...
def load_data(dataset_name, dataset_folder='data/processed', data_split='train_val_test'):
    data = {
        'train': pd.read_csv(f"{dataset_folder}/{dataset_name}/train.csv", index_col=0),
        'val': pd.read_csv(f"{dataset_folder}/{dataset_name}/val.csv", index_col=0),
        'test': pd.read_csv(f"{dataset_folder}/{dataset_name}/test.csv", index_col=0)
    }
...
def load_col_types(dataset_name, dataset_folder='data/processed'):
    with open(f"{dataset_folder}/{dataset_name}/types_of_col.json", "r") as json_file:
