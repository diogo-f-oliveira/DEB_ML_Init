function [prdData, info] = predict_Carinascincus_ocellatus(par, data, auxData)
...
%% uni-variate data
  ...
  % female
  [tvel, t_p, t_b, l_p, l_b] = get_tp(pars_tp, f_tL1, [], tL1_f(:,1)*k_M*TC_tL1);
  ELw_1f = L_m * tvel(:,4)/ del_M;   % cm, length 
  % male
  tvel = get_tpm(pars_tpm, f_tL1, [t_b, f_tL1*z/z_m, l_b*z/z_m], tL1_m(:,1)*k_M*TC_tL1);
