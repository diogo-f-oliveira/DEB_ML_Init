function [prdData, info] = predict_Mallotus_villosus(par, data, auxData)
...
%% compute temperature correction factors
  ...
  EN_L = 365 * TC_LN * reprod_rate(LN(:,1) * del_M, f, pars_R); % #/d, fecundity rate at T
  EN_W = 365 * TC_LN * reprod_rate((WN(:,1)/ (1 + f * w)).^(1/3), f, pars_R); % #/d, fecundity rate at T
