function [prdData, info] = predict_Poecilia_reticulata_LPY (par, data, auxData)
    ...
    f1 = kap_X * spline1(1000, tpX.tL_f1)/ pT_Am/ (3.00 * del_M)^2;  % -, scaled functional response
    f2 = kap_X2 * spline1(1000, tpX.tL_f2)/ pT_Am/ (2.57 * del_M)^2;  % -, scaled functional response
