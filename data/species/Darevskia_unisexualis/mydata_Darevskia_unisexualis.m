function [data, auxData, metaData, txtData, weights] = mydata_Darevskia_unisexualis
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Reptilia'; 
metaData.order      = 'Squamata'; 
metaData.family     = 'Lacertidae';
metaData.species    = 'Darevskia_unisexualis'; 
metaData.species_en = 'Unisexual lizard'; 
...
data.am = 8*365;  units.am = 'd';    label.am = 'life span';            bibkey.am = 'ArakPetr2013';   
  temp.am = C2K(20); units.temp.am = 'K'; label.temp.am = 'temperature'; 

data.Lb  = 2.25;  units.Lb  = 'cm'; label.Lb  = 'SVL at hatching';      bibkey.Lb  = 'guess'; 
  comment.Lb = 'based on Darevskia_derjugini';
data.Li  = 6.7;  units.Li  = 'cm'; label.Li  = 'ultimate SVL for females'; bibkey.Li  = 'ArakPetr2013';  

data.Wwb = 0.26;  units.Wwb = 'g';  label.Wwb = 'ultimate wet '; bibkey.Wwb = 'guess';
  comment.Wwb = 'based on Darevskia_derjugini';
data.Wwi = 8.38;  units.Wwi = 'g';  label.Wwi = 'ultimate wet '; bibkey.Wwi = 'EoL';
...
%% Links
metaData.links.id_CoL = '3463J'; % Cat of Life
metaData.links.id_ITIS = '1155291'; % ITIS
metaData.links.id_EoL = '792778'; % Ency of Life
metaData.links.id_Wiki = 'Darevskia_unisexualis'; % Wikipedia
metaData.links.id_ADW = 'Darevskia_unisexualis'; % ADW
metaData.links.id_Taxo = '642540'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_ReptileDB = 'genus=Darevskia&species=unisexualis'; % ReptileDB
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Darevskia_unisexualis}}';
...
'howpublished = {\url{https://eol.org/pages/792778}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
