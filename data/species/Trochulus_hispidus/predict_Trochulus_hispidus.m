function [prdData, info] = predict_Trochulus_hispidus(par, data, auxData)
  ...
  aT_b = t_0 + tau_b/ k_M;          % d, age at birth
  ...
  % life span
  pars_tm = [pars_tj; h_a/ k_M^2; s_G]; % compose parameter vector
  t_m = get_tm_j(pars_tm, f);           % -, scaled mean life span
  ...
  NT_i = TC * cum_reprod_j(aT_m, f, pars_R); % #, cumulative reproduction
  ...
  ELw = [L_bj; L_jm]/ del_M;               % cm, whell height
