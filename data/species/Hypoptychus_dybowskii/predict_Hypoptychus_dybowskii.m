function [prdData, info] = predict_Hypoptychus_dybowskii(par, data, auxData)
...
% zero-variate data
  ...
  [t_j, t_p, t_b, l_j, l_p, l_b, l_i, rho_j, rho_B, info] = get_tj(pars_tj, f); % -, scaled times & lengths at f
