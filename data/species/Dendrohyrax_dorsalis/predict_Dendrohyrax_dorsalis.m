function [prdData, info] = predict_Dendrohyrax_dorsalis(par, data, auxData)
  ...
  L_i = f_tW1 * L_m - L_T; L_b = get_lb([g; k; v_Hb], f_tW1) * L_m; % cm, length at birth, ultimate
  ...
  L_i = f_tW2 * L_m - L_T; L_b = get_lb([g; k; v_Hb], f_tW2) * L_m; % cm, length at birth, ultimate
