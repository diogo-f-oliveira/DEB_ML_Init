function [prdData, info] = predict_Branchinella_thailandensis(par, data, auxData)
  ...
  % time-length
  tf = [4 f_04; 7 f_07; 10 f_10; 20 f_20]; tf(:,1) = tf(:,1)*kT_M;
  tvel = get_tj(pars_tj, tf,[],tL_f(:,1)*kT_M); 
