function [prdData, info] = predict_Archaster_typicus(par, data, auxData)
  ...
  rT_B = rho_B * k_M * TC;
  ELw = (L_i - (L_i - L_00) * exp(- rT_B * tL(:,1)))/del_M; % cm, volumetric length
  ELw_1 = (L_i - (L_i - L_01) * exp(- rT_B * tL1(:,1)))/del_M; % cm, volumetric length
