function [prdData, info] = predict_Macropus_fuliginosus(par, data, auxData)
  ...
  pT_C = TC * f * E_m * L_i^2 * v; % J/d, mobilisation flux
  pT_J = TC * k_J * E_Hp;          % J/d, maturity maintenance
  pT_R = (1 - kap) * pT_C - pT_J;  % J/d, flux to reproduction plus milk
  pT_L = kap_RL * kap_Lm * pT_R;    % J/d, milk production

  % reproduction
  pars_R = [kap; kap_R; g; k_J; k_M; L_T; v; U_Hb; U_Hp];           % compose parameter vector at T
  RT_i = TC * (1 - kap_Lm) * reprod_rate_foetus(L_i, f, pars_R); % #/d, ultimate reproduction rate at T
