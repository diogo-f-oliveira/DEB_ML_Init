function [prdData, info] = predict_Pteroctopus_tetracirrhus(par, data, auxData)
  ...
  [tau_jm, tau_pm, tau_bm, l_jm, l_pm, l_bm, l_im, rho_jm, rho_Bm] = get_tj(pars_tjm, f, [tau_b, f*z/z_m, l_b*z/z_m]);
  L_jm = L_mm * l_jm;  L_pm = L_mm * l_pm; Lw_pm = L_pm/ del_M; L_im = L_mm * l_im; 
  tT_jm = (tau_jm - tau_bm)/ kT_M; rT_Bm = rho_Bm * kT_M;
  pars_tmm = [pars_tjm; h_a/ k_M^2; s_G]; % compose parameter vector at T_ref
  aT_mm = get_tm_j(pars_tm, f)/ kT_M;  % d, mean life span at T
