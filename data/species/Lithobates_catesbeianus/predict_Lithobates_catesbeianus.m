function [prdData, info] = predict_Lithobates_catesbeianus(par, data, auxData)
  ...
  % length-length next yr
  Lw_i = f_LL * L_m/ del_M; rT_B = TC_LL * k_M/ 3/ (1 + f_LL/ g); % 1/d, von Bert growth rate
  ELw = Lw_i - (Lw_i - LL(:,1)) * exp(-rT_B * 365);
