function [prdData, info] = predict_Lepidocyrtus_cyaneus(par, data, auxData)
  ...
  TC = tempcorr(temp.am, T_ref, T_A); % all data at 20 C
  ...
  tT_p = (t_p - t_b) * (1 + w * f); % d, time since birth at puberty
