function [prdData, info] = predict_Rhinolophus_marshalli(par, data, auxData)
  ...
  tf = [0 f_00; 20 f_20]; % scaled func response in time
  [t, Le] = ode45(@get_Le, [0; tWw(:,1)], [L_b; 1], [], tf, TC*v, g, L_m);
