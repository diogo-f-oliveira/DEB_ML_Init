function [prdData, info] = predict_Potamalosa_richmondia(par, data, auxData)
...
%% compute temperature correction factors
  ...
  % reproduction
  RT_i = TC * reprod_rate_j(26.5*del_M, f, pars_R); % #/d, reproduction rate at TL 26.5 cm
  ...
  % length-weight
  EWw = (LW(:,1)*del_M).^3*(1+ome); % g, weight
