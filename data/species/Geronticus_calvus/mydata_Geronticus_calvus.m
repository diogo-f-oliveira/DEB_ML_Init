function [data, auxData, metaData, txtData, weights] = mydata_Geronticus_calvus
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Pelecaniformes'; 
metaData.family     = 'Threskiornithidae';
metaData.species    = 'Geronticus_calvus'; 
metaData.species_en = 'Southern bald ibis'; 
...
data.am = 15.3*365;  units.am = 'd';    label.am = 'life span';                    bibkey.am = 'AnAge';   
...
data.Wwi = 1202;  units.Wwi = 'g';  label.Wwi = 'ultimate wet weight for females'; bibkey.Wwi = 'avibase';
...
%% Links
metaData.links.id_CoL = '3FWY8'; % Cat of Life
metaData.links.id_ITIS = '174952'; % ITIS
metaData.links.id_EoL = '45513840'; % Ency of Life
metaData.links.id_Wiki = 'Geronticus_calvus'; % Wikipedia
metaData.links.id_ADW = 'Geronticus_calvus'; % ADW
metaData.links.id_Taxo = '51904'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = '645134D31290013B'; % avibase
metaData.links.id_birdlife = 'southern-bald-ibis-geronticus-calvus'; % birdlife
metaData.links.id_AnAge = 'Geronticus_calvus'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Geronticus_calvus}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Geronticus_calvus}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'avibase'; type = 'Misc'; bib = ...
'howpublished = {\url{https://avibase.bsc-eoc.org/species.jsp?lang=EN&avibaseid=645134D31290013B&sec=lifehistory}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
