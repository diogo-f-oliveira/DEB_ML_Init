function [par, metaPar, txtPar] = pars_init_Dreissena_polymorpha(metaData)
...
%% other parameters 
par.del_M = 0.34518;  free.del_M = 1;   units.del_M = '-';        label.del_M = 'shape coefficient'; 
par.f = 1;            free.f     = 0;   units.f = '-';            label.f = 'scaled functional response for 0-var data'; 
par.f_LdL = 0.67575;  free.f_LdL = 1;   units.f_LdL = '-';        label.f_LdL = 'scaled functional response for LdL data'; 
