  function [data, auxData, metaData, txtData, weights] = mydata_Marcusenius_macrolepidotus
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Osteoglossiformes'; 
metaData.family     = 'Mormyridae';
metaData.species    = 'Marcusenius_macrolepidotus'; 
metaData.species_en = 'Bulldog'; 
...
data.Wwp = 21.8;   units.Wwp = 'g';    label.Wwp = 'wet weight at puberty';    bibkey.Wwp = 'fishbase';
  comment.Wwp = 'based on 0.01318*Lp^2.89, see F1';
data.Wwi = 500;   units.Wwi = 'g';    label.Wwi = 'ultimate wet weight';    bibkey.Wwi = 'fishbase';
  comment.Wwi = 'max published weight; based on 0.01318*Li^2.89, see F1, gives 295 g';
  
data.Ri = 1.1e4/365;       units.Ri = '#/d';  label.Ri = 'max reprod rate';     bibkey.Ri = 'fishbase';
  temp.Ri = C2K(23); units.temp.Ri = 'K'; label.temp.Ri = 'temperature'; 
  comment.Ri = 'based on fecundity of Mormyrus longirostris: 7e4*500/3172';
...
%% Facts
F1 = 'length-weight: Ww in g = 0.01318*(TL in cm)^2.89'; 
metaData.bibkey.F1 = 'fishbase'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = '3Y38T'; % Cat of Life
metaData.links.id_ITIS = '649877'; % ITIS
metaData.links.id_EoL = '1157204'; % Ency of Life
metaData.links.id_Wiki = 'Marcusenius'; % Wikipedia
metaData.links.id_ADW = 'Marcusenius_macrolepidotus'; % ADW
metaData.links.id_Taxo = '179586'; % Taxonomicon
metaData.links.id_WoRMS = '1013694'; % WoRMS
metaData.links.id_fishbase = 'Marcusenius-macrolepidotus'; % fishbase
...
'howpublished = {\url{https://www.fishbase.se/summary/Marcusenius-macrolepidotus.html}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
