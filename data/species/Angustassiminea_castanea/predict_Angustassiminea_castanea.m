function [prdData, info] = predict_Angustassiminea_castanea(par, data, auxData)
...
% unpack par, data, auxData
  ...
  L(1) = []; EWd = L.^3 * (1 + f_tL * ome) * 1e3; % mg, AFDW
...
function dL = get_L(t, L, L_i, r_B, T_ref, T_A)
  TC = tempcorr(C2K(17+14*sin(2*pi*(t-140)/365)), T_ref, T_A);
  dL = TC * r_B * (L_i - L);
end
