function [prdData, info] = predict_Merluccius_productus(par, data, auxData) 
...
%% compute temperature correction factors
  ...
  % length-weight
  EWw_f = (LW_f(:,1) * del_M) .^ 3 * (1 + f * ome); % g, wet weight females
  EWw_m = (LW_m(:,1) * del_M) .^ 3 * (1 + f * ome_m); % g, wet weight males
