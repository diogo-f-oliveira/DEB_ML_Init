function [data, auxData, metaData, txtData, weights] = mydata_Leptosomus_discolor

%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Leptosomiformes'; 
metaData.family     = 'Leptosomidae';
metaData.species    = 'Leptosomus_discolor'; 
metaData.species_en = 'Cuckoo roller'; 
...
data.ab = 20;    units.ab = 'd';    label.ab = 'age at birth';             bibkey.ab = 'Twea2012';   
  temp.ab = C2K(36);  units.temp.ab = 'K'; label.temp.ab = 'temperature';
  comment.ab = 'temp from HollRome2012';
data.tx = 30;    units.tx = 'd';    label.tx = 'time since birth at fledging'; bibkey.tx = 'Twea2012';   
...
data.tR = 365;   units.tR = 'd';    label.tR = 'time since birth at 1st brood';bibkey.tR = 'Twea2012';
  temp.tR = C2K(39.5);  units.temp.tR = 'K'; label.temp.tR = 'temperature';
data.am = 10147; units.am = 'd';    label.am = 'life span';                bibkey.am = 'TacuCrai2013';   
  temp.am = C2K(39.5);  units.temp.am = 'K'; label.temp.am = 'temperature'; 

data.Li  = 45;   units.Li  = 'cm';  label.Li  = 'ultimate total length';   bibkey.Li  = 'Twea2012';

data.Wwb = 3;    units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'CramSimm1980';
  comment.Wwb = 'value for Asio otus';
data.Wwi = 225;  units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'RavoWilm2003';

data.Ri = 4/365; units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';  bibkey.Ri  = 'Twea2012';   
  temp.Ri = C2K(39.5);  units.temp.Ri = 'K'; label.temp.Ri = 'temperature';
   
%% set weights for all real data
weights = setweights(data, []);weights.tp = 5;
...
%% Links
metaData.links.id_CoL = '6PJT8'; % Cat of Life
metaData.links.id_ITIS = '554534'; % ITIS
metaData.links.id_EoL = '45514056'; % Ency of Life
metaData.links.id_Wiki = 'Leptosomus_discolor'; % Wikipedia
metaData.links.id_ADW = 'Leptosomus_discolor'; % ADW
metaData.links.id_Taxo = '55345'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = 'BCC6CD0D279E592A'; % avibase
metaData.links.id_birdlife = 'cuckoo-roller-leptosomus-discolor'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Leptosomus_discolor}}';
...
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'RavoWilm2003'; type = 'Incollection'; bib = [ ... 
'author = {Ravokatra, M. and Wilm\''{e}, L. and Goodman, S. M.}, ' ... 
'year = {2003}, ' ...
'title = {Bird weights}, ' ...
...
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'Twea2012'; type = 'Misc'; bib = ...
'howpublished = {\url{http://twearth.com}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
