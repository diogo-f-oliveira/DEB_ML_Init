function [prdData, info] = predict_Panthera_pardus(par, data, auxData)
  ...
  %
  L = L_i - (L_i - L_b) * exp( - rT_B * tW_f1(:,1));   % cm, structural length at time
  EWw_1 = L.^3 * (1 + f * ome);                        % g, wet weight
