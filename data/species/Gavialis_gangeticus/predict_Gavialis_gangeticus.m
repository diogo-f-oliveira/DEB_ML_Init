function [prdData, info] = predict_Gavialis_gangeticus(par, data, auxData)
...
% zero-variate data
  ...
  % length-at-age
  rT_B = TC_L18 * k_M/ 3/ (1 + f/ g); % 1/d, von Bert growth raste        
  Lw_18 = (L_i - (L_i - L_b) * exp( - rT_B * 18 * 30.5))/ del_M; % cm, expected length at time
  ...
  RT_i = TC_Ri * reprod_rate(364 * del_M, f, pars_R);     % #/d, reproduction rate at 364 cm
