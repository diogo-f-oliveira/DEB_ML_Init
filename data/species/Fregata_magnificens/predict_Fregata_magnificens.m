function [prdData, info] = predict_Fregata_magnificens(par, data, auxData)
  ...
  % time-weight
  tf = [30 60 90 120 150 180 200; f_030 f_060 f_090 f_120 f_150 f_180 f_200]'; tf(:,1) = tf(:,1) * kT_M;
