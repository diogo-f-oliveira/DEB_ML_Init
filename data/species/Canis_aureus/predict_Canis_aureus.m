function [prdData, info] = predict_Canis_aureus(par, data, auxData)
  ...
  % time - weight  
  tf = [20 40 60; f_20 f_40  f_60]';
  [t, EL] = ode45(@get_EL, tWw(:,1), [E_m, L_b], [], tf, v * TC, g, E_m, L_m, p_Am * TC); % EL: {J/cm^3, cm}, with {[E], L}
