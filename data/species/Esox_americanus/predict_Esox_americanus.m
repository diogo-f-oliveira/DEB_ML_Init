function [prdData, info] = predict_Esox_americanus(par, data, auxData)
...
%% compute temperature correction factors
  ...
  RT_i = TC * reprod_rate(32.5*del_M, f, pars_R);  % #/d, reprod rate at TL 32.5 cm           % ultimate reproduction rate
