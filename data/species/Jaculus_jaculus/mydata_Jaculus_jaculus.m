function [data, auxData, metaData, txtData, weights] = mydata_Jaculus_jaculus
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Mammalia'; 
metaData.order      = 'Rodentia'; 
metaData.family     = 'Dipodidae';
metaData.species    = 'Jaculus_jaculus'; 
metaData.species_en = 'Lesser Egyptian jerboa'; 
...
data.tpm = 137;   units.tpm = 'd';     label.tpm = 'time since birth at puberty for male'; bibkey.tpm = 'AnAge';
...
data.Wwi = 55;   units.Wwi = 'g';  label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'AnAge';
...
data.Ri  = 3*1.5/ 365;  units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';  bibkey.Ri  = 'AnAge';   
  ...
  comment.Ri = '3 pups per litter; 1,5 litters per yr';
...
%% Links
metaData.links.id_CoL = '3QK2X'; % Cat of Life
metaData.links.id_ITIS = '951273'; % ITIS
metaData.links.id_EoL = '327896'; % Ency of Life
metaData.links.id_Wiki = 'Jaculus_jaculus'; % Wikipedia
metaData.links.id_ADW = 'Jaculus_jaculus'; % ADW
metaData.links.id_Taxo = '63326'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_MSW3 = '12900051'; % MSW3
metaData.links.id_AnAge = 'Jaculus_jaculus'; % AnAge


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Jaculus_jaculus}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Jaculus_jaculus}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
