function [prdData, info] = predict_Crocodylus_johnsoni(par, data, auxData)
  ...
  TC_egg = tempcorr(temp.aW, T_ref, T_A);
...
% zero-variate data
  ...
  UT_E0 = U_E0/ TC_egg; LUH_0 = [1e-10 UT_E0 0];

  vT = v * TC_egg; kT_J = TC_egg * k_J; pT_M = p_M * TC_egg; 
