function [data, auxData, metaData, txtData, weights] = mydata_Crocodylus_johnsoni
...
metaData.species    = 'Crocodylus_johnsoni'; 
metaData.species_en = 'Australian freshwater crocodile'; 
...
metaData.data_1     = {'t-WwYe'; 't-WwVe'; 't-JOe'}; 
...
data.ab = 65;        units.ab = 'd';    label.ab = 'age at birth';             bibkey.ab = 'crocodilian';   
  temp.ab = C2K(30); units.temp.ab = 'K'; label.temp.ab = 'temperature';
  comment.ab = '74-80 d, depending on temperature';
data.ap = 365*12.5;  units.ap = 'd';    label.ap = 'age at puberty for female';bibkey.ap = 'Whit1987';
  temp.ap = C2K(22); units.temp.ap = 'K'; label.temp.ap = 'temperature';
data.apm = 365*16.5; units.apm = 'd';   label.apm = 'age at puberty for male'; bibkey.apm = 'Whit1987';
  temp.apm = C2K(22);units.temp.apm = 'K'; label.temp.apm = 'temperature';
data.am = 50 * 365;  units.am = 'd';    label.am = 'life span';                bibkey.am = 'Whit1987';   
  temp.am = C2K(22); units.temp.am = 'K'; label.temp.am = 'temperature'; 

data.Lb  = 24;       units.Lb  = 'cm';  label.Lb  = 'total length at birth';   bibkey.Lb  = 'Whit1987';  
data.Lp  = 76 * 150/87; units.Lp  = 'cm';  label.Lp  = 'total length at puberty'; bibkey.Lp  = 'crocodilian'; 
data.Lpm  = 150;     units.Lpm  = 'cm'; label.Lpm  = 'total length at puberty';bibkey.Lpm  = 'crocodilian'; 
  comment.Lp = '150 cm total length = 87 cm snout-to-vent';
data.Li  = 200;      units.Li  = 'cm';  label.Li  = 'ultimate total length for female'; bibkey.Li  = 'Wiki';
data.Lim  = 300;     units.Lim  = 'cm'; label.Lim  = 'ultimate total length for male'; bibkey.Lim  = 'Wiki';

data.Wwb = 42;       units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'Whit1987';
data.Wwp = 7480;     units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';   bibkey.Wwp = 'guess';
  comment.Wwp = 'Computed as Wwi*(Lp/Li)^3';
data.Wwpm = 11250;   units.Wwpm = 'g';  label.Wwpm = 'wet weight at puberty';  bibkey.Wwpm = 'guess';
  comment.Wwpm = 'Computed as Wwim*(Lp/Lim)^3 = 90*(1.5/3)^3';
data.Wwi = 26600;    units.Wwi = 'g';   label.Wwi = 'ultimate wet weight of female'; bibkey.Wwi = 'Wiki';
  comment.Wwi = 'Computed as Wwim*(Li/Lim)^3 = 90*(2/3)^3; Wiki: upto 40 kg';
data.Wwim = 90000;   units.Wwim = 'g';  label.Wwim = 'ultimate wet weight of male';  bibkey.Wwim = 'Wiki';
  comment.Wwim = 'Wiki: upto 100 kg';  

data.Ri  = 13/365;   units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';     bibkey.Ri  = 'Whit1987';   
  temp.Ri = C2K(22); units.temp.Ri = 'K'; label.temp.Ri = 'temperature';
 
% uni-variate data
% age-yolk-free wet weight
data.aW = [  ... % time (d), wet weight (g)
      20 0.4414841685;
      20.01 0.7857969114;
      23 0.5181908172;
      23.01 0.7286161847;
      ...
      86 32.96664803;
      89 38.64838032];
units.aW   = {'d', 'g'};  label.aW = {'age', 'yolk-free wet weight'};  
temp.aW    = C2K(30);  units.temp.aW = 'K'; label.temp.aW = 'temperature';
bibkey.aW = {'Whit1987','WhitWebb1990'};

% age-yolk wet weight
data.aWY = [ ... % time (d), wet weight (g)
      20 27.26517524;
      20.01 25.73740821;
      20.02 20.42602386;
      22 26.19091619;
      ...
      95 10.60686057;
      95.01 4.957237807];
units.aWY   = {'d', 'g'};  label.aWY = {'age', 'yolk wet weight'};  
temp.aWY    = C2K(30);  units.temp.aWY = 'K'; label.temp.aWY = 'temperature';
bibkey.aWY = {'Whit1987','WhitWebb1990'};

% age-respiration
data.aJO = [ ... % time (d), O_2 consumption ml/d
       16.1166646  0.05838195376;
...
data.aJO(:,2) = data.aJO(:,2) * 100; % convert to ml/d
units.aJO   = {'d', 'ml/d'};  label.aJO = {'age', 'O2 consumption'};  
temp.aJO    = C2K(30);  units.temp.aJO = 'K'; label.temp.aJO = 'temperature';
bibkey.aJO = {'Whit1987','WhitWebb1990'};
...
%% Facts
F1 = 'temperature effects have shown that eggs incubated at 32 C produce male embryos, whereas those a couple of degrees above and below this produce female embryos';
metaData.bibkey.F1 = 'crocodilian'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = '6BHQR'; % Cat of Life
metaData.links.id_ITIS = '551774'; % ITIS
metaData.links.id_EoL = '795282'; % Ency of Life
metaData.links.id_Wiki = 'Crocodylus_johnsoni'; % Wikipedia
metaData.links.id_ADW = 'Crocodylus_johnsoni'; % ADW
metaData.links.id_Taxo = '50631'; % Taxonomicon
metaData.links.id_WoRMS = '1041088'; % WoRMS
metaData.links.id_ReptileDB = 'genus=Crocodylus&species=johnsoni'; % ReptileDB
metaData.links.id_AnAge = 'Crocodylus_johnsoni'; % AnAge


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Crocodylus_johnsoni}}';
...
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'Whit1987'; type = 'Incollection'; bib = [ ... 
'author = {P. J. Whitehead}, ' ... 
'year = {1987}, ' ...
'title = {Respiration of \emph{Crocodylus johnstoni} embryos}, ' ...
'booktitle = {Crocodiles and Alligators}, ' ...
'editor = {G. J. W. Webb and S. C. Manolis and P. J. Whitehead}, ' ...
'publisher = {Beatty} , ' ...
'address = {Sydney}, ' ...
'pages = {473--497}'];
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'WhitWebb1990'; type = 'Article'; bib = [ ... 
'author = {P. J. Whitehead and G. J. W. Webb and R. S. Seymour}, ' ... 
'year = {1990}, ' ...
'title = {Effect of incubation temperature on development of \emph{Crocodylus johnstoni} embryos}, ' ...
'journal = {Physiol. Zool.}, ' ...
'volume = {63}, ' ...
'pages = {949--964}'];
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'Brit'; type = 'Misc'; bib = [...
'author = {Adam Britton}, ' ... 
'howpublished = {\url{http://www.kingsnake.com/oz/crocs/johnstoni.htm}}'];
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'crocodilian'; type = 'Misc'; bib = ...
'howpublished = {\url{http://crocodilian.com/cnhc/csp_cjoh.htm}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
