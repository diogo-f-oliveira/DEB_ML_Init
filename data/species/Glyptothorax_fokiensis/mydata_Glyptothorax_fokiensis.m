  function [data, auxData, metaData, txtData, weights] = mydata_Glyptothorax_fokiensis
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Siluriformes'; 
metaData.family     = 'Sisoridae';
metaData.species    = 'Glyptothorax_fokiensis'; 
...
data.Wwp = 15.7;   units.Wwp = 'g';    label.Wwp = 'wet weight at puberty';   bibkey.Wwp = 'guess';
  comment.Wwi = 'based on 0.00479*Lp^2.99, see F1';
data.Wwi = 137.9;   units.Wwi = 'g';    label.Wwi = 'ultimate wet weight';    bibkey.Wwi = 'fishbase';
...
%% Links
metaData.links.id_CoL = '3GJCD'; % Cat of Life
metaData.links.id_ITIS = '682001'; % ITIS
metaData.links.id_EoL = '210006'; % Ency of Life
metaData.links.id_Wiki = 'Glyptothorax'; % Wikipedia
metaData.links.id_ADW = 'Glyptothorax_fokiensis'; % ADW
metaData.links.id_Taxo = '175101'; % Taxonomicon
metaData.links.id_WoRMS = '280878'; % WoRMS
metaData.links.id_fishbase = 'Glyptothorax-fokiensis'; % fishbase
...
'howpublished = {\url{https://www.fishbase.se/summary/Glyptothorax-fokiensis.html}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
