function [prdData, info] = predict_Pitta_versicolor(par, data, auxData)
  ...
  l_0 = (W0/(1 +  ome))^(1/3)/ L_m; % cm, initital scaled struc lengths
  tvel = get_tp(pars_tp, tf, [0 1 l_0], tW(:,1)*kT_M);
