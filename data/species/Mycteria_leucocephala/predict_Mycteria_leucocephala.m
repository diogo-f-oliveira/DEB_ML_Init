function [prdData, info] = predict_Mycteria_leucocephala(par, data, auxData)
  ...
  f_values = [f_00, f_10, f_20, f_30, f_40, f_50, f_60];
  if any(f_values <= 0); info=0; prdData=[]; return; end
  ...
  tf = [0 10 20 30 ; f_00 f_10 1.05*f_20 1.1*f_30]'; tf(:,1) = tf(:,1) * kT_M;
