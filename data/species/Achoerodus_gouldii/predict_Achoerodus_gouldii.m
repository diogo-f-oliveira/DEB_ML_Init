function [prdData, info] = predict_Achoerodus_gouldii(par, data, auxData)
...
% zero-variate data
  ...
  Lw_pm = L_mm * l_pm/ del_M; Lw_im = L_mm * l_im/ del_M;
  ...
  %
  tvel = get_tj(pars_tjm, f_tL, [], tL_m(:,1)*kT_M); % cm, struc length 
