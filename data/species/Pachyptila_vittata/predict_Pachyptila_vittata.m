function [prdData, info] = predict_Pachyptila_vittata(par, data, auxData)
  ...
  tf = [5 10 20 30 40 50; f_05 f_10 f_20 f_30 f_40 f_50]'; tf(:,1) = tf(:,1) * kT_M;
