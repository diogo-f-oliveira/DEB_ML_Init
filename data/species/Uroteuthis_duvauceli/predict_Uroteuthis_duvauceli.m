function [prdData, info] = predict_Uroteuthis_duvauceli(par, data, auxData)
  ...
  rT_Bm = rho_Bm * kT_M; % 1/d, growth rates
  ...
  Lw_im = L_amm/ del_Mm; % cm, mantle length at death
  ...
  EWw_m = (LWw_m(:,1)*del_Mm).^3 * (1 + f * w_m); % g, wet weight
