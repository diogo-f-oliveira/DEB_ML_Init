function [prdData, info] = predict_Lepidochitona_cinerea(par, data, auxData)
  ...
  Wd_1 = del_M.^3 * (d_V + w_E * f * E_m/ mu_E); % g, flesh dry weight at L = 10 mm
  
  % reproduction
  pars_R = [kap; kap_R; g; k_J; k_M; L_T; v; U_Hb; U_Hp]; % compose parameter vector at T
  RT_i = TC * reprod_rate(1.4*del_M, f, pars_R);                % #/d, ultimate reproduction rate at T
