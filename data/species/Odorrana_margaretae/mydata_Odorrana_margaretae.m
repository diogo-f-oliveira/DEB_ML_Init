function [data, auxData, metaData, txtData, weights] = mydata_Odorrana_margaretae
...
metaData.species    = 'Odorrana_margaretae'; 
metaData.species_en = 'Green odorous frog'; 
...
data.tp = 2*365;  units.tp = 'd';    label.tp = 'time since birth at puberty'; bibkey.tp = 'YuanZhon2021';   
  temp.tp = C2K(17);  units.temp.tp = 'K'; label.temp.tp = 'temperature'; 
data.am = 4*365;  units.am = 'd';    label.am = 'life span';                bibkey.am = 'YuanZhon2021';   
  temp.am = C2K(17);  units.temp.am = 'K'; label.temp.am = 'temperature'; 

data.Lj  = 2.3;    units.Lj  = 'cm';  label.Lj  = 'SVL at metam';   bibkey.Lj  = 'guess';
  comment.Lj = 'based on Odorrana_swinhoana';
data.Lp  = 7.06;    units.Lp  = 'cm';  label.Lp  = 'SVL at puberty for females';   bibkey.Lp  = 'guess';
  comment.Lp = 'based on Odorrana_swinhoana';
data.Lpm  = 5.06;    units.Lpm  = 'cm';  label.Lpm  = 'SVL at puberty for males';   bibkey.Lpm  = 'guess';
  comment.Lpm = 'based on Odorrana_swinhoana';
data.Li  = 10;    units.Li  = 'cm';  label.Li  = 'ultimate SVL for females';   bibkey.Li  = 'YuanZhon2021';
...
data.Wwi = 92;  units.Wwi = 'g';   label.Wwi = 'ultimate wet weight for females'; bibkey.Wwi = 'guess';
  comment.Wwi = 'based on Odorrana_swinhoana: 67*(10/9)^3';
...
bibkey.tL_fm = 'YuanZhon2021'; treat.tL_fm = {1, {'females','males'}}; label.treat.tL_fm = 'Wawushan NP in Ya''an';
comment.tL_fm = 'Data from Wawushan NP in Ya''an, temp from 3 to 22 C';
...
%% Links
metaData.links.id_CoL = '6SH9S'; % Cat of Life
metaData.links.id_ITIS = '775155'; % ITIS
metaData.links.id_EoL = '332972'; % Ency of Life
metaData.links.id_Wiki = 'Odorrana_margaretae'; % Wikipedia
metaData.links.id_ADW = 'Odorrana_margaretae'; % ADW
metaData.links.id_Taxo = '1396912'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_amphweb = 'Odorrana+margaretae'; % AmphibiaWeb
metaData.links.id_AnAge = ''; % AnAge


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Odorrana_margaretae}}';
...
'howpublished = {\url{http://amphibiaweb.org/cgi/amphib_query?rel-common_name=like&where-scientific_name=Odorrana+margaretae}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
