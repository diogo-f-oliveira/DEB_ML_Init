function [prdData, info] = predict_Odorrana_margaretae(par, data, auxData)
...
% zero-variate data
  ...
  GSI = 365 * TC * k_M * g/ f^3/ (f + kap * g * y_V_E);  % -, GSI based on 365 d accumulation (wild guess)
