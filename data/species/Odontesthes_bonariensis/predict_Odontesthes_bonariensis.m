function [prdData, info] = predict_Odontesthes_bonariensis(par, data, auxData)
...
% zero-variate data
  ...
  RT_i = TC * reprod_rate_j(L_i, f, pars_R); % #/d, reproduction rate at 27.5 cm
  ...
  EWw_m = L.^3 .* (1 + tvel(:,3)*ome); % g, weight
