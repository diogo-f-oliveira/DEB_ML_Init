...
metaData.data_0     = {'ab_T'; 'am'; 'Li'; 'Wwb'; 'Wwp'; 'Wwi'; 'GSI'}; 
...
%% Links
metaData.links.id_CoL = '3L7TP'; % Cat of Life
metaData.links.id_ITIS = '639987'; % ITIS
metaData.links.id_EoL = '207387'; % Ency of Life
metaData.links.id_Wiki = 'Heterobranchus_longifilis'; % Wikipedia
metaData.links.id_ADW = 'Heterobranchus_longifilis'; % ADW
metaData.links.id_Taxo = '176567'; % Taxonomicon
metaData.links.id_WoRMS = '888192'; % WoRMS
metaData.links.id_fishbase = 'Heterobranchus-longifilis'; % fishbase
...
'howpublished = {\url{http://www.fishing-worldrecords.com/scientificname/Heterobranchus longifilis/show}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];