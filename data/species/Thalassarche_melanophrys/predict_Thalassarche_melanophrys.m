function [prdData, info] = predict_Thalassarche_melanophrys(par, data, auxData)
  ...
  L_im = (f - l_T) * L_mm;             % cm, ultimate struc length
  ...
  % uni-variate data 
  % time-weight 
  tf = [10 20  40 60 90; f_10 f_20 f_40 f_60 f_90]'; tf(:,1) = tf(:,1) * kT_M;
