function [data, auxData, metaData, txtData, weights] = mydata_Notomys_alexis
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Mammalia'; 
metaData.order      = 'Rodentia'; 
metaData.family     = 'Muridae';
metaData.species    = 'Notomys_alexis'; 
metaData.species_en = 'Spinifex hopping mouse';
...
data.tp = 75;   units.tp = 'd';     label.tp = 'time since birth at puberty for female'; bibkey.tp = 'AnAge';
  temp.tp = C2K(38); units.temp.tp = 'K'; label.temp.tp = 'temperature';
data.am = 6.4*365;    units.am = 'd'; label.am = 'life span';                bibkey.am = 'AnAge';   
  temp.am = C2K(38); units.temp.am = 'K'; label.temp.am = 'temperature';

data.Wwb = 2.83;   units.Wwb = 'g';     label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'AnAge';
data.Wwx = 12.5;   units.Wwx = 'g';     label.Wwx = 'wet weight at weaning';     bibkey.Wwx = 'AnAge';
data.Wwi = 35;   units.Wwi = 'g';  label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'AnAge';

data.Ri  = 3.9/33;  units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';  bibkey.Ri  = 'AnAge';   
  temp.Ri = C2K(38); units.temp.Ri = 'K'; label.temp.Ri = 'temperature';
  comment.Ri = '3.9 pups per litter; litter interval 33 d';
...
%% Links
metaData.links.id_CoL = '47WWS'; % Cat of Life
metaData.links.id_ITIS = '585438'; % ITIS
metaData.links.id_EoL = '1179286'; % Ency of Life
metaData.links.id_Wiki = 'Notomys_alexis'; % Wikipedia
metaData.links.id_ADW = 'Notomys_alexis'; % ADW
metaData.links.id_Taxo = '63088'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_MSW3 = '13001619'; % MSW3
metaData.links.id_AnAge = 'Notomys_alexis'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Notomys_alexis}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Notomys_alexis}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
