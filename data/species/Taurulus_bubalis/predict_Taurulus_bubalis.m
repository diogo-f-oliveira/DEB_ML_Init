function [prdData, info] = predict_Taurulus_bubalis(par, data, auxData)
  ...
  % male
  tvel = get_tj(pars_tjm, f, [0, z/z_m, l_b*z/z_m], tL_m(:,1)*kT_M);
  ...
  % weight-fecundity
  EN_W = TC * 365 * reprod_rate_j((WN(:,1)/(1+f_tL*ome)).^(1/3), f, pars_R); % #, fecundity
