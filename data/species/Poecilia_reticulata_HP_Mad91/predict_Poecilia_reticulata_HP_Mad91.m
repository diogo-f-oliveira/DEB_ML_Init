function [prdData, info] = predict_Poecilia_reticulata_HP_Mad91 (par, data, auxData)
  ...
  prdData.Li = L_i; % cm, max length at f=1
 ...
 % LWw at low food
  ...
  prdData.LWw_f1 = ELWw1_f1;
  prdData.LWw_f2 = ELWw1_f2; 
  end
