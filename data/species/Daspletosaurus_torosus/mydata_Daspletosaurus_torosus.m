function [data, auxData, metaData, txtData, weights] = mydata_Daspletosaurus_torosus
...
metaData.species    = 'Daspletosaurus_torosus'; 
metaData.species_en = 'Daspletosaurus'; 
...
data.tp = 15*365;    units.tp = 'd';    label.tp = 'time since birth at puberty'; bibkey.tp = 'Wiki';
  temp.tp = C2K(37);  units.temp.tp = 'K'; label.temp.tp = 'temperature';
data.am = 25*365;    units.am = 'd';    label.am = 'life span';                   bibkey.am = 'Wiki';   
  temp.am = C2K(37);  units.temp.am = 'K'; label.temp.am = 'temperature'; 

data.Wwb = 2.5e3; units.Wwb = 'g';   label.Wwb = 'wet weight at birth';             bibkey.Wwb = 'Learning';
  comment.Wwb = 'Very speculative';
data.Wwi = 1.9e6; units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';           bibkey.Wwi = 'Wiki';
...
%% Facts
F1 = 'Extinct, lived 77 till 74 Ma ago';
...
metaData.links.id_EoL = '4433652'; % Ency of Life
metaData.links.id_Wiki = 'Daspletosaurus_torosus'; % Wikipedia
metaData.links.id_Taxo = '4936927'; % Taxonomicon

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Daspletosaurus}}';
