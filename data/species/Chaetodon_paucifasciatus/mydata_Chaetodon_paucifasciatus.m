function [data, auxData, metaData, txtData, weights] = mydata_Chaetodon_paucifasciatus
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Chaetodontiformes'; 
metaData.family     = 'Chaetodontidae';
metaData.species    = 'Chaetodon_paucifasciatus'; 
metaData.species_en = 'Eritrean butterflyfish'; 
...
%% Links
metaData.links.id_CoL = 'TC3F'; % Cat of Life
metaData.links.id_ITIS = '610609'; % ITIS
metaData.links.id_EoL = '46578227'; % Ency of Life
metaData.links.id_Wiki = 'Chaetodon_paucifasciatus'; % Wikipedia
metaData.links.id_ADW = 'Chaetodon_paucifasciatus'; % ADW
metaData.links.id_Taxo = '170398'; % Taxonomicon
metaData.links.id_WoRMS = '218747'; % WoRMS
metaData.links.id_fishbase = 'Chaetodon-paucifasciatus'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Chaetodon_paucifasciatus}}';
...
'howpublished = {\url{http://www.fishbase.org/summary/Chaetodon-paucifasciatus.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
