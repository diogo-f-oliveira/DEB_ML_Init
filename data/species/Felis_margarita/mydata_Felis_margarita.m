function [data, auxData, metaData, txtData, weights] = mydata_Felis_margarita
...
metaData.species    = 'Felis_margarita'; 
metaData.species_en = 'Sand cat'; 
...
data.tp = 274;    units.tp = 'd';    label.tp = 'time since birth at puberty for females';   bibkey.tp = 'AnAge';
...
data.Wwb = 93;   units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'AnAge';
  comment.Wwb = 'AnAge gives 55.5 g';
data.Wwi = 2750;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'Wiki';
  comment.Wwi = 'Wiki: 3.8 kg in the tropics, till 7.1 kg in Siberia';

data.Ri  = 2*4.5/365;   units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';     bibkey.Ri  = 'AnAge';   
  temp.Ri = C2K(39.8);  units.temp.Ri = 'K'; label.temp.Ri = 'temperature';
  comment.Ri = '4.5 cups per litter, 2 litter per yr';
...
%% Links
metaData.links.id_CoL = '3DXVH'; % Cat of Life
metaData.links.id_ITIS = '183801'; % ITIS
metaData.links.id_EoL = '328670'; % Ency of Life
metaData.links.id_Wiki = 'Felis_margarita'; % Wikipedia
metaData.links.id_ADW = 'Felis_margarita'; % ADW
metaData.links.id_Taxo = '168138'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_MSW3 = '14000047'; % MSW3
metaData.links.id_AnAge = 'Felis_margarita'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Felis_margarita}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Felis_margarita}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'ADW'; type = 'Misc'; bib = ...
'howpublished = {\url{https://animaldiversity.org/accounts/Felis_margarita/}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
