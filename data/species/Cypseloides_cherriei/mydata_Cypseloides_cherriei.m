function [data, auxData, metaData, txtData, weights] = mydata_Cypseloides_cherriei
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Apodiformes'; 
metaData.family     = 'Apodidae';
metaData.species    = 'Cypseloides_cherriei'; 
metaData.species_en = 'Spot-fronted swift'; 
...
data.Ww0 = 3.7;    units.Ww0 = 'g';   label.Ww0 = 'initial wet weight';     bibkey.Ww0 = 'MariStil1993';
data.Wwb = 3.4;    units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'MariStil1993';
  comment.Wwb = 'based on tW data';
data.Wwi = 22.3;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight for females';     bibkey.Wwi = 'avibase';
...
%% Links
metaData.links.id_CoL = '6BWH3'; % Cat of Life
metaData.links.id_ITIS = '554937'; % ITIS
metaData.links.id_EoL = '45511601'; % Ency of Life
metaData.links.id_Wiki = 'Cypseloides_cherriei'; % Wikipedia
metaData.links.id_ADW = 'Cypseloides_cherriei'; % ADW
metaData.links.id_Taxo = '72145'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = '258B1B375050DC54'; % avibase
metaData.links.id_birdlife = 'spot-fronted-swift-cypseloides-cherriei'; % birdlife
...
'howpublished = {\url{http://en.wikipedia.org/wiki/Cypseloides_cherriei}}';
...
'howpublished = {\url{https://avibase.bsc-eoc.org/species.jsp?lang=EN&avibaseid=258B1B375050DC54&sec=lifehistory}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
