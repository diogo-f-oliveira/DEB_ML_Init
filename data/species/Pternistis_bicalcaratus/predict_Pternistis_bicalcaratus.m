function [prdData, info] = predict_Pternistis_bicalcaratus(par, data, auxData)
  
  % unpack par, data, auxData
  cPar = parscomp_st(par); vars_pull(par); 
  vars_pull(cPar);  vars_pull(data);  vars_pull(auxData);

  if f_030 > 1.3 ||f_060 > 1.2 ||f_090 > 1.2 ||f_120 > 1.2 ||f_150 > 1.2 || t_0 < 0
  ...
  % time-weight
  tf = [30 f_030; 60 f_060; 90 f_090; 120 f_120; 150 f_150]; tf(:,1) = tf(:,1) * kT_M;
