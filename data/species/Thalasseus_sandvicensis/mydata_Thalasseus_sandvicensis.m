function [data, auxData, metaData, txtData, weights] = mydata_Sterna_sandvicensis
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Charadriiformes'; 
metaData.family     = 'Laridae';
metaData.species    = 'Thalasseus_sandvicensis'; 
metaData.species_en = 'Sandwich tern'; 
...
data.tx = 29;          units.tx = 'd';    label.tx = 'time since birth at fledging'; bibkey.tx = 'DrenKlaa1992';   
...
%% Links
metaData.links.id_CoL = '7C5FT'; % Cat of Life
metaData.links.id_ITIS = '176932'; % ITIS
metaData.links.id_EoL = '45509314'; % Ency of Life
metaData.links.id_Wiki = 'Thalasseus_sandvicensis'; % Wikipedia
metaData.links.id_ADW = 'Sterna_sandvicensis'; % ADW
metaData.links.id_Taxo = '610055'; % Taxonomicon
metaData.links.id_WoRMS = '137166'; % WoRMS
metaData.links.id_avibase = '04B49AE78FFF9B68'; % avibase
metaData.links.id_birdlife = 'sandwich-tern-thalasseus-sandvicensis'; % birdlife
metaData.links.id_AnAge = 'Thalasseus_sandvicensis'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Thalasseus_sandvicensis}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Thalasseus_sandvicensis}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
