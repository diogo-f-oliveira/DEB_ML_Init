function [prdData, info] = predict_Elseya_dentata(par, data, auxData)
  ...
  L_bm = L_mm * l_bm; Lw_bm = L_bm/ del_M; % cm, struc, carapace length at birth
  L_pm = L_mm * l_pm; Lw_pm = L_pm/ del_M; % cm, struc, carapace length at puberty
  Ww_pm = L_pm^3 * (1 + f * w_m); % g, wet weight at puberty 
  L_im = f * L_mm; Lw_im = L_im/ del_M; % cm, ultimate struct, carapace length
