function [prdData, info] = predict_Callipepla_californica(par, data, auxData)
  ...
  aT_b = tau_b/ k_M/ TC_ab;      % d, time at birth at f and T
  ...
  tf = [30 70 99; f_20 f_60 f_99]'; tf(:,1) = tf(:,1) * kT_M;
