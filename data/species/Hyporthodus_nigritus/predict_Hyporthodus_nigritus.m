function [prdData, info] = predict_Hyporthodus_nigritus(par, data, auxData)
...
% zero-variate data
  ...
  % time-length-weight 
  tf = [01000 f_01000; 03000 f_03000; 05000 f_05000; 10000 f_10000; 15000 f_15000]; tf(:,1) = tf(:,1)*kT_M;
