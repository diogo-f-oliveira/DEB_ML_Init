function [prdData, info] = predict_Carcharhinus_dussumieri(par, data, auxData)
  ...
  % male
  tvel = get_tp(pars_tpm, f_tL, [t_b, f_tL*z/z_m, l_b*z/z_m], tL_fm(:,1)*kT_M);
