function [prdData, info] = predict_Squalus_suckleyi(par, data, auxData)  
  ...
  [l_p, l_b] = get_lp(pars_tpm, f);    % -, scaled times & lengths at f
  Lw_pm = L_mm * l_p/del_M;            % cm, totsal length at puberty
