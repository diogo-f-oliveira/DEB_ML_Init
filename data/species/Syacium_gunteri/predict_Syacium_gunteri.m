function [prdData, info] = predict_Syacium_gunteri(par, data, auxData)
  ...
  % time-length 
  % tL for late juveniles and adults, south Calif 
  ...
  L_ji = L_i - (L_i - L_j) * exp( - rT_B * (tL(tL(:,1) >= tT_j,1) - tT_j)); % cm, total length at time
