function [prdData, info] = predict_Vinciguerria_nimbaria(par, data, auxData) 
...
%% uni-variate data
  ...
  EN = TC * 16 * reprod_rate_j(LN(:,1) * del_M, f, pars_R); % #, batch fecundity over 16 d batch interval
