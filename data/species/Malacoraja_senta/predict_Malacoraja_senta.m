function [prdData, info] = predict_Malacoraja_senta(par, data, auxData)  
  ...
  Ww_im = L_im^3 * (1 + f_tL * w_m);  % g, ultimae wet weight
  ...
  % male
  tvel = get_tpm(pars_tpm, f_tL1, [t_b, f_tL1*z/z_m, l_b*z/z_m], tL_1m(:,1)*kT_M);
