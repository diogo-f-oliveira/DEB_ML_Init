function [prdData, info] = predict_Lissotriton_vulgaris(par, data, auxData)
  ...
  TC_L240 = tempcorr(temp.L240, T_ref, T_A);
  TC_L970 = tempcorr(temp.L970, T_ref, T_A);
  ...
  rT_B = TC_L240 * k_M/ 3/ (1 + f/ g);
  Lw_240 = Lw_i - (Lw_i - Lw_b) * exp(-240 * rT_B); % cm, total length at 240 d
  Lw_970 = Lw_i - (Lw_i - Lw_b) * exp(-970 * rT_B); % cm, total length at 970 d
