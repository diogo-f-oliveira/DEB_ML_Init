function [prdData, info] = predict_Afrotis_afra(par, data, auxData)
  ...
  % time-weight 
  tf = [15 25 45; f_15 f_25 f_45]'; tf(:,1) = tf(:,1) * kT_M;
  [tvel, tau_p, tau_b, l_p, l_b] = get_tp(pars_tp, tf, [], tW(:,1)*kT_M);
