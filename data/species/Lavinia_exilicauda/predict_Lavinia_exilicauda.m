function [prdData, info] = predict_Lavinia_exilicauda(par, data, auxData)
...
%% compute temperature correction factors
  ...
  RT_21 = TC * reprod_rate_j(21.2/0.82*del_M, f, pars_R);        % #/d, reprod rate at SL 21.2 cm
  RT_31 = TC * reprod_rate_j(31.2/0.82*del_M, f, pars_R);        % #/d, reprod rate at SL 21.2 cm
