function [prdData, info] = predict_Nipponia_nippon(par, data, auxData)
  ...
  % time-weight 
  tf = [0 5 15 25 35 45; f_00 f_05 f_15 f_25 f_35 f_45]'; tf(:,1) = tf(:,1) * kT_M;
  ...
  EJT_X = (L_m * tvel(:,4)).^2 .* spline1(tJX(:,1),tf) * TC * p_Am/ kap_X/ mu_X * w_X; % g/d, food intake
