function [prdData, info] = predict_Selasphorus_rufus(par, data, auxData)
  ...
  %
  tf = [2 f_02; 5 f_05; 10 f_10; 15 f1_15]; tf(:,1) = tf(:,1) * kT_M;
  tvel = get_tp(pars_tp, tf, [v_Hb 1 l_b], tW1(:,1)*kT_M);
