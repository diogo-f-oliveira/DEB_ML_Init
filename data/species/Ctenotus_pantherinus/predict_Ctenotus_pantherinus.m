function [prdData, info] = predict_Ctenotus_pantherinus(par, data, auxData)
...
TC_tL = tempcorr(temp.LdL_f, T_ref, T_A);
...
L_pm = L_mm * l_pm; Lw_pm = L_pm/ del_M; % cm, SVP at puberty
