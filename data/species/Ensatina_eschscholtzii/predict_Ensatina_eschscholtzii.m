function [prdData, info] = predict_Ensatina_eschscholtzii(par, data, auxData)
  ...
  rT_B = TC * k_M/ 3/ (1 + f_LL/ g); Lw_i = f_LL * L_m/ del_M;
  ELw = Lw_i - (Lw_i - LL(:,1)) .* exp(-rT_B * time.LL) ; % cm, final SVL
