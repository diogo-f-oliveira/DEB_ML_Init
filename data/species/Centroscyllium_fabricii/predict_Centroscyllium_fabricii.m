function [prdData, info] = predict_Centroscyllium_fabricii(par, data, auxData)  
  ...
  TC = tempcorr(temp.Ri, T_ref, T_A); kT_M = k_M * TC;
  ...
  EWw_m = (LWw_m(:,1) * del_M).^3 * (1 + f_tL * w_m); % g, wet weight for males
