function [prdData, info] = predict_Nyctibius_griseus(par, data, auxData)
  ...
  L_35 = L_i - (L_i - L_b) * exp(-rT_B * 35); % cm, struc length at 35 d
  Ww_35 = L_35^3 * (1 + f * ome);   % g, weight at 35 d since birth
  ...
  % time-weight
  tf = [5 f_05; 10 f_10; 20 f_20;30 f_30]; tf(:,1) = tf(:,1) * kT_M;
