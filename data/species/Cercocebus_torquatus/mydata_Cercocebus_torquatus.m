function [data, auxData, metaData, txtData, weights] = mydata_Cercocebus_torquatus
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Mammalia'; 
metaData.order      = 'Primates'; 
metaData.family     = 'Cercopithecidae';
metaData.species    = 'Cercocebus_torquatus'; 
metaData.species_en = 'Collared mangabey'; 
...
data.tp = 973;   units.tp = 'd';    label.tp = 'time since birth at puberty'; bibkey.tp = 'AnAge';
...
data.Wwi = 8000;  units.Wwi = 'g';   label.Wwi = 'ultimate wet weight for females';     bibkey.Wwi = 'Wiki';
  comment.Wwi = 'in captivity 7.5-8.6 kg';
data.Wwim = 9500;  units.Wwim = 'g';   label.Wwim = 'ultimate wet weight for males';     bibkey.Wwim = 'Wiki';
  comment.Wwim = 'in captivity 9-10 kg';
...
6.872	6607.950
7.410	6319.278];
data.tWw_f(:,1) = (data.tWw_f(:,1) - data.tWw_f(1,1) + 1.8) * 365; % convert yr to d
...
comment.tWw_f = 'Data for females; time at birth guessed';
...
%% Links
metaData.links.id_CoL = 'SSTF'; % Cat of Life
metaData.links.id_ITIS = '572995'; % ITIS
metaData.links.id_EoL = '323967'; % Ency of Life
metaData.links.id_Wiki = 'Cercocebus_torquatus'; % Wikipedia
metaData.links.id_ADW = 'Cercocebus_torquatus'; % ADW
metaData.links.id_Taxo = '65902'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_MSW3 = '12100433'; % MSW3
metaData.links.id_AnAge = 'Cercocebus_torquatus'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Cercocebus_torquatus}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Cercocebus_torquatus}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
...
'howpublished = {\url{http://animaldiversity.ummz.umich.edu/accounts/Cercocebus_torquatus/}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
