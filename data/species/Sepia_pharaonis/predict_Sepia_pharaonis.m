function [prdData, info] = predict_Sepia_pharaonis(par, data, auxData)
...
%   end
  ...
  pars_tjm = [g_m; k; l_T; v_Hb; v_Hj; 10*v_Hpm];
  [t_jm, t_pm, t_bm, l_jm, l_pm, l_bm, l_im, rho_jm, rho_Bm, info] = get_tj(pars_tjm, f);
  if ~info; prdData = []; return; end
  Lw_pm = L_mm * l_pm/ del_M; L_jm = L_mm * l_jm; L_im = L_mm * l_im; rT_Bm = rho_Bm * kT_M;
  ...
  EWw = (L_m * tvel(:,4)).^3 * (1 + f_tL * w);   % g, wet weight
