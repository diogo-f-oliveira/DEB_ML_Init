function [prdData, info] = predict_Macropus_rufus(par, data, auxData)
  ...
  Lw_i = L_i/ del_M;                % cm, ultimate head length at f
  ...
  [H, ~, info] = maturity(L, f, pars_power);  % d.cm^2, scaled maturities E_H/ {p_Am}
  if ~info || isempty(H)
      prdData = []; info=0; return
  end
