function [prdData, info] = predict_Paralichthys_californicus(par, data, auxData)
  ...
  % female, Central Calif
  [tvel, t_j, t_p, t_b, l_j, l_p, l_b] = get_tj(pars_tj, f_tLC, [], tL_fC(:,1)*kT_M);
  ELw_fC = L_m * tvel(:,4)/ del_M;   % cm, length
  % male, Central Calif
  tvel = get_tj(pars_tjm, f_tLC, [t_b, f_tLC*z/z_m, l_b*z/z_m], tL_mC(:,1)*kT_M);
