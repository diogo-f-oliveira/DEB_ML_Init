function [prdData, info] = predict_Cercopithecus_neglectus(par, data, auxData)
  ...
  rT_B = kT_M/ 3/ (1 + f_tW/ g);
  L = L_i - (L_i - L_b) * exp(- rT_B * tWw_f(:,1)); % cm, struc length
  EWw_f = L.^3 * (1 + f_tW * ome); % g, wet weight
  %
  tf = [0 1400 1480; f_0 f_0 f_1]';
