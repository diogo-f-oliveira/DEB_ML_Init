function [data, auxData, metaData, txtData, weights] = mydata_Decapterus_kurroides
...
metaData.species    = 'Decapterus_kurroides'; 
metaData.species_en = 'Redtail scad'; 
...
data.Lp = 17.2; units.Lp = 'cm'; label.Lp = 'total length at puberty'; bibkey.Lp = 'guess';
...
data.Wwp = 67; units.Wwp = 'g';    label.Wwp = 'wet weight at puberty';    bibkey.Wwp = 'fishbase';
  comment.Wwp = 'fishbase: based on 0.01318*Lp^3.00, see F1';
data.Wwi = 1200; units.Wwi = 'g';    label.Wwi = 'ultimate wet weight';    bibkey.Wwi = 'fishbase';
  comment.Wwi = 'fishbase: based on 0.01318*Li^3.00, see F1';

data.Ri  = 197672/365;   units.Ri  = '#/d';  label.Ri  = 'maximum reprod rate';    bibkey.Ri  = 'fishbase';  
...
%% Facts
F1 = 'length-weight: Ww in g = 0.01318*(TL in cm)^3.00';
...
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'Lava1991'; type = 'article'; bib = [ ... 
'author = {Lavapie-Gonzales, F.}, ' ...
'year = {1991}, ' ...
'title = {Growth, mortality and recruitment of \emph{Decapterus kurroides} in {D}avao {G}ulf, {P}hilippines}, ' ... 
'journal = {Fishbyte}, ' ...
'volume = {9(2)}, ' ...
'pages = {6-9}'];
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
