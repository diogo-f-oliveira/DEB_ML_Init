function [data, auxData, metaData, txtData, weights] = mydata_Viviparus_viviparus
...
metaData.species    = 'Viviparus_viviparus'; 
metaData.species_en = 'Common river snail'; 
...
data.am = 11*365; units.am = 'd';    label.am = 'life span';                bibkey.am = 'Poel1958';   
  temp.am = C2K(18);  units.temp.am = 'K'; label.temp.am = 'temperature'; 

data.Lb  = 0.4; units.Lb  = 'cm';  label.Lb  = 'shell length at birth'; bibkey.Lb  = 'Poel1958';
data.Lp  = 1.852;   units.Lp  = 'cm';  label.Lp  = 'shell length at puberty'; bibkey.Lp  = 'Poel1958';
data.Li  = 3.5;    units.Li  = 'cm';  label.Li  = 'ultimate shell length'; bibkey.Li  = 'Wiki';

data.Ri  = 65/365; units.Ri  = '#/d'; label.Ri = 'max reproduction rate';  bibkey.Ri  = 'Poel1958';   
...
comment.LWw = 'Data for C. contectus; Weight probably includes shell';
...
%% Links
metaData.links.id_CoL = '7G588'; % Cat of Life
metaData.links.id_ITIS = ''; % ITIS
metaData.links.id_EoL = '3035217'; % Ency of Life
metaData.links.id_Wiki = 'Viviparus_viviparus'; % Wikipedia
metaData.links.id_ADW = ''; % ADW
metaData.links.id_Taxo = '35158'; % Taxonomicon
metaData.links.id_WoRMS = '154008'; % WoRMS
metaData.links.id_molluscabase = '154008'; % molluscabase
