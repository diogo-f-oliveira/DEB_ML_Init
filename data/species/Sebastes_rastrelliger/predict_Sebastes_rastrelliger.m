function [prdData, info] = predict_Sebastes_rastrelliger(par, data, auxData)
  ...
  RT_i = TC * reprod_rate_j(46.5*del_M, f, pars_R); % #/d, ultimate reproduction rate at TL 45.6 cm
