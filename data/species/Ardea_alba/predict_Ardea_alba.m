function [prdData, info] = predict_Ardea_alba(par, data, auxData)
  ...
  % uni-variate data
  % time-weight -50
  tf = [5 f1_05; 10 f1_10; 20 f1_20; 30 f1_30; 50 f1_50]; tf(:,1) = tf(:,1) * kT_M;
  tvel = get_tp(pars_tp, tf, [tau_b 1 l_b], tW1(:,1)*kT_M);
  EWw_1 = (L_m * tvel(:,4)).^3 .* (1 + tvel(:,3) * ome);   % g, weight
  %
  tf = [5 f_05; 10 f_10; 20 f_20; 30 f_30; 50 f_50]; tf(:,1) = tf(:,1) * kT_M;
