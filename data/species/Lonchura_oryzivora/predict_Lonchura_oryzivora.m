function [prdData, info] = predict_Lonchura_oryzivora(par, data, auxData)
  ...
  tf = [0 5 10 20 25; f1_00 f1_05 f1_10 f1_20 f1_25]'; tf(:,1) = tf(:,1) * kT_M;
  tvel = get_tp(pars_tp, tf, [tau_b 1 l_b], tW(:,1)*kT_M);
  EWw = (L_m * tvel(:,4)).^3 .* (1 + tvel(:,3) * ome);   % g, weight
  %
  tf = [0 5 10 20 25; f2_00 f2_05 f2_10 f2_20 f2_25]'; tf(:,1) = tf(:,1) * kT_M;
