function [data, auxData, metaData, txtData, weights] = mydata_Meriones_libycus
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Mammalia'; 
metaData.order      = 'Rodentia'; 
metaData.family     = 'Muridae';
metaData.species    = 'Meriones_libycus'; 
metaData.species_en = 'Libyan jird'; 
...
data.Wwb = 5.33;   units.Wwb = 'g';     label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'AnAge';
...
data.Ri  = 5/ 365;  units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';  bibkey.Ri  = 'AnAge';   
  ...
  comment.Ri = '5 pups per litter; assumed 1 litter per yr';
...
%% Links
metaData.links.id_CoL = '7VTBN'; % Cat of Life
metaData.links.id_ITIS = '632980'; % ITIS
metaData.links.id_EoL = '1179758'; % Ency of Life
metaData.links.id_Wiki = 'Meriones_libycus'; % Wikipedia
metaData.links.id_ADW = 'Meriones_libycus'; % ADW
metaData.links.id_Taxo = '62822'; % Taxonomicon
metaData.links.id_MSW3 = '13001147'; % Mammal Spec World
metaData.links.id_AnAge = 'Meriones_libycus'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Meriones_libycus}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Meriones_libycus}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
