function [prdData, info] = predict_Cephalophus_sylvicultor(par, data, auxData)
  ...
  L_bm = l_bm * L_mm; Ww_bm = L_bm^3 * (1 + f * w_m); % g, weight at birth
  tT_pm = (t_pm - t_bm)/ kT_M; % d, time since birth at puberty for males
