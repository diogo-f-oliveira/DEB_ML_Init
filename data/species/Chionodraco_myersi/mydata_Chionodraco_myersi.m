  function [data, auxData, metaData, txtData, weights] = mydata_Chionodraco_myersi
%% set metadata
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Perciformes'; 
metaData.family     = 'Channichthyidae';
metaData.species    = 'Chionodraco_myersi'; 
metaData.species_en = 'Myers'' icefish'; 
...
%% set data
% zero-variate data
data.ab = 85;   units.ab = 'd';  label.ab = 'age at birth';                       bibkey.ab = 'guess';   
  temp.ab = C2K(-0.9); units.temp.ab = 'K'; label.temp.ab = 'temperature';
data.am = 18*365;   units.am = 'd';  label.am = 'life span';                       bibkey.am = 'MoraMora2000';   
  temp.am = C2K(-0.9); units.temp.am = 'K'; label.temp.am = 'temperature';
  
data.Lp = 27.55;  units.Lp = 'cm'; label.Lp = 'total length at puberty';  bibkey.Lp = 'fishbase'; 
  comment.Lp = 'based on Chionodraco_hamatus: 35*39.2/49.8 cm';
data.Li = 39.2; units.Li = 'cm'; label.Li = 'ultimate total length';  bibkey.Li = 'fishbase';

data.Wwb = 0.0335;  units.Wwb = 'g';  label.Wwb = 'wet weight at birth';   bibkey.Wwb = 'fishbase';
  comment.Wwb = 'based on egg diameter of 3.8-4.2 mm: pi/6*0.4^3';
data.Wwp = 120;  units.Wwp = 'g';  label.Wwp = 'wet weight at puberty';   bibkey.Wwp = 'fishbase';
  comment.Wwp = 'based on 0.00129*Lp^3.45, see F1';
data.Wwi = 405; units.Wwi = 'g';  label.Wwi = 'ultimate wet weight';   bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.00129*Li^3.45, see F1';

data.Ri = 6200/365;units.Ri = '#/d'; label.Ri = 'maximum reprod rate';    bibkey.Ri = 'fishbase';   
...
temp.tL_fm = C2K(-0.9);  units.temp.tL_fm = 'K'; label.temp.tL_fm = 'temperature';
...
%% Facts
F1 = 'length-weight: Ww in g = 0.00129*(TL in cm)^3.45';
