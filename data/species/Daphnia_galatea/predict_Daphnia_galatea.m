function [prdData, info] = predict_Daphnia_galatea(par, data, auxData)
  ...
  % reproduction
  pars_R = [kap; kap_R; g; TC*k_J; TC; L_T; v; U_Hb; U_Hp]; % compose parameter vector at T
  RT_i = TC * reprod_rate(L_i, f_tL, pars_R);
