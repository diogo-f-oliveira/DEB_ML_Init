function [data, auxData, metaData, txtData, weights] = mydata_Gambusia_punctata
...
metaData.species    = 'Gambusia_punctata'; 
metaData.species_en = 'Cuban gambusia'; 
...
data.tp = 14*7;    units.tp = 'd';    label.tp = 'time since birth at puberty for female'; bibkey.tp = 'PoncRodr2013';
  temp.tp = C2K(27.5);  units.temp.tp = 'K'; label.temp.tp = 'temperature';
data.tpm = 11*7;   units.tpm = 'd';   label.tpm = 'time since birth at puberty for male';   bibkey.tpm = 'PoncRodr2013';
...
data.Lb  = 1.221; units.Lb  = 'cm';  label.Lb = 'total length at birth';                bibkey.Lb  = 'PoncRodr2013';  
data.Lbm = 1.221; units.Lbm  = 'cm'; label.Lbm = 'total length at birth for male';      bibkey.Lbm = 'PoncRodr2013';  
data.Lp  = 4.350; units.Lp  = 'cm';  label.Lp  = 'total length at puberty for female';  bibkey.Lp  = 'PoncRodr2013';
data.Lpm = 3.302; units.Lpm = 'cm';  label.Lpm = 'total length at puberty for male';    bibkey.Lpm = 'PoncRodr2013';
data.Li  = 5.500; units.Li  = 'cm';  label.Li  = 'ultimate total length for felmale';   bibkey.Li  = 'PoncRodr2013';
data.Lim = 4.300; units.Lim = 'cm';  label.Lim = 'ultimate total length for male';      bibkey.Lim = 'PoncRodr2013';

data.Wwb = 17.8e-3; units.Wwb = 'g';   label.Wwb = 'wet weight at birth';   bibkey.Wwb = 'fishbase';
  comment.Wwb = 'based on 0.00955*Lb^3.12, see F2';
data.Wwi = 1.95;  units.Wwi = 'g';  label.Wwi = 'ultimate wet weight of female'; bibkey.Wwi = 'fishbase';
  comment.Wwb = 'based on 0.00955*Li^3.12, see F2';
data.Wwim = 0.90; units.Wwim = 'g'; label.Wwim = 'ultimate wet weight of male';  bibkey.Wwim = 'fishbase';
...
%% Links
metaData.links.id_CoL = '3F7WV'; % Cat of Life
metaData.links.id_ITIS = '647309'; % ITIS
metaData.links.id_EoL = '604097'; % Ency of Life
metaData.links.id_Wiki = 'Gambusia_punctata'; % Wikipedia
metaData.links.id_ADW = 'Gambusia_punctata'; % ADW
metaData.links.id_Taxo = '174700'; % Taxonomicon
metaData.links.id_WoRMS = '1013995'; % WoRMS
metaData.links.id_fishbase = 'Gambusia-punctata'; % fishbase


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Gambusia_punctata}}';
...
'howpublished = {\url{https://www.fishbase.de/summary/Gambusia-punctata}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
