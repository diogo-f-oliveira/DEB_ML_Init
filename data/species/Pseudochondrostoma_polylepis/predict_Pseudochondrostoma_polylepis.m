function [prdData, info] = predict_Pseudochondrostoma_polylepis(par, data, auxData)
...
%% compute temperature correction factors
  ...
  % female
  [tvel, t_j, t_p, t_b, l_j, l_p, l_b] = get_tj(pars_tj, f_tLfm, [], tL_f(:,1)*kT_M);
  ELw_f = L_m * tvel(:,4)/ del_M;   % cm, length
  % male
  tvel = get_tj(pars_tjm, f_tLfm, [t_b, f_tLfm*z/z_m, l_b*z/z_m], tL_m(:,1)*kT_M);
