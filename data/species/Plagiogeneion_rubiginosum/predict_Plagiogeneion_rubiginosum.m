function [prdData, info] = predict_Plagiogeneion_rubiginosum(par, data, auxData)
...
%   Ww_im = L_im^3 * (1 + f * ome_m);      % g, ultimate wet weight
  ...
  [t, L ] = ode45(@get_L,[0; tL(:,1)], L_b, [], T_ref, T_A, temp.tL, L_j, L_i, r_j, r_B);
  L(1) = []; ELw = L/del_M;
...
function dL = get_L(t, L, T_ref, T_A, tT, L_j, L_i, r_j, r_B)
