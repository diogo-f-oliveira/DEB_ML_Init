function [prdData, info] = predict_Catostomus_platyrhynchus(par, data, auxData)
...
%% compute temperature correction factors
  ...
  RT_13 = TC * reprod_rate_j(13.1*del_M, f, pars_R);             % #/d, reprod rate at TL 13.1 cm
  RT_18 = TC * reprod_rate_j(18.4*del_M, f, pars_R);             % #/d, reprod rate at TL 18.4 cm
