function [prdData, info] = predict_Morphnus_guianensis(par, data, auxData)
  
  % unpack par, data, auxData
  cPar = parscomp_st(par); vars_pull(par); 
  vars_pull(cPar);  vars_pull(data);  vars_pull(auxData);
  
  if f_50 < 0; info = 0; ordData = []; retunr; end
  ...
  % time-weight 
  tf = [5 f_05; 10 f_10; 30 f_30; 40 f_40; 45 f_45; 50 f_50]; tf(:,1) = tf(:,1) * kT_M;
