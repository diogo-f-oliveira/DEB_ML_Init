function [prdData, info] = predict_Moina_micrura(par, data, auxData)
  ...
  aT_b = t_0 + t_b/ kT_M;           % d, age at birth at f and T_ref
  ...
  % time-dry weight
  tvel = get_tp(pars_tp,f_tWd,[],tWd(:,1)*kT_M);
  EWd = (L_m*tvel(:,4)).^3*d_V.*(1+tvel(:,3)*ome)*1e6; % mug, dry weight
