function [prdData, info] = predict_Acanthocyclops_robustus(par, data, auxData)
  ...
  % life cycle
  pars_tjj = [g k l_T v_Hb v_Hj v_Hj+1e-8]; info = 1;
  [t_j, ~, t_b, l_j, ~, l_b, l_i, rho_j] = get_tj(pars_tjj, f);
