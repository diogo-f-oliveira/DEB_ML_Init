function [data, auxData, metaData, txtData, weights] = mydata_Systellura_longirostris
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Caprimulgiformes'; 
metaData.family     = 'Caprimulgidae';
metaData.species    = 'Systellura_longirostris'; 
metaData.species_en = 'Band-winged nightjar'; 
...
data.Wwi = 46; units.Wwi = 'g'; label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'birdlife';
...
%% Links
metaData.links.id_CoL = '544PK'; % Cat of Life
metaData.links.id_ITIS = '1077346'; % ITIS
metaData.links.id_EoL = '45512206'; % Ency of Life 
metaData.links.id_Wiki = 'Systellura_longirostris'; % Wikipedia
metaData.links.id_ADW = 'Systellura_longirostris'; % ADW
metaData.links.id_Taxo = '5692982'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = '64EDDF85732863B7'; % avibase
metaData.links.id_birdlife = 'greater-band-winged-nightjar-systellura-longirostris'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Systellura_longirostris}}';
...
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'birdlife'; type = 'Misc'; bib = ...
'howpublished = {\url{http://datazone.birdlife.org/species/factsheet/greater-band-winged-nightjar-systellura-longirostris/details}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
