function [prdData, info] = predict_Dasyurus_viverrinus(par, data, auxData)
  ...
  L_im = l_i * L_mm;                   % cm, ultimate structural length
  Lw_im = L_im/ del_M;                 % cm, ultimate total length
