function [prdData, info] = predict_Pronodularia_japanensis(par, data, auxData)
  ...
  kT_M = k_M * TC; rT_B = rho_B * kT_M; L_i = L_m * l_i; Lw_i = L_i/ del_M;
  EdLw = rT_B * (Lw_i - LdL(:,1)); % cm/d, change in shell length
