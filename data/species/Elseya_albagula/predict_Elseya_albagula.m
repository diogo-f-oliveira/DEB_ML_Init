function [prdData, info] = predict_Elseya_albagula(par, data, auxData)
  ...
  a_b = t_b/ k_M; a30_b = a_b/ TC_30; a28_b = a_b/ TC_28; % d, age at borth
  ...
  tT_pm = (t_pm - t_bm)/ kT_M; Lw_im = L_mm * f/ del_M; Lw_pm = L_mm * l_pm/ del_M;
