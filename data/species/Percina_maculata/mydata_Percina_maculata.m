  function [data, auxData, metaData, txtData, weights] = mydata_Percina_maculata
%% set metadata
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Perciformes'; 
metaData.family     = 'Percidae';
metaData.species    = 'Percina_maculata'; 
metaData.species_en = 'Blackside darter'; 
...
%% set data
% zero-variate data
data.am = 5*365;   units.am = 'd';  label.am = 'life span';                       bibkey.am = 'Karr1963';   
...
data.Ri = 1785/365;units.Ri = '#/d'; label.Ri = 'maximum reprod rate';    bibkey.Ri = 'fishbase';   
...
%% Links
metaData.links.id_CoL = '76RSM'; % Cat of Life
metaData.links.id_ITIS = '1118255'; % ITIS
metaData.links.id_EoL = '209142'; % Ency of Life
metaData.links.id_Wiki = 'Percina_maculata'; % Wikipedia
metaData.links.id_ADW = 'Percina_maculata'; % ADW
metaData.links.id_Taxo = '183481'; % Taxonomicon
metaData.links.id_WoRMS = '954586'; % WoRMS
metaData.links.id_fishbase = 'Percina-maculata'; % fishbase


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{https://en.wikipedia.org/wiki/Percina_maculata}}';  
