function [prdData, info] = predict_Lophius_litulon(par, data, auxData)
...
%% compute temperature correction factors
  ...
  Ww_b = L_b^3*(1+f*ome);           % cm, total length at birth
  ...
  RT_i = TC * reprod_rate_j(L_i, f, pars_R); % #, fecundity in 1e6 eggs
  ...
  % male
  tvel = get_tj(pars_tjm, f_tL, [t_b, z/z_m, l_b*z/z_m], tL_m(:,1)*kT_M);
