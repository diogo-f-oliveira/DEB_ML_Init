function [data, auxData, metaData, txtData, weights] = mydata_Turdus_rubrocanus
...
metaData.species    = 'Turdus_rubrocanus'; 
metaData.species_en = 'Chestnut thrush';
...
data.Wwi = 92.175; units.Wwi = 'g';  label.Wwi = 'ultimate wet weight for female';     bibkey.Wwi = 'avibase';
...
%% Links
metaData.links.id_CoL = '59PMZ'; % Cat of Life
metaData.links.id_ITIS = '563609'; % ITIS
metaData.links.id_EoL = '45518874'; % Ency of Life
metaData.links.id_Wiki = 'Turdus_rubrocanus'; % Wikipedia
metaData.links.id_ADW = 'Turdus_rubrocanus'; % ADW
metaData.links.id_Taxo = '57019'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = '82351263DEDB768A'; % avibase
metaData.links.id_birdlife = 'chestnut-thrush-turdus-rubrocanus'; % birdlife
...
'howpublished = {\url{https://avibase.bsc-eoc.org/species.jsp?lang=EN&avibaseid=82351263DEDB768A&sec=lifehistory}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
