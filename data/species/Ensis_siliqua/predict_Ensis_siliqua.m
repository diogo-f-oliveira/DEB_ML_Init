function [prdData, info] = predict_Ensis_siliqua(par, data, auxData)
  ...
  Ww_i = L_i^3 * (1 + f * ome);     % g, ultimate dry weight 
 

  % reproduction: max gonado-somatic index 
  GI = 365 * TC * k_M * g/ f^3/ (f + kap * g * y_V_E);
