function [prdData, info] = predict_Hydroprogne_caspia(par, data, auxData)
  ...
  [tau_p, tau_b, ~, l_b, info] = get_tp(pars_tp, f); if info == 0; prdData = []; return; end % -, scaled times & lengths
  ...
  % time-weight 
  tf = [5 10  20 25; f_05 f_10  f_20 f_25]'; tf(:,1) = tf(:,1) * kT_M;
