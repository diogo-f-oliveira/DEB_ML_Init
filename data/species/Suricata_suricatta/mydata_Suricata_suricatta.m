function [data, auxData, metaData, txtData, weights] = mydata_Suricata_suricatta
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Mammalia'; 
metaData.order      = 'Carnivora'; 
metaData.family     = 'Herpestidae';
metaData.species    = 'Suricata_suricatta'; 
metaData.species_en = 'Meerkat'; 
...
data.Wwb = 29;   units.Wwb = 'g';     label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'AnAge';
data.Wwx = 225.5;   units.Wwx = 'g';     label.Wwx = 'wet weight at weaning';     bibkey.Wwx = 'AnAge';
data.Wwi = 776;   units.Wwi = 'g';  label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'AnAge';
...
%% Links
metaData.links.id_CoL = '7B5YQ'; % Cat of Life
metaData.links.id_ITIS = '621906'; % ITIS
metaData.links.id_EoL = '311580'; % Ency of Life
metaData.links.id_Wiki = 'Suricata_suricatta'; % Wikipedia
metaData.links.id_ADW = 'Suricata_suricatta'; % ADW
metaData.links.id_Taxo = '67031'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_MSW3 = '14000678'; % MSW3
metaData.links.id_AnAge = 'Suricata_suricatta'; % AnAge


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Suricata_suricatta}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Suricata_suricatta}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
