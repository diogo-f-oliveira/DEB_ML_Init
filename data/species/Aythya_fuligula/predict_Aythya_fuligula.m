function [prdData, info] = predict_Aythya_fuligula(par, data, auxData)
  ...
  g_m = E_G/ (kap* E_m_m);             % -, energy investment ratio   m_Em_m = y_E_V * E_m_m/ E_G;         % mol/mol, reserve capacity 
