function [prdData, info] = predict_Geukensia_demissa(par, data, auxData)
  ...
  RT_i = TC * reprod_rate_j(7 * del_M, f, pars_R);           % #/d, reproduction rate at Lw = 7 cm
  ...
  ELw_f = L_m * tvel(:,4)/ del_M;   % cm, shell height
  % male
