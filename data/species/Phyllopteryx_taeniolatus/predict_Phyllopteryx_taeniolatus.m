function [prdData, info] = predict_Phyllopteryx_taeniolatus(par, data, auxData)
...
% zero-variate data
  ...
  Lw_i = L_m * l_i/ del_M;
  ELw = Lw_i - (Lw_i - Lw_0) * exp( - rT_B * tL(:,1)); % cm, expected length at time
  %
  ...
  ELw_1 = [L_bj; L_ji]/ del_M; % cm, standard length
