function [prdData, info] = predict_Trachurus_trachurus(par, data, auxData)
  ...
  TC_ah = tempcorr(C2K(Tah(:,1)), T_ref, T_A);
...
% zero-variate data
  ...
  a_h = aUL(2,1); aT_h = a_h/ TC_tb; % d, age at hatch at f and T
  ...
  tT_b = (t_b/ k_M - a_h)/ TC_tb;   % d, sime since hatch at birth at f and T
