function [prdData, info] = predict_Panthera_tigris_tigris(par, data, auxData)
  ...
  [t_pm, t_bm, l_pm, l_bm, info] = get_tp(pars_tpm, f, [t_b, z/z_m, l_b]);
  L_im = (f - l_T) * L_mm; L_bm = L_mm * l_bm;
  Ww_im = L_im^3 * (1 + f * ome_m);
