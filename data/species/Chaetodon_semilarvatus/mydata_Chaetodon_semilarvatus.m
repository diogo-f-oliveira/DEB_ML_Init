function [data, auxData, metaData, txtData, weights] = mydata_Chaetodon_semilarvatus
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Chaetodontiformes'; 
metaData.family     = 'Chaetodontidae';
metaData.species    = 'Chaetodon_semilarvatus'; 
metaData.species_en = 'Bluecheek butterflyfish'; 
...
data.Wwi = 278.8; units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'fishbase';
...
%% Links
metaData.links.id_CoL = 'TC4Z'; % Cat of Life
metaData.links.id_ITIS = '610328'; % ITIS
metaData.links.id_EoL = '46578222'; % Ency of Life
metaData.links.id_Wiki = 'Chaetodon_semilarvatus'; % Wikipedia
metaData.links.id_ADW = 'Chaetodon_semilarvatus'; % ADW
metaData.links.id_Taxo = '170411'; % Taxonomicon
metaData.links.id_WoRMS = '218742'; % WoRMS
metaData.links.id_fishbase = 'Chaetodon-semilarvatus'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Chaetodon_semilarvatus}}';
...
'howpublished = {\url{http://www.fishbase.org/summary/Chaetodon-semilarvatus.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
