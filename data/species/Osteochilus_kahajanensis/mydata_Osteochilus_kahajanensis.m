  function [data, auxData, metaData, txtData, weights] = mydata_Osteochilus_kahajanensis
%% set metadata
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Cypriniformes'; 
metaData.family     = 'Cyprinidae';
metaData.species    = 'Osteochilus_kahajanensis'; 
metaData.species_en = 'Palau'; 
...
data.Wwp = 21.4;  units.Wwp = 'g';  label.Wwp = 'wet weight at puberty for females';    bibkey.Wwp = {'guess','fishbase'};
  comment.Wwp = 'Based on 0.01122*Lp^3.04, see F1';
data.Wwi = 135.2; units.Wwi = 'g';  label.Wwi = 'ultimate wet weight for females';     bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.01122*Li^3.04, see F1';

% univariate data
data.Ri = 171e3/365; units.Ri = '#/d';  label.Ri = 'max reprod rate'; bibkey.Ri = 'guess';
...
%% Links
metaData.links.id_CoL = '75BBN'; % Cat of Life
metaData.links.id_ITIS = '689582'; % ITIS
metaData.links.id_EoL = '218282'; % Ency of Life
metaData.links.id_Wiki = 'Osteochilus_kahajanensis'; % Wikipedia
metaData.links.id_ADW = 'Osteochilus_kahajanensis'; % ADW
metaData.links.id_Taxo = '182298'; % Taxonomicon
metaData.links.id_WoRMS = '1021450'; % WoRMS
metaData.links.id_fishbase = 'Osteochilus-kahajanensis'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{https://en.wikipedia.org/wiki/Osteochilus_kahajanensis}}';
...
'howpublished = {\url{https://www.fishbase.se/summary/Osteochilus-kahajanensis}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
