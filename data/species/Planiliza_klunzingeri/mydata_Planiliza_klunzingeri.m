function [data, auxData, metaData, txtData, weights] = mydata_Planiliza_klunzingeri
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Mugiliformes'; 
metaData.family     = 'Mugilidae';
metaData.species    = 'Planiliza_klunzingeri'; 
metaData.species_en = 'Klunzinger''s mullet'; 
...
data.Li  = 24.4;     units.Li  = 'cm';  label.Li  = 'ultimate total length';    bibkey.Li  = 'fishbase';
...
data.Wwp = 36.3;   units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';      bibkey.Wwp = 'fishbase';
  comment.Wwp = 'based on 0.01259*Lp^2.90, see F1';
data.Wwi = 133;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight for females';      bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.01259*Li^2.90, see F1; max published weight 97.66 g';

data.Ri = 185929/365;   units.Ri = '#/d';  label.Ri = 'max reproduction rate';  bibkey.Ri = 'fishbase';   
...
%% Facts
F1 = 'length-weight: Ww in g = 0.01259*(TL in cm)^2.90';
metaData.bibkey.F1 = 'fishbase';
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = '3VQFT'; % Cat of Life
metaData.links.id_ITIS = '630324'; % ITIS
...
metaData.links.id_WoRMS = '1509598'; % WoRMS
metaData.links.id_fishbase = 'Planiliza-klunzingeri'; % fishbase
...
'howpublished = {\url{https://www.fishbase.de/summary/Planiliza_klunzingeri.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
