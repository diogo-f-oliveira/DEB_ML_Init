function [prdData, info] = predict_Dynamene_bidentata(par, data, auxData)
  ...
  TC_17 = tempcorr(temp.ab17, T_ref, T_A);
  TC_tp = tempcorr(temp.tp, T_ref, T_A);
  TC_am = tempcorr(temp.am, T_ref, T_A);
  TC_Ri = tempcorr(temp.Ri, T_ref, T_A);
  TC    = tempcorr(temp.tL_f, T_ref, T_A); kT_M = k_M * TC;
  ...
  aT_b17 = (t_0 + t_b/ k_M)/ TC_17;   % d, age at birth at f and T
  ...
  L_bm = L_mm * l_bm; Lw_bm = L_bm/ del_M; L_pm = L_mm * l_pm; Lw_pm = L_pm/ del_M; % cm, total length at puberty
