function [prdData, info] = predict_Fratercula_cirrhata(par, data, auxData)
  ...
  [t_p, t_b, ~, l_b, info] = get_tp(pars_tp, f); % -, scaled times & lengths
  ...
  % time-weight
  tf = [5 f_05; 10 f_10; 20 f_20; 30 f_30; 40 f_40]; tf(:,1) = tf(:,1) * kT_M;
