function [prdData, info] = predict_Taenioides_cirratus(par, data, auxData)
  ...
  % length-weight
  EWw = (LWF(:,1)*del_M).^3*(1 + f_tL*ome); % g, weight
  
  % length-fecundity
  EN = TC * 365 * reprod_rate_j(LWF(:,1)*del_M, f_tL, pars_R); % #, fecundity
