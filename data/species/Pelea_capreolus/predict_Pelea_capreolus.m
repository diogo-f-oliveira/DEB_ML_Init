function [prdData, info] = predict_Pelea_capreolus(par, data, auxData)
  ...
  Lw_i = L_i/ del_M;                % cm, shoulder height
  ...
  L_im = L_mm * f;                     % cm, ultimate struct length
  Lw_im = L_im/ del_M;                 % cm, shoulder height
  ...
  L = L_im - (L_im - L_bm) * exp( - rT_Bm * tL(:,1));   % cm, structural length at time
  ELw = L/ del_M;                     % cm, shoulder height
