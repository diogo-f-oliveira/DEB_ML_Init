  function [data, auxData, metaData, txtData, weights] = mydata_Coilia_ramcarati
%% set other metadata
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Clupeiformes'; 
metaData.family     = 'Engraulidae';
metaData.species    = 'Coilia_ramcarati'; 
metaData.species_en = 'Ramcarat grenadier anchovy'; 
...
data.Lp = 17.9;     units.Lp = 'cm';   label.Lp = 'total length at puberty';bibkey.Lp = 'guess';
  comment.Lp = 'based on Coilia_dussumieri: 15*25/21';
...
data.Wwp = 26;   units.Wwp = 'g';    label.Wwp = 'wet weight at puberty';    bibkey.Wwp = {'fishbase','guess'};
  comment.Wwp = 'based on 0.00380*Lp^3.06, see F1';
data.Wwi = 72;   units.Wwi = 'g';    label.Wwi = 'ultimate wet weight';    bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.00380*Li^3.06, see F1';
...
%% Facts
F1 = 'length-weight: Ww in g = 0.00380*(TL in cm)^3.06'; 
metaData.bibkey.F1 = 'fishbase'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = 'WWGN'; % Cat of Life
metaData.links.id_ITIS = '551442'; % ITIS
metaData.links.id_EoL = '46562650'; % Ency of Life
metaData.links.id_Wiki = 'Coilia'; % Wikipedia
metaData.links.id_ADW = 'Coilia_ramcarati'; % ADW
metaData.links.id_Taxo = '171571'; % Taxonomicon
metaData.links.id_WoRMS = '279085'; % WoRMS
metaData.links.id_fishbase = 'Coilia-ramcarati'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/wiki/Coilia}}';  
...
'howpublished = {\url{https://www.fishbase.se/summary/Coilia-ramcarati.html}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
