function [prdData, info] = predict_Poecilia_reticulata_LPO (par, data, auxData)
    ...
    % unpack par, data, auxData
     ...
     f1 = kap_X * spline1(1000, tpX.tL_f1)/ pT_Am/ (3.16 * del_M)^2;  % -, scaled functional response
     f2 = kap_X2 * spline1(1000, tpX.tL_f2)/ pT_Am/ (2.69 * del_M)^2;  % -, scaled functional response

       % NB 3.16 = mean max length at high food, 2.69 is mean max length at low
   ...
   % NB the development delay parameter t_0 is temperature dependent
     ...
     % This is not modelled here, instead we assume that mother at high and low    
