function [prdData, info] = predict_Heloderma_suspectum(par, data, auxData)
...
% zero-variate data
  ...
  % time-length
  Lw_i = L_m * f_tL/ del_M; rT_B = TC * k_M/ 3/ (1 + f_tL/ g); % 1/d, von Bert growth rate
  EdLw = rT_B * (Lw_i - LdL(:,1)); % cm/d, chnage in SVL
