function [prdData, info] = predict_Hexagrammos_agrammus(par, data, auxData)
  ...
  Lw_p = L_p/ del_M;                % cm, std length at puberty at f
  ...
  % males
  p_Am_m = z_m * p_M/ kap;             % J/d.cm^2, {p_Am} max spec assimilation flux for males
  E_m_m = p_Am_m/ v;                   % J/cm^3, [E_m] reserve capacity for males
  ...
  Lw_im = L_mm * l_im/ del_M;          % cm, ultimate std length
