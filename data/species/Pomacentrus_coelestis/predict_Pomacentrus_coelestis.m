function [prdData, info] = predict_Pomacentrus_coelestis(par, data, auxData)
...
% zero-variate data
  ...
  ELw_1 = [L_bj; L_jm]/ del_M; % cm, standard length
  %
  ...
  ELw_2 = [L_bj; L_jm]/ del_M; % cm, standard length
  %
  ...
  ELw_3 = [L_bj; L_jm]/ del_M; % cm, standard length
