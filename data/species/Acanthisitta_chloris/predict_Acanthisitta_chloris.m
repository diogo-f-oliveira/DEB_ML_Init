function [prdData, info] = predict_Acanthisitta_chloris(par, data, auxData)
  ...
  l_bm = get_lb([g_m; k; v_Hb], f);    % -, scaled length at birth
  L_bm = l_bm * L_mm; L_im = f * L_mm; % cm, struct length, birth & ultimate
  ...
  tf = [0 4 8 12 16 20 24; f_00 f_04 f_08 f_12 f_16 f_20 f_24]'; tf(:,1) = tf(:,1) * kT_M;
  % female
