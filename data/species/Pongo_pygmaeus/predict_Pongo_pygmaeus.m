function [prdData, info] = predict_Pongo_pygmaeus(par, data, auxData)
  ...
  % males after puberty
  p_Am_m = z_mm * p_M/ kap;             % J/d.cm^2, {p_Am} spec assimilation flux
  ...
  % time-weight  for babies
  % assume that spec assimilation jumps at puberty, so not for babies
  % female
