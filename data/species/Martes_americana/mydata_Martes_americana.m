function [data, auxData, metaData, txtData, weights] = mydata_Martes_americana
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Mammalia'; 
metaData.order      = 'Carnivora'; 
metaData.family     = 'Mustelidae';
metaData.species    = 'Martes_americana'; 
metaData.species_en = 'American marten'; 

metaData.ecoCode.climate = {'Csb','Dfa', 'Dfb'};
...
data.Wwb  = 28;   units.Wwb  = 'g';  label.Wwb  = 'wet weight at birth'; bibkey.Wwb  = 'MarkBass1942';
data.Wwx  = 392;   units.Wwx  = 'g';  label.Wwx  = 'wet weight at weaning'; bibkey.Wwx  = 'AnAge';
data.Wwi  = 1400;   units.Wwi  = 'g';  label.Wwi  = 'ultimate wet weight'; bibkey.Wwi  = 'Wiki';
...
D2 = 'Body temperare from Neovison';
...
%% Links
metaData.links.id_CoL = '3Y9VR'; % Cat of Life
metaData.links.id_ITIS = '180559'; % ITIS
metaData.links.id_EoL = '328591'; % Ency of Life
metaData.links.id_Wiki = 'Martes_americana'; % Wikipedia
metaData.links.id_ADW = 'Martes_americana'; % ADW
metaData.links.id_Taxo = '66667'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_MSW3 = '14001204'; % MSW3
metaData.links.id_AnAge = 'Martes_americana'; % AnAge


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Martes_americana}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Martes_americana}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
