function [prdData, info] = predict_Margaritifera_margaritifera(par, data, auxData)
  ...
  kT_M = k_M * TC_tL3; rT_B = rho_B * kT_M; L_j = L_m * l_j; L_i = L_m * l_i;
  L = L_i - (L_i - L_j) * exp(- rT_B * tL3(:,1));
  ELw_3 = L/ del_M; 
