function [prdData, info] = predict_Eptatretus_stoutii(par, data, auxData)  
  ...
  %% uni-variate data
  % length - length
  rT_B = kT_M/ 3/ (1 + g/ f); % 1/d, von Bert growth rate
  ELw = LL(:,1) + 365 * rT_B * (Lw_i - LL(:,1)); % cm, total length at t+1yr
