function [data, auxData, metaData, txtData, weights] = mydata_Streptoprocne_zonaris
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Apodiformes'; 
metaData.family     = 'Apodidae';
metaData.species    = 'Streptoprocne_zonaris'; 
metaData.species_en = 'White-collared swift'; 
...
data.Ww0 = 10.6;    units.Ww0 = 'g';   label.Ww0 = 'initial wet weight';     bibkey.Ww0 = 'MariStil1993';
data.Wwb = 9.0;    units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'MariStil1993';
...
%% Links
metaData.links.id_CoL = '52YVZ'; % Cat of Life
metaData.links.id_ITIS = '178023'; % ITIS
metaData.links.id_EoL = '45510759'; % Ency of Life
metaData.links.id_Wiki = 'Streptoprocne_zonaris'; % Wikipedia
metaData.links.id_ADW = 'Streptoprocne_zonaris'; % ADW
metaData.links.id_Taxo = '54859'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = '88D7E68DB7827611'; % avibase
metaData.links.id_birdlife = 'white-collared-swift-streptoprocne-zonaris'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% Discussion points
D1 = 'Feeding is reduced just before fledge';
D2 = 'Males are assumed not to differ from females';
D3 = 'mod_1: v is reduced; Ww0 ignorned due to inconsistency with Wwb';
D4 = 'mod_2: Pseudo-data point k is used, rather than k_J; Data set tp and parameter t_R are added, the latter replacing clutch interval t_N. Postnatal T is based on PrinPres1991, see <a href="https://debtool.debtheory.org/lib/pet/html/get_T_Aves.html">get_T_Aves</a>. See further the <a href="https://debportal.debtheory.org/docs/Revision.html">revision page, theme puberty</a>';
metaData.discussion = struct('D1',D1, 'D2',D2, 'D3',D3, 'D4',D4);

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Streptoprocne_zonaris}}';
...
'howpublished = {\url{https://avibase.bsc-eoc.org/species.jsp?lang=EN&avibaseid=88D7E68DB7827611&sec=lifehistory}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
