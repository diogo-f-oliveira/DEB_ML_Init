function [prdData, info] = predict_Sarcophilus_harrisii(par, data, auxData)
  ...
  Lw_im = l_i * L_mm/ del_M;           % cm, ultimate total length
  ...
  % univariate data
  % time-weight
  rT_B = TC_am * k_M/ 3/ (1 + f * w); % 1/d, von Bert growth rate
