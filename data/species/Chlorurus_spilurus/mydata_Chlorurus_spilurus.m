function [data, auxData, metaData, txtData, weights] = mydata_Chlorurus_spilurus
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Labriformes'; 
metaData.family     = 'Scaridae';
metaData.species    = 'Chlorurus_spilurus'; 
metaData.species_en = 'Pacific bullethead parrotfish'; 
...
data.Lp  = 26; units.Lp  = 'cm';  label.Lp  = 'total length at puberty'; bibkey.Lp  = 'guess'; 
data.Lim  = 48.6;  units.Lim  = 'cm';  label.Lim  = 'ultimate total length'; bibkey.Lim  = 'fishbase';
...
data.Wwp = 244; units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';   bibkey.Wwp = {'fishbase','guess'};
  comment.Wwp = 'based on 0.01259*Lp^3.03, see F1';
data.Wwi = 1.6e3; units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.01259*Li^3.03, see F1; max published weight 2.7 kg';
...
%% Facts
F1 = 'weight-length relationship: W in g = 0.01259*(TL in cm)^3.03';
metaData.bibkey.F1 = 'fishbase'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = '5XYWP'; % Cat of Life
metaData.links.id_ITIS = ''; % ITIS
metaData.links.id_EoL = '46572695'; % Ency of Life
metaData.links.id_Wiki = 'Chlorurus_spilurus'; % Wikipedia
metaData.links.id_ADW = ''; % ADW
metaData.links.id_Taxo = '1683141'; % Taxonomicon
metaData.links.id_WoRMS = '712772'; % WoRMS
metaData.links.id_fishbase = 'Chlorurus-spilurus'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Chlorurus_spilurus}}';
...
'howpublished = {\url{https://www.fishbase.de/summary/Chlorurus-spilurus.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
