function [data, auxData, metaData, txtData, weights] = mydata_Microcarbo_africanus

metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Suliformes'; 
metaData.family     = 'Phalacrocoracidae';
metaData.species    = 'Microcarbo_africanus'; 
metaData.species_en = 'Reed cormorant';
...
data.tx = 35;     units.tx = 'd';    label.tx = 'time since birth at fledging';  bibkey.tx = 'Kopi1996';   
...
data.Wwb = 12;  units.Wwb = 'g';  label.Wwb = 'wet weight at birth';               bibkey.Wwb = 'Kopi1996';
data.Wwi = 513;  units.Wwi = 'g';  label.Wwi = 'ultimate wet weight for females'; bibkey.Wwi = 'avibase';
data.Wwim = 568.5;  units.Wwim = 'g';  label.Wwim = 'ultimate wet weight for males'; bibkey.Wwim = 'avibase';
...
%% Links
metaData.links.id_CoL = '42S9D'; % Cat of Life
metaData.links.id_ITIS = '823997'; % ITIS
metaData.links.id_EoL = '45518911'; % Ency of Life
metaData.links.id_Wiki = 'Microcarbo_africanus'; % Wikipedia
metaData.links.id_ADW = 'Phalacrocorax_africanus'; % ADW
metaData.links.id_Taxo = '2682347'; % Taxonomicon
metaData.links.id_WoRMS = '212701'; % WoRMS
metaData.links.id_avibase = 'E255DCE15494936B'; % avibase
metaData.links.id_birdlife = 'long-tailed-cormorant-microcarbo-africanus'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Microcarbo_africanus}}';
...
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'Kopi1996'; type = 'Article'; bib = [ ... 
'author = {Grzegorz Kopij}, ' ... 
'year = {1996}, ' ...
'title = {Breeding and feeding ecology of the Reed Cormorant \emph{Phalacrocorax africanus} in the {F}ree {S}tate, {S}outh {A}frica}, ' ...
