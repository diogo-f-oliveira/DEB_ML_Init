function [prdData, info] = predict_Macruronus_novaezelandiae(par, data, auxData) 
  ...
  tT_p = (t_p - t_b)/ kT_M;            % d, age at puberty
  ...
  L_im = L_mm * l_i;                   % cm, ultimate total length 
 ...
 % uni-variate data
  ...
  % male
  tvel = get_tj(pars_tjm, f_tL, [0, f_tL*z/z_m, l_b*z/z_m], tL_m(:,1)*kT_M);
