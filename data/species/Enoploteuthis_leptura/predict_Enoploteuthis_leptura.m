function [prdData, info] = predict_Enoploteuthis_leptura(par, data, auxData)
  ...
  Ni = cum_reprod_j(300, f, pars_R); % #, fecundity
  ...
  % male
  tvel = get_tj(pars_tjm, f, [t_b, f, l_b], tL_m(:,1)*kT_M);
  ...
  % male
  tvel = get_tj(pars_tjm, f, [t_b, f, l_b], tWw_m(:,1)*kT_M);
