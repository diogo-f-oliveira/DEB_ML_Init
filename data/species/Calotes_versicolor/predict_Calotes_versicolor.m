...
function [prdData, info] = predict_Calotes_versicolor(par, data, auxData)
...
% zero-variate data
  ...
  a_b = t_b/ k_M; aT_b = t_0 + a_b/ TC;   % d, age at birth at f and T
  ...
  Lw_i = L_i/ del_M;                % cm, ultimate pSVL at f
  ...
  L_pm = L_m * l_pm; Lw_pm = L_pm/ del_M; % cm, SVL at puberty at f
  ...
  ELw_1 = (L_i - (L_i - L_b) * exp(- rT_B * tL1(:,1)))/ del_M; % cm, SVL
