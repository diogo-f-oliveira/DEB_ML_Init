function [prdData, info] = predict_Zoarces_elongatus(par, data, auxData)
  ...
  RT_i = TC * reprod_rate_j(20 * del_M, f, pars_R);        % #/d, reproduction rate at 20 cm
  ...
  % length-fecundity
  EN = 365 * TC * reprod_rate_j(LN(:,1) * del_M, f, pars_R);        % #/d, ultimate reproduction rate
