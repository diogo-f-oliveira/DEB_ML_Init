function [prdData, info] = predict_Pinicola_enucleator(par, data, auxData)
  ...
  tf = [2 f_02; 4 f_04; 6 f_06]; tf(:,1) = tf(:,1) * kT_M;
  l_0 = (Ww_tW0/ (1 + f * ome))^(1/3)/ L_m; % -, scaled initial struc length
  tvel = get_tp(pars_tp, tf, [tau_b 1 l_0], tW(:,1)*kT_M);
