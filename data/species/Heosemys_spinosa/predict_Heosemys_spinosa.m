function [prdData, info] = predict_Heosemys_spinosa(par, data, auxData)
  ...
  % length-weight
  EWw_f = (LWw_f(:,1)*del_M).^3*(1 + f_tW * w); % g, wet weight
  EWw_m = (LWw_m(:,1)*del_M).^3*(1 + f_tW * w_m); % g, wet weight
