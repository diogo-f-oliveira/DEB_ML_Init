function [prdData, info] = predict_Etheostoma_barbouri(par, data, auxData)
...
%% compute temperature correction factors
  ...
  ELw = L/ del_M; EWw = L.^3 * (1 + f_tL * ome); % cm,g std length, wet weight
  
  % length - weight
  EWw_L = (LWw(:,1) * del_M).^3 * (1 + f_tL * ome); % g, wet weight
