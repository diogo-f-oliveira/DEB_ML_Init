function [prdData, info] = predict_Ceriodaphnia_reticulata(par, data, auxData)
  ...
  TC_LN = tempcorr(temp.LN, T_ref, T_A); kT_M = TC * k_M;
  ...
  ELw = L_m * tvel(:,4)/ del_M; % cm, length at time
    
  EN = TC_LN * 2 * reprod_rate(LN(:,1)*del_M, f, pars_R); % #, fecundity
