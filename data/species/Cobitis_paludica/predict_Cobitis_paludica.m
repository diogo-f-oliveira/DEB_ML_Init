function [prdData, info] = predict_Cobitis_paludica(par, data, auxData)
...
%% compute temperature correction factors
  ...
  Ri = TC * reprod_rate_j(9*del_M, f, pars_R);                 % #/d, reprod rate at TL 9 cm
  ...
  L_im = L_mm * l_im; Lw_im = L_im/ del_M; % cm, total length
