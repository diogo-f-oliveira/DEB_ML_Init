function [prdData, info] = predict_Ursus_maritimus(par, data, auxData)
  ...
  [t_pm, t_bm, l_pm, l_bm, info] = get_tp(pars_tpm, f_tW, [t_b, f_tW*z/z_m, l_b*z/z_m]); 
  L_bm = L_mm * l_bm;                  % Length at birth
  ...
  L_im = (f - l_T) * L_mm;             % Ultimate length
  Lw_im = L_im/ del_M;                 % ultimate physical length
