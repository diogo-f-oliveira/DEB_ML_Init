function [prdData, info] = predict_Neolepton_cobbi(par, data, auxData)
  ...
  [t L] = ode45(@get_L, [0; tL(:,1)], L_b, [], r_B, L_i, T_ref, T_A);
...
function dL = get_L(t, L, r_B, L_i, T_ref, T_A)
  TC = tempcorr(C2K(9+5*sin(2*pi*(t-120)/365)), T_ref, T_A);
  dL = TC * r_B * (L_i - L);
end
