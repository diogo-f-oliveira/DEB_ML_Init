function [prdData, info] = predict_Scapholeberis_mucronata(par, data, auxData)
  ...
  % tN-data
  pars_R = [kap; kap_R; g; TC_10 * k_J; TC_10 * k_M; L_T; TC_10 * v; U_Hb/ TC_15; U_Hp/ TC_15]; % compose parameter vector at T
