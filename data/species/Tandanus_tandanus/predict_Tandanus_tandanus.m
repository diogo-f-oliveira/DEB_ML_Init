function [prdData, info] = predict_Tandanus_tandanus(par, data, auxData)
  ...
  EWw = (tvel(:,4)*L_m).^3.*(1+tvel(:,3)*ome); % g, weight at 30 d
  ...
  EN = TC * 365 * reprod_rate_j(L, f_tL, pars_R); % #, yearly fecundity
