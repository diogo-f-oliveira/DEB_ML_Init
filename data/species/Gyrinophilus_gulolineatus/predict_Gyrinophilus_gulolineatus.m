function [prdData, info] = predict_Gyrinophilus_gulolineatus(par, data, auxData)
  ...
  rT_B = TC * k_M/ 3/ (1 + f_LL/ g); L_i = f_LL * L_m; L_b = L_m * get_lb([g; k; v_Hb], f_LL);
  ELw = (L_i - (L_i - L_b) * exp(-rT_B * time.LL))/ del_M;
