function [data, auxData, metaData, txtData, weights] = mydata_Corvus_corax
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Passeriformes'; 
metaData.family     = 'Corvidae';
metaData.species    = 'Corvus_corax'; 
metaData.species_en = 'Common raven'; 

metaData.ecoCode.climate = {'BSk', 'Cfb', 'Df'};
...
data.tx = 30;    units.tx = 'd';    label.tx = 'time since birth at fledging'; bibkey.tx = 'WhitMarz1998';   
...
data.Wwb = 34;    units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'WhitMarz1998';
...
%% Links
metaData.links.id_CoL = 'YNHG'; % Cat of Life
metaData.links.id_ITIS = '179725'; % ITIS
metaData.links.id_EoL = '45510016'; % Ency of Life
metaData.links.id_Wiki = 'Corvus_corax'; % Wikipedia
metaData.links.id_ADW = 'Corvus_corax'; % ADW
metaData.links.id_Taxo = '59526'; % Taxonomicon
metaData.links.id_WoRMS = '159389'; % WoRMS
metaData.links.id_avibase = 'B9B272F40EE1570F'; % avibase
metaData.links.id_birdlife = 'common-raven-corvus-corax'; % birdlife
metaData.links.id_AnAge = 'Corvus_corax'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Corvus_corax}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Corvus_corax}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
