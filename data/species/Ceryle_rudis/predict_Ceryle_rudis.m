function [prdData, info] = predict_Ceryle_rudis(par, data, auxData)
  ...
  % uni-variate data
  % time-weight  
  tf = [0 10 20 25 30; f_00 f_10 f_20 f_25 f_30]'; tf(:,1) = tf(:,1) * kT_M;
  ...
  EJX = (L_m * tvel(:,4)).^2 .* spline1(tvel(:,1), tf) * TC * p_Am/ kap_X/ mu_X * w_X/ d_X; % g/d, food consumption
