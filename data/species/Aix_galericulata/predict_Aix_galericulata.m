...
function [prdData, info] = predict_Aix_galericulata(par, data, auxData)
...
% uni-variate data
  ...
  % time-weight
  tf = [05 10 30 50 ; f_05 f_10 f_30 f_50 ]'; tf(:,1) = tf(:,1) * kT_M;
  % female
  [tvel, tau_p, tau_b, l_p, l_b] = get_tp(pars_tp, tf, [], tW_f(:,1)*kT_M);
