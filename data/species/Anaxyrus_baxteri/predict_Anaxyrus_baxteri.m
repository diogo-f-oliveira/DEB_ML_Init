function [prdData, info] = predict_Anaxyrus_baxteri(par, data, auxData)
  ...
  % puberty for toad
  tT_p = (t_p - t_j)/ k_M/ TC;   % d, time since birth at puberty at f and T
  ...
  % t-W data 
  L_0 = (Ww_0/ (1 + f * w))^(1/3); % cm, initial structural length 
