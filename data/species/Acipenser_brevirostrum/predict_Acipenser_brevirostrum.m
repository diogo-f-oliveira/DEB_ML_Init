function [prdData, info] = predict_Acipenser_brevirostrum(par, data, auxData)  
  ...
  TC_ab = tempcorr(C2K(Tab(:,1)), T_ref, T_A); kT_M = TC * k_M;
  ...
  EWw = L.^3 * (1 + f_tL * ome);                   % cm, gtotal length
