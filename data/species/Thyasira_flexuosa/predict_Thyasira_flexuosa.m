function [prdData, info] = predict_Thyasira_flexuosa(par, data, auxData)
...
% % zero-variate data
  ...
  % settlement
  L_j = L_m * l_j;                  % cm, structural length at settlement at f
  Lw_j = L_j/ del_M;                % cm, physical length at settlement at f
