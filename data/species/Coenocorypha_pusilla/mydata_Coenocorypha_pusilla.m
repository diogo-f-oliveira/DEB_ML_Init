function [data, auxData, metaData, txtData, weights] = mydata_Coenocorypha_pusilla
...
metaData.species    = 'Coenocorypha_pusilla'; 
metaData.species_en = 'Chatham snipe'; 
...
data.ab = 23;      units.ab = 'd';    label.ab = 'age at birth';           bibkey.ab = 'Misk1999';   
  temp.ab = C2K(36); units.temp.ab = 'K'; label.temp.ab = 'temperature';
data.tx = 41;      units.tx = 'd';     label.tx = 'time since birth at fledging'; bibkey.tx = 'Misk1999';   
...
data.Wwb = 11.0;    units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'Misk1999';
data.Wwi = 70;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight for female'; bibkey.Wwi = 'Misk1999';
...
%% Links
metaData.links.id_CoL = '5ZJSZ'; % Cat of Life
metaData.links.id_ITIS = '559383'; % ITIS
metaData.links.id_EoL = '1049598'; % Ency of Life
metaData.links.id_Wiki = 'Coenocorypha_pusilla'; % Wikipedia
metaData.links.id_ADW = 'Coenocorypha_pusilla'; % ADW
metaData.links.id_Taxo = '158863'; % Taxonomicon
metaData.links.id_WoRMS = '225898'; % WoRMS
metaData.links.id_avibase = '168E36269B6A854B'; % avibase
metaData.links.id_birdlife = 'chatham-snipe-coenocorypha-pusilla'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Coenocorypha_pusilla}}';
