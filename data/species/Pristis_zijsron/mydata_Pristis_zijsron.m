function [data, auxData, metaData, txtData, weights] = mydata_Pristis_zijsron
...
metaData.species    = 'Pristis_zijsron'; 
metaData.species_en = 'Longcomb sawfish';
...
data.am = 53*365;  units.am = 'd';    label.am = 'life span';              bibkey.am = 'Peve2010';   
  temp.am = C2K(28.5); units.temp.am = 'K'; label.temp.am = 'temperature';

data.Lb  = 80;     units.Lb  = 'cm';  label.Lb  = 'total length at birth'; bibkey.Lb  = 'Wiki';
data.Lp  = 430;    units.Lp  = 'cm';  label.Lp  = 'total length at puberty';bibkey.Lp  = 'guess'; 
data.Li  = 730;    units.Li  = 'cm';  label.Li  = 'ultimate total length'; bibkey.Li  = 'fishbase';

data.Wwi = 2.7e6; units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';   bibkey.Wwi = 'fishbase';
...
data.Ri  = 12/365/2; units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';   bibkey.Ri  = 'fishbase';   
  ...
  comment.Ri = '12 pups per clutch; possibily 1 litter per 2 yr';
...
%% Links
metaData.links.id_CoL = '9KD2K'; % Cat of Life
metaData.links.id_ITIS = '564305'; % ITIS
metaData.links.id_EoL = '46560362'; % Ency of Life
metaData.links.id_Wiki = 'Pristis_zijsron'; % Wikipedia
metaData.links.id_ADW = 'Pristis_zijsron'; % ADW
metaData.links.id_Taxo = '42018'; % Taxonomicon
metaData.links.id_WoRMS = '217375'; % WoRMS
metaData.links.id_fishbase = 'Pristis-zijsron'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Pristis_zijsron}}'; 
...
'howpublished = {\url{https://www.fishbase.se/summary/Pristis-zijsron.html}}';   
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
