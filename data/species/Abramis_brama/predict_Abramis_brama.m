function [prdData, info] = predict_Abramis_brama(par, data, auxData)
...
%% compute temperature correction factors
  ...
  % males
  [t_jm, t_pm, t_bm, l_jm, l_pm, l_bm, l_im, rho_jm, rho_Bm] = get_tj(pars_tjm, f);
  rT_Bm = rho_Bm * kT_M; tT_jm = (t_jm - t_bm)/ kT_M; L_jm = L_m * l_jm; L_im = L_m * l_im;
  ELw_m = (L_im - (L_im - L_jm) * exp( - rT_Bm * (tL_m(:,1) - tT_jm)))/ del_M; % cm, total length
