function [prdData, info] = predict_Stenodus_nelma(par, data, auxData)
...
%% compute temperature correction factors
  ...
  l_0 = (W_0/(1+f_tW*ome))^(1/3)/L_m; % -, scaled initial length
  tvel = get_tj(pars_tj, f_tW, [0 f_tW l_0], tW(:,1)*k_M);
