function [prdData, info] = predict_Notropis_blennius(par, data, auxData)
...
%% compute temperature correction factors
  ...
  RT_7 = TC * reprod_rate_j(7.1*del_M, f_tL, pars_R);  % #/d, reprod rate at TL 7.1 cm
  RT_9 = TC * reprod_rate_j(9.1*del_M, f_tL, pars_R);  % #/d, reprod rate at TL 9.1 cm
