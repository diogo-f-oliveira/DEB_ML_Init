function [prdData, info] = predict_Cheilinus_undulatus(par, data, auxData)
  ...
  aT_p = (tau_p-tau_b)/ kT_M;       % d, time since birth at puberty at f and T
  ...
  L_im = L_mm * l_im; Lw_im = L_im/ del_M; Ww_im = L_im^3 * (1 + f * ome_m); 
