  function [data, auxData, metaData, txtData, weights] = mydata_Rasbora_dusonensis
%% set metadata
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Cypriniformes'; 
metaData.family     = 'Cyprinidae';
metaData.species    = 'Rasbora_dusonensis'; 
metaData.species_en = 'Rosefin rasbora'; 
...
data.Wwp = 3.3;  units.Wwp = 'g';  label.Wwp = 'wet weight at puberty for females';    bibkey.Wwp = {'guess','fishbase'};
  comment.Wwp = 'Based on 0.00851*Lp^3.07, see F1';
data.Wwi = 17.5; units.Wwi = 'g';  label.Wwi = 'ultimate wet weight for females';     bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.00851*Li^3.07, see F1';

% univariate data
data.Ri = 41e3/365; units.Ri = '#/d';  label.Ri = 'max reprod rate'; bibkey.Ri = 'guess';
...
%% Facts
F1 = 'length-weight: Ww (in g) = 0.00851*(TL in cm)^3.07';
metaData.bibkey.F1 = 'fishbase'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = '6WT66'; % Cat of Life
metaData.links.id_ITIS = '689901'; % ITIS
metaData.links.id_EoL = '213399'; % Ency of Life
metaData.links.id_Wiki = 'Rasbora_dusonensis'; % Wikipedia
metaData.links.id_ADW = 'Rasbora_dusonensis'; % ADW
metaData.links.id_Taxo = '185759'; % Taxonomicon
metaData.links.id_WoRMS = '1021818'; % WoRMS
metaData.links.id_fishbase = 'Rasbora-dusonensis'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{https://en.wikipedia.org/wiki/Rasbora_dusonensis}}';
...
'howpublished = {\url{https://www.fishbase.se/summary/Rasbora-dusonensis}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
