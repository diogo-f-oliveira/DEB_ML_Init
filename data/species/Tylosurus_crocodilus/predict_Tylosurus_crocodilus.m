function [prdData, info] = predict_Tylosurus_crocodilus(par, data, auxData)
  ...
  [t_j, t_p, t_b, l_j, l_p, l_b, info] = get_tj(pars_tj, f); % -, scaled times & lengths at f
  ...
  Lw_p = L_p/ del_M;                % cm, total length at puberty for female
