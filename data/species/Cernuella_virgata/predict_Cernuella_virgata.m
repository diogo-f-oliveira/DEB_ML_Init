function [prdData, info] = predict_Cernuella_virgata(par, data, auxData)
  ...
  L_bj = L_b * exp(365 * tW((365 * tW(:,1) <= tT_j),1) *  rT_j/ 3);
  L_ji = L_i - (L_i - L_j) * exp( - rT_B * (365 * tW((365 * tW(:,1) > tT_j),1) - tT_j)); % cm, structural length at time
