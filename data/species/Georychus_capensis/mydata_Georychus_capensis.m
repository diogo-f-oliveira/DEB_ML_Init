function [data, auxData, metaData, txtData, weights] = mydata_Georychus_capensis
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Mammalia'; 
metaData.order      = 'Rodentia'; 
metaData.family     = 'Bathyergidae';
metaData.species    = 'Georychus_capensis'; 
metaData.species_en = 'Cape mole-rat'; 
...
data.Wwb = 6;   units.Wwb = 'g';     label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'BennJarv1991';
data.Wwx = 36;   units.Wwx = 'g';     label.Wwx = 'wet weight at weaning';     bibkey.Wwx = 'AnAge';
data.Wwi = 181;   units.Wwi = 'g';  label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'AnAge';
...
%% Links
metaData.links.id_CoL = '3FS57'; % Cat of Life
metaData.links.id_ITIS = '584675'; % ITIS
metaData.links.id_EoL = '326230'; % Ency of Life
metaData.links.id_Wiki = 'Georychus_capensis'; % Wikipedia
metaData.links.id_ADW = 'Georychus_capensis'; % ADW
metaData.links.id_Taxo = '63623'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_MSW3 = '13400027'; % MSW3
metaData.links.id_AnAge = 'Georychus_capensis'; % AnAge


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Georychus_capensis}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Georychus_capensis}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
