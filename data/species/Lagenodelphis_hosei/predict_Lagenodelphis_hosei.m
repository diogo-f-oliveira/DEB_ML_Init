function [prdData, info] = predict_Lagenodelphis_hosei(par, data, auxData)
  ...
  %
  L_b = L_m * get_lb([g k v_Hb], f_tL1); L_i = L_m * f_tL1;
  rT_B = TC * k_M/ 3/ (1 + f_tL1/ g); % 1/d, von Bert growth rate
  L = L_i - (L_i - L_b) * exp( - rT_B * tL1(:,1)); % cm, struct length
