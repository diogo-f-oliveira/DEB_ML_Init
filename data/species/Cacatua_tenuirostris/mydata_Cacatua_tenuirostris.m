function [data, auxData, metaData, txtData, weights] = mydata_Cacatua_tenuirostris
...
metaData.species    = 'Cacatua_tenuirostris'; 
metaData.species_en = 'Long-billed corella'; 
...
metaData.ecoCode.food    = {'biHs', 'biHr'};
...
data.ab = 24;    units.ab = 'd';    label.ab = 'age at birth';                      bibkey.ab = 'Wiki';   
...
data.Wwb = 15;  units.Wwb = 'g';   label.Wwb = 'wet weight at birth';             bibkey.Wwb = 'Pfei1986';
  comment.Wwb = '14 till 20 g';
data.Wwi = 567;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';             bibkey.Wwi = 'Wiki';
...
%% Links
metaData.links.id_CoL = 'P57N'; % Cat of Life
metaData.links.id_ITIS = '554847'; % ITIS
metaData.links.id_EoL = '1178090'; % Ency of Life
metaData.links.id_Wiki = 'Cacatua_tenuirostris'; % Wikipedia
metaData.links.id_ADW = 'Cacatua_tenuirostris'; % ADW
metaData.links.id_Taxo = '54184'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = 'F2A2FB6A910FE3C8'; % avibase
metaData.links.id_birdlife = 'long-billed-corella-cacatua-tenuirostris'; % birdlife
metaData.links.id_AnAge = 'Cacatua_tenuirostris'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Cacatua_tenuirostris}}';
...
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'Pfei1986'; type = 'Article'; bib = [ ... 
'author = {C. Pfeifer}, ' ... 
'year = {1986}, ' ...
'title = {Breeding and hand-rearing of the long-billed corella \emph{Cacatua t. tenuirostris} at the {Birmingham Zoo}}, ' ...
'journal = {Int. Zoo Yb.}, ' ...
'volume = {24/25}, ' ...
'pages = {253-256}']; 
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Cacatua_tenuirostris}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
