function [prdData, info] = predict_Trematomus_lepidorhinus(par, data, auxData)
...
%% compute temperature correction factors
  ...
  % time-length
  % female
  %tf = [500 f_00500; 1000 f_01000; 2000 f_02000; 4000 f_04000; 6000 f_06000]; tf(:,1) = tf(:,1)*kT_M;
  tvel = get_tj(pars_tj, f_tL, [], tL(:,1)*kT_M);
  ELw_f = L_m * tvel(:,4)/ del_M;   % cm, length
  % males
  tvel = get_tj(pars_tjm, f_tL, [0 1 l_b*z/z_m], tL(:,1)*kT_M);
