...
units.tW_f   = {'d', 'g'};  label.tW_f = {'time since puberty', 'wet tissue weight', 'female'};  
...
units.tW_m   = {'d', 'g'};  label.tW_m = {'time since puberty', 'wet tissue weight', 'male'};  
temp.tW_m = C2K(27);  units.temp.tW_m = 'K'; label.temp.tW_m = 'temperature';
bibkey.tW_m = 'Appe1988';
comment.tW_m = 'Data for males; time reconstructed from shell lip thickness, which is zero at ap';
...
%% Links
metaData.links.id_CoL = '7PX48'; % Cat of Life
metaData.links.id_ITIS = '564653'; % ITIS
metaData.links.id_EoL = '455238'; % Ency of Life
metaData.links.id_Wiki = 'Aliger_gigas'; % Wikipedia
metaData.links.id_ADW = 'Strombus_gigas'; % ADW
metaData.links.id_Taxo = '3964489'; % Taxonomicon
metaData.links.id_WoRMS = '1429769'; % WoRMS
metaData.links.id_molluscabase = '1429769'; % molluscabase
