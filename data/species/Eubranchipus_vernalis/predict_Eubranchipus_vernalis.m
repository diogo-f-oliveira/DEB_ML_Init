function [prdData, info] = predict_Eubranchipus_vernalis(par, data, auxData)
  ...
  tTC_43 = temp.tL43; tTC_43(:,2)= tempcorr(C2K(tTC_43(:,2)), T_ref, T_A);
  tTC_44 = temp.tL44; tTC_44(:,2)= tempcorr(C2K(tTC_44(:,2)), T_ref, T_A);
...
%   Ww_im = L_im^3 * (1 + f * w_m);      % g, ultimate wet weight
  ...
  % time-length
  tf = [10 f43_10; 20 f43_20; 40 f43_40; 60 f43_60];
  [tau_j, tau_p, tau_b, l_j, l_p, l_b, l_i, rho_j, rho_B] = get_tj(pars_tj, f43_40);
  [t, HeL] = ode45(@get_HeL, [0;tL43(:,1)], [E_Hb 1 L_m*l_b], [], tf, tTC_43, v, g, E_m, L_b, L_m, kap, k_J, E_Hj); 
  HeL(1,:)=[]; ELw_43 = HeL(:,3)/del_M;
  %
  tf = [10 f44_10; 20 f44_20; 40 f44_40];
  [tau_j, tau_p, tau_b, l_j, l_p, l_b, l_i, rho_j, rho_B] = get_tj(pars_tj, f44_40);
  [t, HeL] = ode45(@get_HeL, [0;tL44(:,1)], [E_Hb 1 L_m*l_b], [], tf, tTC_44, v, g, E_m, L_b, L_m, kap, k_J, E_Hj); 
  HeL(1,:)=[]; ELw_44 = HeL(:,3)/del_M;
