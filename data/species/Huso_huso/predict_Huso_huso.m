function [prdData, info] = predict_Huso_huso(par, data, auxData)
  ...
  pars_lb = [g; k; v_Hb];   [l_b, info] = get_lb(pars_lb, f_tL); Lw_b = l_b * L_m/ del_M; % cm, total length at birth
  Lw_i = (f_tL * L_m - L_T)/ del_M; % cm, ultimate total length
