function [prdData, info] = predict_Vipera_aspis(par, data, auxData)
  ...
  aT_b = t_b/ k_M/ TC_ab;           % d, ahe at birth
  ...
  L = L_i - (L_i - L_b) * exp( - rT_B * tLW(:,1));
  ELw = L/ del_M; EWw = L.^3 * (1 + f_tL/ g); % cm, g, total length, weight
