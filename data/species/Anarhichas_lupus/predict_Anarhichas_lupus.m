function [prdData, info] = predict_Anarhichas_lupus(par, data, auxData)
  ...
  TC_R125 = tempcorr(temp.R125, T_ref, T_A);
...
% zero-variate data
  ...
  RT_125 = TC_R125 * reprod_rate_j(125 * del_M, f, pars_R);       % #/d, reproduction rate at 125 cm
