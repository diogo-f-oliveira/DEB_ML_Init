function [prdData, info] = predict_Apalone_mutica(par, data, auxData)
  ...
  % male
  [tvel, t_pm, t_bm, l_pm, l_bm] = get_tpm(pars_tpm, f_tL, [t_b, f_tL*z/z_m, l_b*z/z_m], tL_m(:,1)*kT_M);
