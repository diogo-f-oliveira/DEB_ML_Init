function [prdData, info] = predict_Atheresthes_stomias(par, data, auxData)
  ...
  % time-length
  tf = [1000 f_1000; 4000 f_4000]; tf(:,1) = tf(:,1)*kT_M;
  % female
  ...
  EN_W = TC * 365*reprod_rate_j((WN(:,1)/(1 + f/g)).^(1/3), f, pars_R); % #, fecundity
