function [prdData, info] = predict_Leiosolenus_patagonicus(par, data, auxData)
  ...
  % reproduction GSI
  GSI = TC * 365 * k_M * g/ f.^3./ (f + kap * g * y_V_E);  % see eqn 2 LikaKooy2014
  GSI = GSI .* ((1 - kap) * f.^3 - ...
     k_M^2 * g^2 * k_J * U_Hp/ v^2/ s_M^3); % mol E_R/ mol W, gonado-somatic index
