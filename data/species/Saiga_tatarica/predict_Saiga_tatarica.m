function [prdData, info] = predict_Saiga_tatarica(par, data, auxData)
  ...
  Ww_i = L_i^3 * (1 + f * w);       % g, ultimate body weihgt
  ...
  L_bm = L_mm * l_bm; Ww_bm = L_bm^3 * (1 + f * w_m); % g, birth weight 
