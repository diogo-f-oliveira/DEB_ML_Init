function [data, auxData, metaData, txtData, weights] = mydata_Dascyllus_reticulatus
...
metaData.species    = 'Dascyllus_reticulatus'; 
metaData.species_en = 'Reticulate dascyllus'; 
...
data.Wwp = 1.9;   units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';   bibkey.Wwp = {'guess','fishbase'};
  comment.Wwi = 'based on 0.02951*Lp^2.99, see F1';
data.Wwi = 21;  units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.02951*Li^2.99, see F1';
...
%% Facts
F1 = 'length-weight: Ww in g = 0.02951*(TL in cm)^2.99';
metaData.bibkey.F1 = 'fishbase'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = '346F6'; % Cat of Life
metaData.links.id_ITIS = '170125'; % ITIS
metaData.links.id_EoL = ''; % Ency of Life
metaData.links.id_Wiki = 'Dascyllus_reticulatus'; % Wikipedia
metaData.links.id_ADW = 'Dascyllus_reticulatus'; % ADW
metaData.links.id_Taxo = '172891'; % Taxonomicon
metaData.links.id_WoRMS = '212844'; % WoRMS
metaData.links.id_fishbase = 'Dascyllus-reticulatus'; % fishbase
...
'howpublished = {\url{https://www.fishbase.de/summary/Dascyllus-reticulatus.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
