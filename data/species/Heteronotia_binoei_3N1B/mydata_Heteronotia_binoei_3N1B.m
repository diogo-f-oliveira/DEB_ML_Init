function [data, auxData, metaData, txtData, weights] = mydata_Heteronotia_binoei_3N1B
%% set metadata
metaData.phylum     = 'Chordata';
metaData.class      = 'Reptilia';
metaData.order      = 'Squamata';
metaData.family     = 'Gekkonidae';
metaData.species    = 'Heteronotia_binoei_3N1B';
metaData.species_en = 'Bynoe''s gecko 3N1B';
...
metaData.date_acc    = [2017 06 14];

%% set data
% zero-variate data;
data.ab = 89.4;     units.ab = 'd';    label.ab = 'age at birth';                      bibkey.ab = 'Kear2004a';
...
data.Lb  = 2.14;     units.Lb  = 'cm';   label.Lb  = 'snout to vent length at birth';    bibkey.Lb  = 'Kear2004c';
...
data.Ri  = 2.8/365;    units.Ri  = '#/d';  label.Ri  = 'maximum reprod rate';  bibkey.Ri  = 'Kear2005';
temp.Ri = C2K(29);  units.temp.Ri = 'K'; label.temp.Ri = 'temperature';

% uni-variate data
data.Tab = [24  27  30; 144.6 87.8    60.2]'; units.Tab  = {'C','d'};  label.Tab  = {'temperature','development time'};  bibkey.Tab  = 'Kear2004a';
