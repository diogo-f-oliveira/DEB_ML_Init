function [prdData, info] = predict_Cercopithecus_cephus(par, data, auxData)
  ...
  % time-weight 
  tf = [0 1000 1600; f_0 f_0 f_1]';
  L_b = L_m * get_lb([g; k; v_Hb], f_0); 
  ...
  %
  tf = [0 1200 1600; f_0 f_0 f_1]';
  L_bm = L_mm * get_lb([g_m; k; v_Hb], f_0); 
