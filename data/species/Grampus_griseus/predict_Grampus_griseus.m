function [prdData, info] = predict_Grampus_griseus(par, data, auxData)
  ...
  Ww_x = L_x^3 * (1 + f * ome);     % g, weight at weaning
  ...
  L_pm = L_m * l_pm; Lw_pm = L_pm/ del_M; % cm, length at buperty
