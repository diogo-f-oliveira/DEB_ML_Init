function [prdData, info] = predict_Prionailurus_rubiginosus(par, data, auxData)
  ...
  L_bm = l_bm * L_mm;                  % d, structural length at birth
  ...
  % female
  [tvel, t_p, t_b, l_p, l_b] = get_tp(pars_tp, f_tW, [], tW(:,1)*kT_M);
