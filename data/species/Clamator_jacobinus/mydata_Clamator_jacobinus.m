function [data, auxData, metaData, txtData, weights] = mydata_Clamator_jacobinus
...
metaData.species    = 'Clamator_jacobinus'; 
metaData.species_en = 'Jacobin cuckoo'; 
...
data.Ww0 = 5.1;   units.Ww0 = 'g';  label.Ww0 = 'initial wet weight';     bibkey.Ww0 = 'avibase';
data.Wwb = 6;   units.Wwb = 'g';  label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'avibase';
data.Wwi = 76;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'Live1969';
data.Wwim = 71; units.Wwim = 'g';   label.Wwim = 'ultimate wet weight for males'; bibkey.Wwim = 'avibase';

data.Ri  = 20/365;   units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate'; bibkey.Ri  = 'Live1969';   
...
%% Facts
F1 = 'Brood parsite for mainly species of babblers in the genus Turdoides';
metaData.bibkey.F1 = 'Wiki'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = 'VQNY'; % Cat of Life
metaData.links.id_ITIS = '705297'; % ITIS
metaData.links.id_EoL = '45518919'; % Ency of Life
metaData.links.id_Wiki = 'Clamator_jacobinus'; % Wikipedia
metaData.links.id_ADW = 'Clamator_jacobinus'; % ADW
metaData.links.id_Taxo = '70839'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = 'BF0A09546401D245'; % avibase
metaData.links.id_birdlife = 'jacobin-cuckoo-clamator-jacobinus'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Clamator_jacobinus}}';
...
'howpublished = {\url{https://avibase.bsc-eoc.org/species.jsp?lang=EN&avibaseid=BF0A09546401D245&sec=lifehistory}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
