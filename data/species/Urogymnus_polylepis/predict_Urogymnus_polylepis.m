function [prdData, info] = predict_Urogymnus_polylepis(par, data, auxData)  
  ...
  TC_M = tempcorr(temp.tL_M, T_ref, T_A); 
  ...
  L = L_i - (L_i - L_b) * exp(-rT_B * tL_C(:,1)); % cm, struct length
  ELw_C = L/ del_M; % cm, total length
  %
