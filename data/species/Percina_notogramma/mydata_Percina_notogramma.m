  function [data, auxData, metaData, txtData, weights] = mydata_Percina_notogramma
%% set metadata
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Perciformes'; 
metaData.family     = 'Percidae';
metaData.species    = 'Percina_notogramma'; 
metaData.species_en = 'Stripeback darter'; 
...
%% set data
% zero-variate data
data.am = 4 * 365;   units.am = 'd';  label.am = 'life span';                    bibkey.am = 'Link1970';   
  temp.am = C2K(12.5); units.temp.am = 'K'; label.temp.am = 'temperature';
 
data.Lp = 4.2;  units.Lp = 'cm'; label.Lp = 'total length at puberty';           bibkey.Lp = 'guess'; 
...
data.Wwp = 0.46; units.Wwp = 'g';  label.Wwp = 'wet weight at puberty';     bibkey.Wwp =  {'fishbase','guess'};
...
data.Ri = 550/365;   units.Ri = '#/d';  label.Ri = 'ultimate reproduction rate';  bibkey.Ri = 'guess';
...
%% Links
metaData.links.id_CoL = '6V3SN'; % Cat of Life
metaData.links.id_ITIS = '168473'; % ITIS
metaData.links.id_EoL = '207983'; % Ency of Life
metaData.links.id_Wiki = 'Percina_notogramma'; % Wikipedia
metaData.links.id_ADW = 'Percina_notogramma'; % ADW
metaData.links.id_Taxo = '183485'; % Taxonomicon
metaData.links.id_WoRMS = '1419900'; % WoRMS
metaData.links.id_fishbase = 'Percina-notogramma'; % fishbase


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{https://en.wikipedia.org/wiki/Percina_notogramma}}';  
...
'howpublished = {\url{https://www.fishbase.se/summary/Percina-notogramma}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
