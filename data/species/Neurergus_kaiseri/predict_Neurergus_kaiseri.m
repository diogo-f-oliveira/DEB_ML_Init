function [prdData, info] = predict_Neurergus_kaiseri(par, data, auxData)
...
%   Ww_i = L_i^3 * (1 + f * w);       % g, ultimate wet weight 
  ...
  pars_tmm = [g_m; l_T; h_a/ k_M^2; s_G];  % compose parameter vector at T_ref
  t_m = get_tm_s(pars_tmm, f, l_b);      % -, scaled mean life span at T_ref
  aT_mm = t_m/ k_M/ TC_am;                  % d, mean life span at T
