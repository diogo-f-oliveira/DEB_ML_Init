function [prdData, info] = predict_Geotria_australis(par, data, auxData)  
  ...
  ELw_1 = (L_i - (L_i - Lw_01 * del_M) * exp(- rT_B * tL_1(:,1)))/ del_M;
  %
  ELw_2 = (L_i - (L_i - Lw_02 * del_M) * exp(- rT_B * tL_2(:,1)))/ del_M;
