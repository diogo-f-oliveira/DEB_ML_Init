function [prdData, info] = predict_Notropis_texanus(par, data, auxData)
...
%% compute temperature correction factors
  ...
  RT_4 = TC * reprod_rate_j(4.2*del_M, f_tL, pars_R);  % #/d, max reprod rate at TL 4.2 cm
  RT_7 = TC * reprod_rate_j(7.5*del_M, f_tL, pars_R);  % #/d, max reprod rate at TL 7.5 cm
