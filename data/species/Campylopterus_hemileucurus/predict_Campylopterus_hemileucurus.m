function [prdData, info] = predict_Campylopterus_hemileucurus(par, data, auxData)
  
  % unpack par, data, auxData
  cPar = parscomp_st(par); vars_pull(par); 
  vars_pull(cPar);  vars_pull(data);  vars_pull(auxData);
  
  if E_Hx < 0 || p_M > 9500 || f_06 > 3 || f_09 > 3
  ...
  tf = [3 6 9 15 25; f_03 f_06 f_09 f_15 f_25]'; tf(:,1) = tf(:,1) * kT_M;
  % female
