function [prdData, info] = predict_Ursus_arctos_middendorffi(par, data, auxData)
  ...
  aT_g = t_0 + t_b/ kT_M;           % d, age at birth at f and T
  ...
  Ww_im = L_im^3 * (1 + f * ome_m); % g, ulitmate weight
