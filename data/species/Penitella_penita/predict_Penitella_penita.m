function [prdData, info] = predict_Penitella_penita(par, data, auxData)
  ...
  if ~info; prdData = []; return; end
  rT_B = kT_M * rho_B; Lw_i = l_i * L_m/ del_M; 
  ELw = (Lw_i - LL(:,1)) * (1 - exp(-rT_B * 350)); % cm, shell depth increment over 350 d
