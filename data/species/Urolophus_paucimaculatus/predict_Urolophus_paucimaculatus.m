function [prdData, info] = predict_Urolophus_paucimaculatus(par, data, auxData)  
  ...
  L_pm = l_pm * L_mm; Lw_pm = L_pm/ del_M; % cm, struct length, disc width at puberty
  L_im = f * L_mm; Lw_im = L_im/ del_M; % cm, struct length, disc width at ultimate
