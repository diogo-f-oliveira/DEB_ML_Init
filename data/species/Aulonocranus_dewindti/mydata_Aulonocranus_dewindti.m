function [data, auxData, metaData, txtData, weights] = mydata_Aulonocranus_dewindti
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Cichliformes'; 
metaData.family     = 'Cichlidae';
metaData.species    = 'Aulonocranus_dewindti'; 
...
data.Wwp = 4.9;   units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';      bibkey.Wwp = {'fishbase','guess'};
...
%% Links
metaData.links.id_CoL = 'JSRR'; % Cat of Life
metaData.links.id_ITIS = '649034'; % ITIS
metaData.links.id_EoL = '223598'; % Ency of Life
metaData.links.id_Wiki = 'Aulonocranus_dewindti'; % Wikipedia
metaData.links.id_ADW = 'Aulonocranus_dewindti'; % ADW
metaData.links.id_Taxo = '162686'; % Taxonomicon
metaData.links.id_WoRMS = '1026857'; % WoRMS
metaData.links.id_fishbase = 'Aulonocranus-dewindti'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Aulonocranus_dewindti}}';
...
'howpublished = {\url{https://www.fishbase.se/summary/Aulonocranus-dewindti.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
