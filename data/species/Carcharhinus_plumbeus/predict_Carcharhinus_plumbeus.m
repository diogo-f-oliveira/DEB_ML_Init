function [prdData, info] = predict_Carcharhinus_plumbeus(par, data, auxData)
  ...
  Lw_bm = L_mm * l_bm/ del_M; % cm, total length at birth
  ...
  [a LUH] = ode45(@dget_LUH, [0; tLe(:,1)], [1e-10 U_E0 0], [], kap, vT, kT_J, g, L_m); 
  LUH(1,:) = []; ELw = LUH(:,1)/ del_M; % cm, total length
  % female
