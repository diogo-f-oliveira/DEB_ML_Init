function [prdData, info] = predict_Istiophorus_albicans(par, data, auxData)
  ...
  Lw_j = L_j/ del_M;                % cm, LJFL at birth at f
  ...
  RT_i = TC * reprod_rate_j(L_i, f, pars_R); % #/d, reproduction rate at 33 kg
...
%   pars_tjm = [g_m k l_T v_Hb v_Hj v_Hp];
  ...
  EWw = (L_m * tvel(:,4)).^3 * (1 + f_tL * w); % g, weight
