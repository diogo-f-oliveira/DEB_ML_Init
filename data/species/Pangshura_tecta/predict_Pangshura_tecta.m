function [prdData, info] = predict_Pangshura_tecta(par, data, auxData)
  ...
  aT_b = t_b/ k_M/ TC_ab;           % d, age at borth
  ...
  %
  L= L_i - (L_i - L_b) * exp (- rT_B * tWw(:,1)); % cm, struct langth
  EWw = L.^3 * (1 + f_tL * w); % cm, carapace length
