function [prdData, info] = predict_Egernia_striolata(par, data, auxData)
...
o2Ww=38.3; % mean wet weight of experimental animals
...
L = (o2Ww / (1 + f * w)).^(1/3); % cm, structural length, inferred from wet mass
