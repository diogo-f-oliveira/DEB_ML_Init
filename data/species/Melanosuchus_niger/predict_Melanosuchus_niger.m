function [prdData, info] = predict_Melanosuchus_niger(par, data, auxData)
...
% zero-variate data
 ...
 % length-length
 L_b = L_m * get_lb([g k v_Hb], f_LL); Lw_i = L_m * f_LL/ del_M; rT_B = TC_LL * k_M/ 3/ (1 + f_LL/ g); 
 EL = Lw_i - (Lw_i - LL(:,1)) .* exp(- rT_B * time.LL);
