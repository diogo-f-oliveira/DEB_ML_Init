function [prdData, info] = predict_Coregonus_pollan(par, data, auxData)
...
%% compute temperature correction factors
  ...
  [tau_j, tau_p, tau_b, l_j, l_p, l_b, l_i, rho_j, rho_B] = get_tj(pars_tjm, f);
  aT_jm = tau_j/ kT_M;                 % d, age at birth 
  aT_pm = tau_p/ kT_M;                 % d, age at puberty
