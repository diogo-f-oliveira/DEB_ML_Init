function [data, auxData, metaData, txtData, weights] = mydata_Fregata_minor
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Suliformes'; 
metaData.family     = 'Fregatidae';
metaData.species    = 'Fregata_minor'; 
metaData.species_en = 'Great frigatebird'; 
...
data.tx = 130;   units.tx = 'd';    label.tx = 'time since birth at fledging'; bibkey.tx = 'Diam1975';   
  temp.tx = C2K(40.6);  units.temp.tx = 'K'; label.temp.tx = 'temperature';
data.tp = 390;   units.tp = 'd';    label.tp = 'time since birth at puberty'; bibkey.tp = 'guess';   
...
data.Wwb = 100;   units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'Diam1975';
data.Wwi = 1460; units.Wwi = 'g';   label.Wwi = 'ultimate wet weight for female';     bibkey.Wwi = 'Diam1975';
  comment.Wwi = 'Wiki: 1215 to 1590 g';
data.Wwim = 1225; units.Wwim = 'g';   label.Wwim = 'ultimate wet weight for male';     bibkey.Wwim = 'Wiki';
  comment.Wwim = 'Wiki: 1000 to 1450 g';
...
%% Links
metaData.links.id_CoL = '6JLWF'; % Cat of Life
metaData.links.id_ITIS = '174766'; % ITIS
metaData.links.id_EoL = '45511364'; % Ency of Life
metaData.links.id_Wiki = 'Fregata_minor'; % Wikipedia
metaData.links.id_ADW = 'Fregata_minor'; % ADW
metaData.links.id_Taxo = '51730'; % Taxonomicon
metaData.links.id_WoRMS = '212654'; % WoRMS
metaData.links.id_avibase = '788EBCAB63213E04'; % avibase
metaData.links.id_birdlife = 'great-frigatebird-fregata-minor'; % birdlife
metaData.links.id_AnAge = 'Fregata_minor'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Fregata_minor}}';
