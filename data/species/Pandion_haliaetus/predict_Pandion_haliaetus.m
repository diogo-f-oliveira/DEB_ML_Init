function [prdData, info] = predict_Pandion_haliaetus(par, data, auxData)
  ...
  tf = [0 f_00; 3 f_03; 10 f_10; 30 f_30; 50 f_50]; tf(:,1) = tf(:,1) * kT_M;
  % female
  [tvel, t_p, t_b, l_p, l_b] = get_tp(pars_tp, tf, [tau_b 1 l_b], tW_fm(:,1)*kT_M);
