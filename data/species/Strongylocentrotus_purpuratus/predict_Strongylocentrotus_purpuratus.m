function [prdData, info] = predict_Strongylocentrotus_purpuratus(par, data, auxData)
  ...
  kT_M = k_M * TC_tL; rT_B = rho_B * kT_M; L_0 = Lw_0 * del_M; L_i = L_m * l_i; 
  L = L_i - (L_i - L_0) * exp( - rT_B * tL(:,1)); % cm, structural length at time
