function [prdData, info] = predict_Anaxyrus_americanus(par, data, auxData)
  ...
  % time-weight
  L_0 = (Ww_0/ (1 + f * w_m))^(1/3); % g, intitial weight
  rT_Bm = TC_tW * k_M/ 3/ (1 + f/ g_m); % 1/d, von Bert growth rate
  L = L_im - (L_im - L_0) * exp( - rT_Bm * tW_m(:,1)); % cm, struc length
