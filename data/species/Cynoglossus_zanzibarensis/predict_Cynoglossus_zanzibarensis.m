function [prdData, info] = predict_Cynoglossus_zanzibarensis(par, data, auxData) 
...
%% compute temperature correction factors
  ...
  RT_i = TC * reprod_rate_j(L_i, f, pars_R);             % reproduction rate for fish
  ...
  %
  tvel = get_tj(pars_tjm,f_tL,[], tL_fm(:,1)*k_M);
