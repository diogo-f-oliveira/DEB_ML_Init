function [data, auxData, metaData, txtData, weights] = mydata_Chrysiptera_biocellata
...
metaData.species    = 'Chrysiptera_biocellata'; 
metaData.species_en = 'Twinspot damselfish'; 
...
data.Li  = 12.5;   units.Li  = 'cm';  label.Li  = 'ultimate standard length'; bibkey.Li  = 'fishbase';
...
data.Wwp = 2.9;   units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';   bibkey.Wwp = {'guess','fishbase'};
  comment.Wwi = 'based on 0.02344*Lp^2.99, see F1';
data.Wwi = 44.6;  units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.02344*Li^2.99, see F1';
...
data.Ri  = 2e3/365; units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';  bibkey.Ri  = 'guess';   
  ...
  comment.Ri = 'based on Dascyllus_aruanus';
...
%% Facts
F1 = 'length-weight: Ww in g = 0.02344*(TL in cm)^2.99';
metaData.bibkey.F1 = 'fishbase'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = '5YKBF'; % Cat of Life
metaData.links.id_ITIS = '615572'; % ITIS
metaData.links.id_EoL = '46572358'; % Ency of Life
metaData.links.id_Wiki = 'Chrysiptera'; % Wikipedia
metaData.links.id_ADW = 'Chrysiptera_biocellata'; % ADW
metaData.links.id_Taxo = '171152'; % Taxonomicon
metaData.links.id_WoRMS = '218784'; % WoRMS
metaData.links.id_fishbase = 'Chrysiptera-biocellata'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Dascyllus_reticulatus}}';
...
'howpublished = {\url{https://www.fishbase.de/summary/Chrysiptera-biocellata.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
