function [prdData, info] = predict_Equus_quagga(par, data, auxData)
  ...
  EWw = L.^3 * (1 + f * w)/ 1e3; % kg, weight for females
  %
  EWw_e = (1 + f * w) * ((tW_e(:,1) - t_0) * v * TC/ 3).^3/1e3; % kg, weight for males
