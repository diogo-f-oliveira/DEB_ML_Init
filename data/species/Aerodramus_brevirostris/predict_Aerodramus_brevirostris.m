function [prdData, info] = predict_Aerodramus_brevirostris(par, data, auxData)
  ...
  % time-weight
  tf = [2 f_02; 5 f_05; 10 f_10; 15 f_15; 20 f_20; 25 f_25]; tf(:,1) = tf(:,1) * kT_M;
  tvel = get_tp(pars_tp, tf, [v_Hb 1 l_b], tW(:,1)*kT_M);
  EWw = (L_m * tvel(:,4)).^3 .* (1 + tvel(:,3) * ome);   % g, weight
  %
  tf = [2 f1_02; 5 f1_05; 10 f1_10; 15 f1_15; 20 f1_20; 25 f1_25]; tf(:,1) = tf(:,1) * kT_M;
  tvel = get_tp(pars_tp, tf, [v_Hb 1 l_b], tW(:,1)*kT_M);
