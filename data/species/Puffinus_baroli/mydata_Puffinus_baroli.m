function [data, auxData, metaData, txtData, weights] = mydata_Puffinus_baroli
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Procellariiformes'; 
metaData.family     = 'Procellariidae';
metaData.species    = 'Puffinus_baroli'; 
metaData.species_en = 'Barolo shearwater'; 
...
data.ab = 53;  units.ab = 'd';    label.ab = 'age at birth';             bibkey.ab = 'guess';   
...
data.Wwi = 210; units.Wwi = 'g';  label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'Ramo2013';
  comment.Wwi = 'Asymptotic mass prior to fledging, mean adult mass is smaller; Closely related to Puffinus lherminieri, which weighs 170 g';
...
%% Links
metaData.links.id_CoL = '4QFXG'; % Cat of Life
metaData.links.id_ITIS = '174560'; % ITIS
metaData.links.id_EoL = '45511315'; % Ency of Life
metaData.links.id_Wiki = 'Puffinus_baroli'; % Wikipedia
metaData.links.id_ADW = ''; % ADW
metaData.links.id_Taxo = '2682492'; % Taxonomicon
metaData.links.id_WoRMS = '514084'; % WoRMS
metaData.links.id_avibase = '5F555FDD48DEAC1C'; % avibase
metaData.links.id_birdlife = 'little-shearwater-puffinus-assimilis'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Puffinus_baroli}}';
...
'howpublished = {\url{http://eol.org/pages/1265539/overview}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
