function [prdData, info] = predict_Galatea_paradoxa(par, data, auxData)
  ...
  Ww_i = (9.74*del_M)^3 * (1 + f * w);% g, wet weight at SL 9.74 cm
  ...
  rT_B = TC * rho_B * k_M;  L_j = L_m * l_j; L_i = L_m * l_i;      
