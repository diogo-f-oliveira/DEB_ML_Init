function [par, metaPar, txtPar] = pars_init_Metridium_senile(metaData)
...
%% other parameters 
par.del_M = 0.3162;   free.del_M = 1;   units.del_M = '-';        label.del_M = 'shape coefficient'; 
par.f = 1;            free.f     = 0;   units.f = '-';            label.f = 'scaled functional response for 0-var data'; 
par.t_0 = 239.8676;   free.t_0   = 1;   units.t_0 = 'd';          label.t_0 = 'time since birth at t=0 in tA-data'; 
