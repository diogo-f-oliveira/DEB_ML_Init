function [prdData, info] = predict_Centropomus_robalito(par, data, auxData)
...
% zero-variate data
  ...
  tT_b = tau_b/kT_M;                  % d, age at birth at f and T
  ...
  % time-length
  [tvel, t_p, t_b, l_p, l_b] = get_tj(pars_tj, f_tL, [], tL(:,1)*kT_M);
