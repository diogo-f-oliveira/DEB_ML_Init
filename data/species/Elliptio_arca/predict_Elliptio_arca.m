function [prdData, info] = predict_Elliptio_arca(par, data, auxData)
  ...
  RT_i = TC * reprod_rate_j(6.99*del_M, f, pars_R);  % #/d, reprod rate for SL 6.99 cm
  ...
  %
  tvel = get_tj(pars_tj, f_tL, [t_b, f_tL, l_b], tL_m(:,1)*k_M*TC_tL_m);
