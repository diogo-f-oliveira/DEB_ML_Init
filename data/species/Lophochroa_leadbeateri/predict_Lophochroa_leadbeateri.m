function [prdData, info] = predict_Lophochroa_leadbeateri(par, data, auxData)
  ...
  % uni-variate data   
  % time-weight
  l_0 = (W0/(1 + f_tW * ome))^(1/3)/L_m; % -, scaled initial struc length
  tvel = get_tp(pars_tp, f_tW, [tau_b f_tW l_0], tW(:,1)*kT_M);
