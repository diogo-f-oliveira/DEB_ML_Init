function [data, auxData, metaData, txtData, weights] = mydata_Charadrius_nivosus
...
metaData.species    = 'Charadrius_nivosus'; 
metaData.species_en = 'Snowy plover'; 
...
data.Wwb = 5.8;    units.Wwb = 'g';   label.Wwb = 'wet weight at birth';   bibkey.Wwb = 'ErieGree2020';
data.Wwi = 310;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';   bibkey.Wwi = 'avibase';
...
%% Links
metaData.links.id_CoL = '69PKT'; % Cat of Life
metaData.links.id_ITIS = '824030'; % ITIS
metaData.links.id_EoL = '45509161'; % Ency of Life
metaData.links.id_Wiki = 'Charadrius_nivosus'; % Wikipedia
metaData.links.id_ADW = ''; % ADW
metaData.links.id_Taxo = '2682050'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = 'F012ED4BC8CD3876'; % avibase
metaData.links.id_birdlife = 'snowy-plover-charadrius-nivosus'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Charadrius_nivosus}}';
...
'howpublished = {\url{https://avibase.bsc-eoc.org/species.jsp?lang=EN&avibaseid=F012ED4BC8CD3876&sec=lifehistory}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
