function [prdData, info] = predict_Erinaceus_europaeus(par, data, auxData)
  ...
  L_bm = L_mm * get_lb_foetus([g_m k v_Hb], f); L_im = (f - l_T) * L_mm;
  ...
  % female at f_tW
  tvel = get_tp(pars_tp, f_tW, [t_b, f_tW, (W_0/(1+f_tW*w))^(1/3)/L_m], tW_f1(:,1)*kT_M);
