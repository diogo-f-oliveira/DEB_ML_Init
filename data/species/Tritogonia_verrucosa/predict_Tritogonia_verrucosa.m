function [prdData, info] = predict_Tritogonia_verrucosa(par, data, auxData)
  ...
  RT_i = TC * reprod_rate_j(9.15*del_M, f, pars_R);  % #/d, reprod rate at SL 9.15 cm
  ...
  %
  tvel = get_tj(pars_tj, f_tL, [t_b, f_tL*z/z_m, l_b*z/z_m], tL_m(:,1)*k_M*TC_tL);
