function [data, auxData, metaData, txtData, weights] = mydata_Sphyraena_viridensis
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Sphyraeniformes'; 
metaData.family     = 'Sphyraenidae';
metaData.species    = 'Sphyraena_viridensis'; 
metaData.species_en = 'Yellowmouth barracuda'; 
...
data.Lp  = 53; units.Lp  = 'cm';  label.Lp  = 'fork length at puberty'; bibkey.Lp  = 'guess'; 
...
data.Wwp = 785; units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';   bibkey.Wwp = {'fishbase','guess'};
  comment.Wwp = 'based on W = 0.00724*Lp^2.92, see F1';
data.Wwi = 9.6e3; units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';    bibkey.Wwi = 'fishbase';
...
%% Links
metaData.links.id_CoL = '4Z2NG'; % Cat of Life
metaData.links.id_ITIS = '646747'; % ITIS
metaData.links.id_EoL = ''; % Ency of Life
metaData.links.id_Wiki = 'Sphyraena_viridensis'; % Wikipedia
metaData.links.id_ADW = 'Sphyraena_viridensis'; % ADW
metaData.links.id_Taxo = '187948'; % Taxonomicon
metaData.links.id_WoRMS = '127069'; % WoRMS
metaData.links.id_fishbase = 'Sphyraena-viridensis'; % fishbase
