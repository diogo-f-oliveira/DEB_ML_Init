function [prdData, info] = predict_Anthus_pratensis(par, data, auxData)
  ...
  % time-weight
  tf = [0 f2_00; 3 f2_03; 6 f2_06; 9 f2_09; 12 f2_12]; tf(:,1) = tf(:,1) * kT_M;
  ...
  % pack to output
  prdData.tW = [EWw EWw_1 EWw_2 EWw_3];
end
