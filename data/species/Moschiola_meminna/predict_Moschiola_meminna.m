function [prdData, info] = predict_Moschiola_meminna(par, data, auxData)
  ...
  % life cycle
  pars_tx = [g k l_T v_Hb v_Hx v_Hp 1];  % s_F = 1
  [tau_p, tau_x, tau_b, l_p, l_x, l_b, info] = get_tx(pars_tx, [f_bx f]);
