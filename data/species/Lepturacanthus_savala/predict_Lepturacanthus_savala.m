function [prdData, info] = predict_Lepturacanthus_savala(par, data, auxData)
...
%   tT_jm = (t_j-t_b)/ k_M/ TC;                % d, time since birth at metam 
...
%   L_jm = L_mm * l_jm;                  % cm, struc length at puberty
