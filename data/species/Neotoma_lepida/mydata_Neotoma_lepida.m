function [data, auxData, metaData, txtData, weights] = mydata_Neotoma_lepida
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Mammalia'; 
metaData.order      = 'Rodentia'; 
metaData.family     = 'Cricetidae';
metaData.species    = 'Neotoma_lepida'; 
metaData.species_en = 'Desert woodrat'; 
...
data.tp = 76;   units.tp = 'd';     label.tp = 'time since birth at puberty for female'; bibkey.tp = 'AnAge';
...
data.Wwb = 8.45;   units.Wwb = 'g';     label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'AnAge';
data.Wwx = 35;   units.Wwx = 'g';     label.Wwx = 'wet weight at weaning';   bibkey.Wwx = 'AnAge';
data.Wwi = 236;     units.Wwi = 'g';  label.Wwi = 'ultimate wet weight';        bibkey.Wwi = 'AnAge';
...
%% Links
metaData.links.id_CoL = '7W255'; % Cat of Life
metaData.links.id_ITIS = '180374'; % ITIS
metaData.links.id_EoL = '328456'; % Ency of Life
metaData.links.id_Wiki = 'Neotoma_lepida'; % Wikipedia
metaData.links.id_ADW = 'Neotoma_lepida'; % ADW
metaData.links.id_Taxo = '88836'; % Taxonomicon
metaData.links.id_MSW3 = '13000415'; % Mammal Spec World
metaData.links.id_AnAge = 'Neotoma_lepida'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Neotoma_lepida}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Neotoma_lepida}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
