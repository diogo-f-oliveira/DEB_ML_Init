function [prdData, info] = predict_Glyptocephalus_cynoglossus(par, data, auxData) 
...
%% compute temperature correction factors
  ...
  RT_26 = TC * reprod_rate_j(26.8 * del_M, f, pars_R);             % reproduction rate for fish of 50 cm
  RT_42 = TC * reprod_rate_j(42 * del_M, f, pars_R);             % reproduction rate for fish of 50 cm
