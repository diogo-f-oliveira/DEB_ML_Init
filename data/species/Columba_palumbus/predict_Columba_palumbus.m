function [prdData, info] = predict_Columba_palumbus(par, data, auxData)
  ...
  L_x = l_x * L_m;                  % structural length at fledging/puberty
  Ww_x = L_x^3 * (1 + f * w);       % g, wet weight at fledging/puberty
  ...
  % time-weight
  tf = [0 f_00; 5 f_05; 10 f_10; 15 f_15]; tf(:,1) = tf(:,1) * kT_M;
