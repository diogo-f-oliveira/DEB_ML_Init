function [prdData, info] = predict_Takifugu_rubripes(par, data, auxData)
...
% zero-variate data
  ...
  Lw_pm = L_mm * get_lp(pars_tp, f)/ del_M; % cm, total length at puberty
  ...
  % male
  tvel = get_tpm(pars_tpm, f_tL, [0, f_tL*z/z_m, l_b*z/z_m], tL_fm(:,1)*kT_M);
