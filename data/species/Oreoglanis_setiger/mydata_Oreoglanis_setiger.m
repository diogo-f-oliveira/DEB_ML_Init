  function [data, auxData, metaData, txtData, weights] = mydata_Oreoglanis_setiger
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Siluriformes'; 
metaData.family     = 'Sisoridae';
metaData.species    = 'Oreoglanis_setiger'; 
...
data.Lp = 3;     units.Lp = 'cm';   label.Lp = 'total length at puberty for females';   bibkey.Lp = 'guess';
data.Li = 6.9;     units.Li = 'cm';   label.Li = 'ultimate total length';   bibkey.Li = 'fishbase';
...
data.Wwp = 0.17;   units.Wwp = 'g';    label.Wwp = 'wet weight at puberty';   bibkey.Wwp = 'guess';
  comment.Wwi = 'based on 0.00589*Lp^3.08, see F1';
data.Wwi = 2.26;   units.Wwi = 'g';    label.Wwi = 'ultimate wet weight';    bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.00589*Li^3.08, see F1';
...
D2 = 'Li of fishbase is at odds with tL data; temperatures are guessed';
metaData.discussion = struct('D1',D1, 'D2',D2);

%% Facts
F1 = 'length-weight: Ww in g = 0.00589*(TL in cm)^3.08'; 
metaData.bibkey.F1 = 'fishbase'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = '3GJDJ'; % Cat of Life
metaData.links.id_ITIS = '682065'; % ITIS
metaData.links.id_EoL = '1012375'; % Ency of Life
metaData.links.id_Wiki = 'Oreoglanis'; % Wikipedia
metaData.links.id_ADW = 'Oreoglanis_setiger'; % ADW
metaData.links.id_Taxo = '682065'; % Taxonomicon
metaData.links.id_WoRMS = '1592731'; % WoRMS
metaData.links.id_fishbase = 'Glyptothorax-macromaculatus'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/wiki/Oreoglanis}}';  
...
'howpublished = {\url{https://www.fishbase.se/summary/Oreoglanis-setiger.html}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
