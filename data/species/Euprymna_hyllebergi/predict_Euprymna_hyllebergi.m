function [prdData, info] = predict_Euprymna_hyllebergi(par, data, auxData)
  ...
  Ww_p = L_p^3 * (1 + f * w);       % g, wet weight at at puberty at f
  ...
  %
  tvel = get_tj(pars_tj, f, [], tW(:,1) * k_M * TC_tL);
