function [prdData, info] = predict_Pipistrellus_pipistrellus(par, data, auxData)
  ...
  % tW-data for foetal development
  vT = TC * v; % cm/d, energy conductance
  f = f_1978;
  EWw_1978 = (1 + f * w) * (vT * max(0, tWe_1978(:,1) - t_0_78)/ 3) .^ 3;
  f = f_1979;
  EWw_1979 = (1 + f * w) * (vT * max(0, tWe_1979(:,1) - t_0_79)/ 3) .^ 3;
  
  % pack to output
  prdData.tWe_1978 = EWw_1978;
  prdData.tWe_1979 = EWw_1979;
