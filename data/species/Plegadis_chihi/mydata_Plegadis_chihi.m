function [data, auxData, metaData, txtData, weights] = mydata_Plegadis_chihi
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Pelecaniformes'; 
metaData.family     = 'Threskiornithidae';
metaData.species    = 'Plegadis_chihi'; 
metaData.species_en = 'White-faced ibis'; 

metaData.ecoCode.climate = {'BWh', 'BSk','Cfa','Cfb','Dfa'};
...
data.Wwb = 29.35;  units.Wwb = 'g';  label.Wwb = 'wet weight at birth';             bibkey.Wwb = 'AnAge';
data.Wwi = 487.5;  units.Wwi = 'g';  label.Wwi = 'ultimate wet weight for females'; bibkey.Wwi = 'AnAge';
...
data.Ri  = 3.5/365; units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';            bibkey.Ri  = 'AnAge';   
  ...
  comment.Ri = '3.5 eggs per clutch';
...
%% Links
metaData.links.id_CoL = '4K62K'; % Cat of Life
metaData.links.id_ITIS = '174926'; % ITIS
metaData.links.id_EoL = '45509054'; % Ency of Life
metaData.links.id_Wiki = 'Plegadis_chihi'; % Wikipedia
metaData.links.id_ADW = 'Plegadis_chihi'; % ADW
metaData.links.id_Taxo = '51924'; % Taxonomicon
metaData.links.id_WoRMS = '422583'; % WoRMS
metaData.links.id_avibase = 'FD2B030969BC4DBC'; % avibase
metaData.links.id_birdlife = 'white-faced-ibis-plegadis-chihi'; % birdlife
metaData.links.id_AnAge = 'Plegadis_chihi'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Plegadis_chihi}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Plegadis_chihi}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'avibase'; type = 'Misc'; bib = ...
'howpublished = {\url{https://avibase.bsc-eoc.org/species.jsp?lang=EN&avibaseid=FD2B030969BC4DBC&sec=lifehistory}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
