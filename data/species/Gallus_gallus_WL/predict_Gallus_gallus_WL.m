function [prdData, info] = predict_Gallus_gallus_WL(par, data, auxData)
  ...
  L_R = L_i - (L_i - L_b) * exp(-rT_B * t_R ); % cm, total length at 9 month 
  Ww_R = L_R^3 * (1 + f * ome);       % g, wet weight at 1st brood
