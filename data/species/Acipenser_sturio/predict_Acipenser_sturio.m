function [prdData, info] = predict_Acipenser_sturio(par, data, auxData)
...
%% compute temperature correction factors
  ...
  [t_j t_b l_j l_b info] = get_tp(pars_tj, f); % get t_j, l_j, only morphological metam
  ...
  aT_j = t_j/ k_M/ TC_aj;           % d, age at metam at f and T
  ...
  % ultimate
  l_i = f - l_T;                    % -, sclaed ulitmate length
