function [prdData, info] = predict_Mesoplodon_stejnegeri(par, data, auxData)
  ...
  % time-length
  L_i = L_m * f_tL; rT_B = kT_M/ 3/ (1 + f_tL/ g);
  ELw = L_i * (1 - exp(- rT_B * tL(:,1)))/ del_MT;   % cm, length of teeth
