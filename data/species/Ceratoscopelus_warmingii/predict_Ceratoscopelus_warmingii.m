function [prdData, info] = predict_Ceratoscopelus_warmingii(par, data, auxData) 
...
%% compute temperature correction factors
  ...
  RT_i = TC * reprod_rate_j(L_i, f, pars_R); % reproduction rate for
...
%% uni-variate data
  ...
  kT_M = TC_l * k_M; rT_j = rho_j * kT_M; 
  L_b = L_m * l_b;  L_j = L_m * l_j; L_i = L_m * l_i;
  L = L_b * exp(tL_l(:,1) * rT_j/ 3);
  ELw_l = L/ del_M; % cm, standard length
  % post-larva
