function [prdData, info] = predict_Sepioteuthis_australis(par, data, auxData)
  ...
  % male
  tvel = get_tj(pars_tj, f, [t_b, f*z/z_m, l_b*z/z_m], tL_m(:,1)*kT_M);
  ...
  % male
  tvel = get_tj(pars_tj, f, [t_b, f*z/z_m, l_b*z/z_m], tW_m(:,1)*kT_M);
