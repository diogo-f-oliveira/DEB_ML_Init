function [data, auxData, metaData, txtData, weights] = mydata_Sebastes_viviparus
...
metaData.species    = 'Sebastes_viviparus'; 
metaData.species_en = 'Norway redfish'; 
...
data.Wwb = 1.6e-3;   units.Wwb = 'g';  label.Wwb = 'ultimate wet weight';     bibkey.Wwb = 'fishbase';
  comment.Wwb = 'based on egg length of 2.0 mm and width 1.25 mm: pi/6*0.2*0.125^2';
data.Wwi = 4.1e3;   units.Wwi = 'g';  label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.01148*Li^3.05, see F1';

data.Ri  = 363000/365; units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate'; bibkey.Ri  = 'fishbase';   
...
%% Links
metaData.links.id_CoL = '4W7QP'; % Cat of Life
metaData.links.id_ITIS = '166779'; % ITIS
metaData.links.id_EoL = ''; % Ency of Life
metaData.links.id_Wiki = 'Sebastes_viviparus'; % Wikipedia
metaData.links.id_ADW = 'Sebastes_viviparus'; % ADW
metaData.links.id_Taxo = '187347'; % Taxonomicon
metaData.links.id_WoRMS = '127255'; % WoRMS
metaData.links.id_fishbase = 'Sebastes-viviparus'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Sebastes_viviparus}}';
...
'author = {George F. Kelly and Robert S. Wolf}, ' ... 
'year = {1959}, ' ...
...
'howpublished = {\url{https://www.fishbase.de/summary/Sebastes-viviparus.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
