function [prdData, info] = predict_Eurycea_bislineata(par, data, auxData)
  ...
  % uni-variate data
  [t, EL] = ode45(@get_EL, [0;tL(:,1)], [E_m, L_b], [], food.tL, v * TC, g, E_m, L_m, p_Am * TC); % EL: {J/cm^3, cm}, with {[E], L}
  ELw = EL(2:end,2)/ del_M; % cm, SVL
