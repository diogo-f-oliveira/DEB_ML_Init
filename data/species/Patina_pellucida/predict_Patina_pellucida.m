function [prdData, info] = predict_Patina_pellucida(par, data, auxData)
  ...
  % reproduction
  pars_R = [kap; kap_R; g; TC * k_J; k_M; L_T; v; U_Hb; U_Hj; U_Hp]; % compose parameter vector
...
function dL = get_L(t, L, r_B, L_i, T_ref, T_A)
  TC = tempcorr(C2K(8 + 8 * cos(2*pi*(t-180)/365)), T_ref, T_A);
  dL = TC * r_B * (L_i - L);
end
