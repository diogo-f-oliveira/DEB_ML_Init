function [prdData, info] = predict_Camelus_bactrianus(par, data, auxData)
  ...
  pars_tpm = [g_m k l_T v_Hb v_Hp 1]; 
  [t_pm, t_bm, l_pm, l_bm] = get_tp(pars_tpm, f, [t_b, f*z/z_m, l_b*z/z_m]);
  L_im = f * L_mm; L_bm = l_bm * L_mm; % cm, structural lengths
  ...
  % male
  tvel = get_tp(pars_tpm, f_tW, [t_b, f_tW*z/z_m, l_b*z/z_m], tW_fm(:,1)*kT_M);
