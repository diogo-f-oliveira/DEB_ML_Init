function [prdData, info] = predict_Saurida_undosquamis(par, data, auxData) 
...
%% compute temperature correction factors
  ...
  RT_97 = TC * reprod_rate_j((97/(1 + f * w))^(1/3), f, pars_R); % #/d, reproduction rate at 97 g
  RT_290 = TC * reprod_rate_j((290/(1 + f * w))^(1/3), f, pars_R); % #/d, reproduction rate at 290 g
