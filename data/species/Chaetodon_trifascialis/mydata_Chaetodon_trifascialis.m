function [data, auxData, metaData, txtData, weights] = mydata_Chaetodon_trifascialis
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Chaetodontiformes'; 
metaData.family     = 'Chaetodontidae';
metaData.species    = 'Chaetodon_trifascialis'; 
metaData.species_en = 'Chevron butterflyfish'; 
...
data.Wwp = 9.9; units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';   bibkey.Wwp = 'fishbase';
  comment.Wwp = 'based on 0.02138*Lp^2.95, see F1';
data.Wwi = 108; units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.02138*Li^2.95, see F1';
...
%% Facts
F1 = 'weight-length relationship: weight in g = 0.02138*(TL in cm)^2.95';
...
%% Links
metaData.links.id_CoL = 'TC63'; % Cat of Life
metaData.links.id_ITIS = '169607'; % ITIS
metaData.links.id_EoL = '46578204'; % Ency of Life
metaData.links.id_Wiki = 'Chaetodon_trifascialis'; % Wikipedia
metaData.links.id_ADW = 'Chaetodon_trifascialis'; % ADW
metaData.links.id_Taxo = '170419'; % Taxonomicon
metaData.links.id_WoRMS = '218719'; % WoRMS
metaData.links.id_fishbase = 'Chaetodon-trifascialis'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Chaetodon_trifascialis}}';
...
'howpublished = {\url{http://www.fishbase.org/summary/Chaetodon-trifascialis.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
