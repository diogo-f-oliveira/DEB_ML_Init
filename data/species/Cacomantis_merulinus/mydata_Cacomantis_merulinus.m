function [data, auxData, metaData, txtData, weights] = mydata_Cacomantis_merulinus
...
metaData.species    = 'Cacomantis_merulinus'; 
metaData.species_en = 'Plaintive cuckoo'; 
...
data.ab = 13;    units.ab = 'd';    label.ab = 'age at birth';           bibkey.ab = 'TunhStok2019';   
  temp.ab = C2K(36.2);  units.temp.ab = 'K'; label.temp.ab = 'temperature';
data.tx = 18;    units.tx = 'd';    label.tx = 'time since birth at fledging'; bibkey.tx = 'TunhStok2019';   
...
data.Ww0 = 1.7;   units.Ww0 = 'g';  label.Ww0 = 'initial wet weight';     bibkey.Ww0 = 'guess';
data.Wwb = 1.15;   units.Wwb = 'g';  label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'TunhStok2019';
...
D3 = 'Males are supposed not to differ from females';
...
%% Facts
F1 = 'Parasitizes nests of cisticolas, prinias and tailorbirds';
metaData.bibkey.F1 = 'Wiki'; 
metaData.facts = struct('F1',F1);
 
%% Links
metaData.links.id_CoL = 'P5WR'; % Cat of Life
metaData.links.id_ITIS = '554692'; % ITIS
metaData.links.id_EoL = '914640'; % Ency of Life
metaData.links.id_Wiki = 'Cacomantis_merulinus'; % Wikipedia
metaData.links.id_ADW = 'Cacomantis_merulinus'; % ADW
metaData.links.id_Taxo = '105682'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = '54089C784D4DFF4A'; % avibase
metaData.links.id_birdlife = 'plaintive-cuckoo-cacomantis-merulinus'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Cacomantis_merulinus}}';
...
'howpublished = {\urlhttps://avibase.bsc-eoc.org/species.jsp?lang=EN&avibaseid=54089C784D4DFF4A&sec=lifehistory}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
