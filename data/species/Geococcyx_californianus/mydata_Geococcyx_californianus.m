function [data, auxData, metaData, txtData, weights] = mydata_Geococcyx_californianus
...
metaData.species    = 'Geococcyx_californianus'; 
metaData.species_en = 'Greater roadrunner';
 
metaData.ecoCode.climate = {'BWh', 'BSh', 'BSk', 'Cfa'};
...
data.Wwb = 14;     units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'avibase';
data.Wwi = 286.3;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'avibase';
data.Wwim = 319.1;   units.Wwim = 'g';   label.Wwim = 'ultimate wet weight for males';  bibkey.Wwim = 'avibase';

data.Ri  = 1.6*4.44/365;   units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate'; bibkey.Ri  = 'avibase';   
...
%% Links
metaData.links.id_CoL = '3FP5Z'; % Cat of Life
metaData.links.id_ITIS = '177836'; % ITIS
metaData.links.id_EoL = '45510707'; % Ency of Life
metaData.links.id_Wiki = 'Geococcyx_californianus'; % Wikipedia
metaData.links.id_ADW = 'Geococcyx_californianus'; % ADW
metaData.links.id_Taxo = '54594'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = 'DB5DABCFA33AE06F'; % avibase
metaData.links.id_birdlife = 'greater-roadrunner-geococcyx-californianus'; % birdlife
metaData.links.id_AnAge = 'Geococcyx_californianus'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Geococcyx_californianus}}';
...
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
bibkey = 'Elli2020'; type = 'Incollection'; bib = [ ... 
'doi = {10.1002/9781119167792}, ' ...
'author = {Elizabeth Penn Ellisto}, ' ... 
'year = {2020}, ' ...
'title = {Roadrunners}, ' ...
...
'howpublished = {\url{http://animaldiversity.org/accounts/Geococcyx_californianus/}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
