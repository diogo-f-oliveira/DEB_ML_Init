function [prdData, info] = predict_Lampris_guttatus(par, data, auxData)
...
% zero-variate data
  ...
  % will be overwritten below, due to lower f
  ...
  RT_i = TC * reprod_rate(93.6 * del_M, f, pars_R);        % #/d, reprod rate at 96.3 cm
  ...
  % pack to output
  prdData.tp = tT_p; % will be overwritten
  prdData.am = aT_m;
  prdData.Lp = Lw_p;
  prdData.Li = Lw_i;
  prdData.Wwb = Ww_b;
  ...
  prdData.tL_m = ELw_m;
  prdData.tL_f = ELw_f;
  prdData.tp = t_p/ kT_M; % overwrite for low f_tL
