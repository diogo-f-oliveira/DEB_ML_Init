  function [data, auxData, metaData, txtData, weights] = mydata_Cobitis_ohridana
%% set metadata
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Cypriniformes'; 
metaData.family     = 'Cobitidae';
metaData.species    = 'Cobitis_ohridana'; 
metaData.species_en = 'Ohrid loach'; 
...
data.Lp = 3.8;    units.Lp = 'cm'; label.Lp = ' total length at puberty'; bibkey.Lp = 'BohlSlec2003';
data.Li = 7.5;    units.Li = 'cm'; label.Li = 'ultimate total length for females'; bibkey.Li = 'BohlSlec2003';
  comment.Li = 'fishbase gives TL 6.8 cm';
...
data.Wwp = 0.33;  units.Wwp = 'g';  label.Wwp = 'wet weight at puberty for females';    bibkey.Wwp = {'BohlSlec2003','fishbase'};
  comment.Wwp = 'Based on 0.00562*Lp^3.05, see F1';
data.Wwi = 2.62; units.Wwi = 'g';  label.Wwi = 'ultimate wet weight for females';     bibkey.Wwi = 'fishbase';
...
data.Ri = 1e3/365;   units.Ri = '#/d';  label.Ri = 'max reprod rate';    bibkey.Ri = 'guess';
  ...
  comment.Ri = 'based on Cobitis_taenia';
...
F2 = 'known from the Balkan';
metaData.bibkey.F2 = 'fishbase';
metaData.facts = struct('F1',F1, 'F2',F2);

%% Links
metaData.links.id_CoL = 'WK2H'; % Cat of Life
metaData.links.id_ITIS = ''; % ITIS
metaData.links.id_EoL = ''; % Ency of Life
metaData.links.id_Wiki = 'Cobitis_ohridana'; % Wikipedia
metaData.links.id_ADW = 'Cobitis_ohridana'; % ADW
metaData.links.id_Taxo = '1682576'; % Taxonomicon
metaData.links.id_WoRMS = '1016069'; % WoRMS
metaData.links.id_fishbase = 'Cobitis-ohridana'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{https://en.wikipedia.org/wiki/Cobitis_ohridana}}';
...
'howpublished = {\url{https://www.fishbase.se/summary/Cobitis-ohridana}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
