function [prdData, info] = predict_Euglesa_casertana(par, data, auxData)
  ...
  Lw_b = L_b/ del_M;                % cm, structural length at birth
  ...
  Wd_i = (0.34*del_M)^3 * (1 + f * ome) * d_V; % g, ultimate dry weight at SL 3.4 mm
  
  % reproduction
  pars_R = [kap; kap_R; g; TC * k_J; TC * k_M; L_T; TC * v; U_Hb/ TC; U_Hj/ TC; U_Hp/ TC]; % compose parameter vector
  NT_i = cum_reprod_j(1100, f, pars_R);                 % #, cumulated reprod output
