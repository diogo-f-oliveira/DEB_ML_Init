function [prdData, info] = predict_Enicognathus_ferrugineus(par, data, auxData)
  ...
  EJ_Oe = 0 * tJOe(:,1); EJ_Oe(i_sel) = - J_M(:,3) * 24.4e3; % ml/d, O2 consumption
