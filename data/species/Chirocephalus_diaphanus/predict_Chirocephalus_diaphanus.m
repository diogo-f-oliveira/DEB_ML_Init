function [prdData, info] = predict_Chirocephalus_diaphanus(par, data, auxData)
  ...
  TC_Ri = tempcorr(C2K(TRi(:,1)), T_ref, T_A); 
...
%   Ww_im = L_im^3 * (1 + f * w_m);      % g, ultimate wet weight
  ...
  ELw_05 = L_m*tvel(:,4)/del_M;

  % temperature-time since birth at puerty
  EtT_p = t_p./TC_Ri;
  ...
  % pack to output
  prdData.tL = [ELw_25 ELw_20 ELw_15 ELw_10 ELw_05];
  prdData.Ttpam = [EtT_p EaT_m];
  prdData.TRi = ERT_i;
