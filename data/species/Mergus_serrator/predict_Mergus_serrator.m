function [prdData, info] = predict_Mergus_serrator(par, data, auxData)
  ...
  tf = [10 20 40 60; f_10 f_20 f_40 f_60]'; tf(:,1) = tf(:,1)*kT_M;
  [tvel, t_p, t_b, l_p, l_b] = get_tp(pars_tp, tf, [], tW(:,1)*kT_M);
