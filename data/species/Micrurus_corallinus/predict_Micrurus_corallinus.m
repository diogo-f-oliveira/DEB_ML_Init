function [prdData, info] = predict_Micrurus_corallinus(par, data, auxData)
  ...
  aT_b = t_b/ k_M/ TC;              % cm, age at birth
  ...
  % weight at length
  Ww_55 = (55.1 * del_M)^3 * (1 + f * w); % g, weight at SVL 55.1 cm
  Ww_60 = (59.6 * del_M)^3 * (1 + f * w); % g, weight at SVL 55.1 cm
