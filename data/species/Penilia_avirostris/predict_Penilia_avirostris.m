function [prdData, info] = predict_Penilia_avirostris(par, data, auxData)
  ...
  RT_i = TC * reprod_rate(L_i,f, pars_R); % #/d, mas reprod rate
  ...
  % length-fecundity
  EN = TC * 12 * reprod_rate(LN(:,1)*del_M,f_tL, pars_R); % #, fecundity

  % length-dry weight
  EWd = (LWd(:,1)*del_M).^3*d_V*(1+f_tL*ome); % g, dry weight
