function [prdData, info] = predict_Sphoeroides_maculatus(par, data, auxData)
...
% zero-variate data
  ...
  % length - weight
  EWw = (LWw(:,1) * del_M).^3 * (1 + f * w);
  
  % length - fecundity
  pars_R = [kap; kap_R; g; k_J; k_M; L_T; v; U_Hb; U_Hp]; % compose parameter vector at T
  EN = TC * 365 * reprod_rate(LN(:,1) * del_M, f, pars_R); % #, ultimate reproduction rate at T
