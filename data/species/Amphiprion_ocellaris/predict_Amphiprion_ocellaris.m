function [prdData, info] = predict_Amphiprion_ocellaris(par, data, auxData)
...
% zero-variate data
  ...
  % length-fecundity
  EN= TC * 365/4 * reprod_rate_j(LN(:,1)*del_M, f, pars_R); % #, clutch size assuming 8 clutches per yr
