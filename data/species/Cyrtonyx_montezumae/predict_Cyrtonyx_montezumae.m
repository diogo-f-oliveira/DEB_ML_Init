function [prdData, info] = predict_Cyrtonyx_montezumae(par, data, auxData)
  ...
  aT_b = tau_b/ k_M/ TC_ab;      % d, time at birth
  ...
  tf = [0 10 20 50; f_00 f_10 f_20 f_50]'; tf(:,1) = tf(:,1) * kT_M;
