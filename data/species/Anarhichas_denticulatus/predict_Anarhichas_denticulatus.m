function [prdData, info] = predict_Anarhichas_denticulatus(par, data, auxData)
  ...
  filterChecks =  f_tLW^3 > 1 || ...                  
                  f_tLW^3 < 0 || ...
                  ~reach_birth(g, k, v_Hb, f_tLW );   % constraint required for reaching birth with t_tLW
  ...
  L = [L_bj; L_jm];
  EWw = L.^3 * (1 + f_tLW * w);       % g, wet weight 
