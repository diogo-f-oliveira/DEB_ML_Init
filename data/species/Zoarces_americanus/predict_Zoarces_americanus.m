function [prdData, info] = predict_Zoarces_americanus(par, data, auxData)
  ...
  RT_i = TC * reprod_rate_j(62*del_M, f, pars_R);        % #/d, reproduction rate at 20 cm
...
%   L_im = l_i * L_mm; Lw_im = L_im/ del_M;  % cm, ultimate total length
  ...
  % length-weight
  LWw = (LW(:,1) * del_M) .^ 3 * (1 + f * w); % g, wet weight females
