function [prdData, info] = predict_Stichopus_vastus(par, data, auxData)
  ...
  Lw_j = L_j/ del_M;                % cm, stest diameter at metam
  ...
  L = L_i - (L_i - L_j) * exp( - rT_B * tL(:,1)); % cm, structural length
  ELw = L/ del_M; % body length
