function [prdData, info] = predict_Dryomys_nitedula(par, data, auxData)
  ...
  tf = [0 40 70; f_tW0 f_tW1 f_tW1]';
  L_0 = (Ww_0/ (1 + f_tW0* w))^(1/3);
  [t, EL] = ode45(@get_EL, tWw(:,1), [E_m*f_tW0, L_0], [], tf, v * TC, g, E_m, L_m, p_Am * TC); % EL: {J/cm^3, cm}, with {[E], L}
