function [prdData, info] = predict_Aepyceros_melampus(par, data, auxData)
  ...
  L_bm = L_mm * l_bm; L_im = (f - l_T) * L_mm; Ww_im = L_im^3 * (1 + f * w_m);
  ...
  L = L_i * (1 - exp( - rT_B * max(0, aW_e(:,1)- t_0))); % cm, struct length
