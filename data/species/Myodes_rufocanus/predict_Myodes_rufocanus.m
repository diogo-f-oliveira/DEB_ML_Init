function [prdData, info] = predict_Myodes_rufocanus(par, data, auxData)
  ...
  % time-weight 
  tf = [0 f_000; 50 f_050; 150 f_150; 180 f_180; 250 f_250]; % scaled func response in time
  ...
  Le(1,:) = []; EWw_m = Le(:,1).^3 .* (1 + Le(:,2) * w_m); % g, wet weight
