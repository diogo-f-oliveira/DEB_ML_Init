  function [data, auxData, metaData, txtData, weights] = mydata_Etheostoma_nigrum
%% set metadata
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Perciformes'; 
metaData.family     = 'Percidae';
metaData.species    = 'Etheostoma_nigrum'; 
metaData.species_en = 'Johnny darter'; 
...
data.Lp = 3.3;  units.Lp = 'cm'; label.Lp = 'standard length at puberty';  bibkey.Lp = 'guess'; 
...
data.Wwi = 2.5; units.Wwi = 'g';  label.Wwi = 'ultimate wet weight';       bibkey.Wwi = {'fishbase'};
   comment.Wwi = 'relationship 0.00513*7.2^3.14 (see F1)';

data.Ri = 1248/365;units.Ri = '#/d'; label.Ri = 'maximum reprod rate';    bibkey.Ri = 'fishbase';   
...
%% Links
metaData.links.id_CoL = '6H4SZ'; % Cat of Life
metaData.links.id_ITIS = '168369'; % ITIS
metaData.links.id_EoL = '207258'; % Ency of Life
metaData.links.id_Wiki = 'Etheostoma_nigrum'; % Wikipedia
metaData.links.id_ADW = 'Etheostoma_nigrum'; % ADW
metaData.links.id_Taxo = '45185'; % Taxonomicon
metaData.links.id_WoRMS = '590491'; % WoRMS
metaData.links.id_fishbase = 'Etheostoma-nigrum'; % fishbase


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{https://en.wikipedia.org/wiki/Etheostoma_nigrum}}';  
...
'howpublished = {\url{https://www.fishbase.se/summary/Etheostoma-nigrum.html}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
