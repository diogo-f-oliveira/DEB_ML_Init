function [prdData, info] = predict_Harpadon_nehereus(par, data, auxData) 
...
%% compute temperature correction factors
  ...
  Ww_i = (33 * del_M).^3 * (1 + f * w); % g, wet weight of 33 cm female
  ...
  Ww_im = (31 * del_M)^3 * (1 + f * w_m);  % g, wet weight 31 cm male
