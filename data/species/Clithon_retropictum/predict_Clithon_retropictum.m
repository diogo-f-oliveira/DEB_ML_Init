function [prdData, info] = predict_Clithon_retropictum(par, data, auxData)
  ...
  Wd_i = (0.75*del_M)^3 * (1 + f * ome) * d_V; % g, dry weight at shell diameter 0.75 cm
