function [prdData, info] = predict_Gymnocephalus_cernuus(par, data, auxData)
...
%% compute temperature correction factors
  ...
  Lw_b = L_b/ del_Mb;               % cm, total length
  ...
  % estuaries
  [t_j, t_p, t_b, l_j, l_p, l_b, l_i, rho_j, rho_B] = get_tj(pars_tjm, f_tL1);
  rT_B = rho_B * kT_M; tT_j = (t_j - t_b)/ kT_M; L_j = L_m * l_j; L_i = L_m * l_i;
