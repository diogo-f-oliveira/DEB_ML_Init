function [prdData, info] = predict_Alloteuthis_africana(par, data, auxData)
  ...
  rT_B = rho_B * kT_M; % 1/d, v Bert growth rate
  ...
  Lw_im = L_amm/ del_Mm; Lw_pm = L_pm/ del_Mm; % cm, mantle length at death
