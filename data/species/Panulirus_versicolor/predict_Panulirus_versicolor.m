function [prdData, info] = predict_Panulirus_versicolor(par, data, auxData)
  ...
  dL = rT_B * (L_i - LdL(:,1) * del_M); % cm/d, change in struc length
  EdLw = dL/ del_M; % cm/d , chnage in carapace length
