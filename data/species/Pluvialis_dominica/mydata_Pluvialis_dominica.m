function [data, auxData, metaData, txtData, weights] = mydata_Pluvialis_dominica
...
metaData.species    = 'Pluvialis_dominica'; 
metaData.species_en = 'American golden plover'; 
...
data.Wwb = 19.5;    units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'AnAge';
data.Wwi = 118;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight for female'; bibkey.Wwi = 'AnAge';
...
%% Links
metaData.links.id_CoL = '4KKPW'; % Cat of Life
metaData.links.id_ITIS = '176564'; % ITIS
metaData.links.id_EoL = '45509152'; % Ency of Life
metaData.links.id_Wiki = 'Pluvialis_dominica'; % Wikipedia
metaData.links.id_ADW = 'Pluvialis_dominica'; % ADW
metaData.links.id_Taxo = '53625'; % Taxonomicon
metaData.links.id_WoRMS = '159136'; % WoRMS
metaData.links.id_avibase = '2143A8526CA7C809'; % avibase
metaData.links.id_birdlife = 'american-golden-plover-pluvialis-dominica'; % birdlife
metaData.links.id_AnAge = 'Pluvialis_dominica'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Pluvialis_dominica}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Pluvialis_dominica}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
