function [prdData, info] = predict_Acrocheilus_alutaceus(par, data, auxData)
...
%% compute temperature correction factors
  ...
  TC_18 = tempcorr(temp.ab18, T_ref, T_A); 
  ...
  aT_b12 = tau_b/ k_M/ TC_12;       % d, age at birth at 12 C
  aT_b18 = tau_b/ k_M/ TC_18;       % d, age at birth at 18 C
  ...
  rT_j = kT_M * rho_j; rT_B = kT_M * rho_B; % 1/d, von Bertalanffy growth rate
