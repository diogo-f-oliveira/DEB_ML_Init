function [data, auxData, metaData, txtData, weights] = mydata_Copadichromis_mloto
...
metaData.species    = 'Copadichromis_mloto'; 
...
data.Lp  = 10.3;   units.Lp  = 'cm';  label.Lp  = 'total length at puberty';  bibkey.Lp  = 'fishbase'; 
...
data.Wwp = 17.2;   units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';      bibkey.Wwp = 'fishbase';
  comment.Wwp = 'based on 0.02188*Lp^2.86, see F1';
data.Wwi = 37.4;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';      bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.02188*Li^2.86, see F1';

data.Ri  = 50/365; units.Ri  = '#/d'; label.Ri  = 'max reprod rate'; bibkey.Ri = 'Smit2000';   
...
%% Facts
F1 = 'length-weight: Ww in g = 0.02188*(TL in cm)^2.86'; 
metaData.bibkey.F1 = 'fishbase';
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = '5ZX86'; % Cat of Life
metaData.links.id_ITIS = '649004'; % ITIS
metaData.links.id_EoL = '994749'; % Ency of Life
metaData.links.id_Wiki = 'Copadichromis_mloto'; % Wikipedia
metaData.links.id_ADW = 'Copadichromis_mloto'; % ADW
metaData.links.id_Taxo = '45591'; % Taxonomicon
metaData.links.id_WoRMS = '1013822'; % WoRMS
metaData.links.id_fishbase = 'Copadichromis_mloto'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Copadichromis_virginalis}}';
...
'howpublished = {\url{https://www.fishbase.se/summary/Copadichromis-virginalis.html}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
