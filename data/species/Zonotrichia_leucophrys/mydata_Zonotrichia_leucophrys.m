function [data, auxData, metaData, txtData, weights] = mydata_Zonotrichia_leucophrys
%% set metaData
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Aves'; 
metaData.order      = 'Passeriformes'; 
metaData.family     = 'Passerellidae';
metaData.species    = 'Zonotrichia_leucophrys'; 
metaData.species_en = 'White-crowned sparrow'; 
...
data.Wwi = 25.8;     units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'AnAge';
...
%% Links
metaData.links.id_CoL = '5D766'; % Cat of Life
metaData.links.id_ITIS = '179455'; % ITIS
metaData.links.id_EoL = '45511191'; % Ency of Life
metaData.links.id_Wiki = 'Zonotrichia_leucophrys'; % Wikipedia
metaData.links.id_ADW = 'Zonotrichia_leucophrys'; % ADW
metaData.links.id_Taxo = '58134'; % Taxonomicon
metaData.links.id_WoRMS = '1484615'; % WoRMS
metaData.links.id_avibase = '8601A4678CABA542'; % avibase
metaData.links.id_birdlife = 'white-crowned-sparrow-zonotrichia-leucophrys'; % birdlife
metaData.links.id_AnAge = 'Zonotrichia_leucophrys'; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Zonotrichia_leucophrys}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Zonotrichia_leucophrys}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
