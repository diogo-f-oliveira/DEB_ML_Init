function [prdData, info] = predict_Bettongia_lesueur(par, data, auxData)
  ...
  tf = [50 100 150 200; f_050 f_100 f_150 f_200]';
  [t, EL] = ode45(@get_EL, [0;tL(:,1)], [E_m, L_b], [], tf, v * TC, g, E_m, L_m, p_Am * TC); % EL: {J/cm^3, cm}, with {[E], L}
  EL(1,:)=[]; ELw = EL(:,2)/ del_M; % cm, length
  %
 [t, EL] = ode45(@get_EL, [0;tWw(:,1)], [E_m, L_b], [], tf, v * TC, g, E_m, L_m, p_Am * TC); % EL: {J/cm^3, cm}, with {[E], L}
