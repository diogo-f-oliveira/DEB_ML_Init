function [prdData, info] = predict_Coleura_seychellensis(par, data, auxData)
  ...
  % time-weight 
  tf = [0 f_00; 10 f_10; 15 f_15]; % scaled func response in time
  [t, Le] = ode45(@get_Le, [0; tL(:,1)], [l_b; 1], [], tf, v * TC, g, 1);
  Le(1,:) = []; EL = Le(:,1);  % -, length as fraction of fully grown
