...
function [prdData, info] = predict_Tadorna_cana(par, data, auxData)
...
% zero-variate data
  ...
  [tau_p, tau_b, ~, l_b, info] = get_tp(pars_tp, f); % -, scaled times & lengths
...
% uni-variate data
  ...
  % time-weight
  tf = [05 10 30 50 60; f_05 f_10 f_30 f_50 f_60]'; tf(:,1) = tf(:,1) * kT_M;
  % female
