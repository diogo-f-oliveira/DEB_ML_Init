function [data, auxData, metaData, txtData, weights] = mydata_Cricetus_cricetus
...
metaData.species    = 'Cricetus_cricetus'; 
metaData.species_en = 'European hamster'; 
metaData.ecoCode.climate = {'BSk', 'BWk', 'Dfa', 'Dfb'};
...
data.tp = 53;     units.tp = 'd';    label.tp = 'time since birth at puberty'; bibkey.tp = 'AnAge';
...
data.Wwi = 506.9;  units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';       bibkey.Wwi = 'AnAge';
...
data.Ri  = 7*2/365; units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';      bibkey.Ri  = 'AnAge';   
  ...
  comment.Ri = '7 pups per litter; 2 litters per yr';
...
%% Links
metaData.links.id_CoL = 'ZFXR'; % Cat of Life
metaData.links.id_ITIS = '632734'; % ITIS
metaData.links.id_EoL = '1179512'; % Ency of Life
metaData.links.id_Wiki = 'Cricetus_cricetus'; % Wikipedia
metaData.links.id_ADW = 'Cricetus_cricetus'; % ADW
metaData.links.id_Taxo = '62488'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_MSW3 = '13000362'; % MSW3
metaData.links.id_AnAge = 'Cricetus_cricetus'; % AnAge


%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Cricetus_cricetus}}';
...
'howpublished = {\url{http://genomics.senescence.info/species/entry.php?species=Cricetus_cricetus}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
