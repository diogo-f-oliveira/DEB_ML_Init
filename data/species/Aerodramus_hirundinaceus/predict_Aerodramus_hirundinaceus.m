function [prdData, info] = predict_Aerodramus_hirundinaceus(par, data, auxData)
  ...
  aT_b = tau_b/ k_M/ TC_ab;     % d, age at birth at f and T% fledging
  ...
  % uni-variate data
  % time-weight
  tf = [ 5 10 20 30; f_05 f_10 f_20 f_30]'; tf(:,1) = tf(:,1) * kT_M;
