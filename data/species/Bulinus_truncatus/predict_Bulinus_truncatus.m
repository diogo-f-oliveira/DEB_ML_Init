function [prdData, info] = predict_Bulinus_truncatus(par, data, auxData)
  ...
  %
  pars_R = [kap; kap_R; g; TC_10 * k_J; TC_10* k_M; L_T; TC_10 * v; U_Hb/ TC_10; U_Hj/ TC_10; U_Hp/ TC_10]; % compose parameter vector at T
  N10_121 = cum_reprod_j(121, f, pars_R);                   % #, number of egg at 121 d
