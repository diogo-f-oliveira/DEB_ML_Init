function [prdData, info] = predict_Lophius_americanus(par, data, auxData)
...
%% compute temperature correction factors
  ...
  % time-length
  tf = [1000 f_1000; 2000 f_2000; 3000 f_3000]; tf(:,1)=tf(:,1)*kT_M;
  % female
  ...
  % length-fecundity
  EN = TC * 365e-6 * reprod_rate_j(LN(:,1)*del_M, f, pars_R); % #, fecundity in 1e6 eggs
