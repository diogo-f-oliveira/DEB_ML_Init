function [data, auxData, metaData, txtData, weights] = mydata_Clamator_glandarius
...
metaData.species    = 'Clamator_glandarius'; 
metaData.species_en = 'Great spotted cuckoo';

metaData.ecoCode.climate = {'BSh', 'BSk', 'Csa', 'Csb'};
...
metaData.date_mod_1     = [2017 11 23];              
metaData.email_mod_1    = {'bas.kooijman@vu.nl'};            
metaData.address_mod_1  = {'VU University Amsterdam'};   

metaData.author_mod_2   = {'Bas Kooijman'};    
metaData.date_mod_2     = [2022 11 17];              
...
data.ab = 13.5;    units.ab = 'd';    label.ab = 'age at birth';           bibkey.ab = 'ADW';   
  temp.ab = C2K(36.2);  units.temp.ab = 'K'; label.temp.ab = 'temperature';
  comment.ab = 'temp from Cuculus canoris';
data.tx = 20.3;    units.tx = 'd';    label.tx = 'time since birth at fledging'; bibkey.tx = 'SoleSole1991';   
  temp.tx = C2K(41.3);  units.temp.tx = 'K'; label.temp.tx = 'temperature';
data.tp = 60.9;    units.tp = 'd';    label.tp = 'time since birth at puberty'; bibkey.tp = 'guess';   
...
data.Wwi = 133;   units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'SoleSole1991';
...
%% Facts
F1 = 'Brood parsite for crows';
metaData.bibkey.F1 = 'Wiki'; 
metaData.facts = struct('F1',F1);

%% Links
metaData.links.id_CoL = 'VQNX'; % Cat of Life
metaData.links.id_ITIS = '554674'; % ITIS
metaData.links.id_EoL = '45518918'; % Ency of Life
metaData.links.id_Wiki = 'Clamator_glandarius'; % Wikipedia
metaData.links.id_ADW = 'Clamator_glandarius'; % ADW
metaData.links.id_Taxo = '54509'; % Taxonomicon
metaData.links.id_WoRMS = ''; % WoRMS
metaData.links.id_avibase = '3D67C56A490A60AE'; % avibase
metaData.links.id_birdlife = 'great-spotted-cuckoo-clamator-glandarius'; % birdlife
metaData.links.id_AnAge = ''; % AnAge

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/Clamator_glandarius}}';
...
'howpublished = {\url{http://animaldiversity.org/accounts/Clamator_glandarius/}}';
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
