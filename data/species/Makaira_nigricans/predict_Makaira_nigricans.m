function [prdData, info] = predict_Makaira_nigricans(par, data, auxData)
  ...
  RT_277 = TC * reprod_rate_j(277 * del_M, f, pars_R);             % #/d, ultimate reproduction rate at T
  RT_290 = TC * reprod_rate_j(290 * del_M, f, pars_R);             % #/d, ultimate reproduction rate at T
  ...
  L_jm = L_i - (L_i - L_j) * exp( - rT_B * (tL1((tL1(:,1) > tT_j),1) - tT_j)); % cm, expected length at time
  ELw_1 = [L_bj; L_jm]/ del_M;                                            % cm, total length     
