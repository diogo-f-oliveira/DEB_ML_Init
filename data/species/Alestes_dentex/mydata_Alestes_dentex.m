  function [data, auxData, metaData, txtData, weights] = mydata_Alestes_dentex
%% set metadata
metaData.phylum     = 'Chordata'; 
metaData.class      = 'Actinopterygii'; 
metaData.order      = 'Characiformes'; 
metaData.family     = 'Alestidae';
metaData.species    = 'Alestes_dentex'; 
metaData.species_en = 'Silversides'; 
...
data.Wwp = 122;  units.Wwp = 'g';    label.Wwp = 'wet weight at puberty';    bibkey.Wwp = 'fishbase';
  comment.Wwp = 'based on 0.01148*Lp^3.0, see F1';
data.Wwi = 1.9e3;  units.Wwi = 'g';    label.Wwi = 'ultimate wet weight';    bibkey.Wwi = 'fishbase';
  comment.Wwi = 'based on 0.01148*Li^3.00, see F1';
  
data.Ri = 51000*871.4/220/365; units.Ri = '#/d'; label.Ri = 'max reprod rate'; bibkey.Ri = 'guess'; 
...
bibkey.tL_fm = 'MorePalo1995'; treat.tL_fm = {1 {'females','males'}};
...
%% Links
metaData.links.id_CoL = 'BP7Q'; % Cat of Life
metaData.links.id_ITIS = '640387'; % ITIS
metaData.links.id_EoL = '219948'; % Ency of Life
metaData.links.id_Wiki = 'Alestes_dentex'; % Wikipedia
metaData.links.id_ADW = 'Alestes_dentex'; % ADW
metaData.links.id_Taxo = '160373'; % Taxonomicon
metaData.links.id_WoRMS = '826492'; % WoRMS
metaData.links.id_fishbase = 'Alestes-dentex'; % fishbase

%% References
bibkey = 'Wiki'; type = 'Misc'; bib = ...
'howpublished = {\url{http://en.wikipedia.org/wiki/wiki/Alestes_dentex}}';  
...
'howpublished = {\url{https://fishbase.mnhn.fr/summary/Alestes-dentex.html}}';  
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
