function [prdData, info] = predict_Rhynchocypris_oxycephalus(par, data, auxData)
...
%% compute temperature correction factors
  ...
  RT_5 = TC * reprod_rate_j(5.8*del_M, f_tL, pars_R);    % #/d, reprod rate at TL 5.8 cm
  RT_14 = TC * reprod_rate_j(14.3*del_M, f_tL, pars_R);    % #/d, reprod rate at TL 14.3 cm
